			 ...
			 <div class="row">
              ...
              <div class="tab-pane fade interestCover" id="interestedData" role="tabpanel" aria-labelledby="interested-tab">              
				<div class="row">
                  <div class="col-12 col-sm-9">                    
					<?php 
					   if(!empty($itineraryData->service_id) and !empty($itineraryData->id)){						
...
//=========== Change Language Data js Start on 19-02-19 =========//
$('.changeLang').on('change',function(){
	...
	var detailURL = '<?php echo base_url()?>admin/admin_detail_itineraries_meetup?itinerary_id='+itinerary_id+'&flag=<?php echo $flag?>'+'&service_id='+serviceid+'&lang='+itinerary_lang;		
