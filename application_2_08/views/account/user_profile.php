...
<!-- Flash MSG--> 
  ...
  c1.2,0.1,2.4,0,3.6,0c1.1,0,2.3,0.1,3.4-0.1C22.9,19.9,22.5,18.4,21.6,18.6z"/>
          ...
          <fieldset>
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-6 placeVaild">
                <p class="font-weight-semibold text-light d-inline-block mb-0">Swachh Bharat <a href="#"  target="_blank" data-toggle="modal" data-target="#swachh_bharat_Modal" class="d-block text-uppercase text-primary font-weight-semibold">Read More</a></p>
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                <p class="font-weight-semibold text-light d-inline-block mb-0">Tourism <a href="#" target="_blank" data-toggle="modal" data-target="#tourism_Modal" class="d-block text-uppercase text-primary font-weight-semibold">Read More</a></p>
                <div class="custom-control custom-checkbox custom-control-inline align-bottom ml-3">
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6 placeVaild">
                    ...
                    <input type="text" class="form-control text-uppercase" autocomplete="off" placeholder="Personal Account Number" name="pan_number" id="pan_number" required  value="<?php if( $user_data->pan_number == ''){}else{echo $user_data->pan_number ;}?>" />
                  </div>
                  <div class="col-12 col-sm-6 text-right placeVaild">
