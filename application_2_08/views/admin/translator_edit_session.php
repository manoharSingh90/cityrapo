...
<div class="profilePage">
  ...
  <div class="profilePage-body clearfix">
			  ...
			  <?php 
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                    <input type="checkbox" id="deliveryType-bus" name="itinerary_delivery[]" value="bus" class="custom-control-input limitSelect ignore"  data-rule-required="true" <?php if(isset($deliverydata['bus'])){echo "checked";} ?>/>
	...
	C23.8,28.7,23.8,27.3,22.9,27.3z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                    <input type="checkbox" id="deliveryType-car" name="itinerary_delivery[]" value="car" <?php if(isset($deliverydata['car'])){echo "checked";} ?> class="custom-control-input limitSelect">
                    <span class="control-icon"> <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             ...
             <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
              <label> 
				   <input type="checkbox" id="deliveryType-online" name="itinerary_delivery[]" value="online" class="custom-control-input limitSelect ignore"  data-rule-required="true" <?php if(isset($deliverydata['online'])){echo "checked";} ?>/>
                    ...
                    <label class="custom-control-label" for="deliveryType-online">Online</label>
                   </label>					
				  </div>
                </div>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 placeVaild">
                  ...
                  <input id="pickup_point" type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Venue" value="<?php echo @$draftRoutData->pickup_point;?>" data-rule-required="true"/>
                </div>
      ...
      <!--       <ul class="form-row">
		...
		<?php } ?>
         ...
         <fieldset>
          <h3 id="fillSponsor" class="col-form-label mt-2">Sponsor</h3>
           <small class="text-muted">*Required dimension 640 X 100px, size less than 5mb and format .jpg,.jpeg only</small>
        ...
        <fieldset>
          ...
          <h3 id="fillImage" class="col-form-label mt-2">Image Gallery</h3>
           <small class="text-muted">*Required dimension 1440 X 563px, size less than 5mb and format .jpg,.jpeg only</small>
