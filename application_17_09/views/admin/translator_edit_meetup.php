...
<div class="profilePage">
  ...
  <div class="profilePage-body clearfix">
		  ...
		  <?php 
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                   <label> <input type="checkbox" id="deliveryType-bus" name="itinerary_delivery[]" value="bus" class="custom-control-input limitSelect ignore" data-rule-required="true" <?php if(isset($deliverydata['bus'])){echo "checked";} ?>/>
	...
	c0,0.7,0,1.5,0.8,1.7c0.6,0.2,1.5,0.1,2.1,0.1C22.4,32.3,22.4,30.9,21.6,30.9z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                   <label> <input type="checkbox" id="deliveryType-auto" name="itinerary_delivery[]" value="auto" class="custom-control-input limitSelect" <?php if(isset($deliverydata['auto'])){echo "checked";} ?> >
                    <span class="control-icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	C23.8,28.7,23.8,27.3,22.9,27.3z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                   <label> <input type="checkbox" id="deliveryType-car" name="itinerary_delivery[]" value="car" class="custom-control-input limitSelect" <?php if(isset($deliverydata['car'])){echo "checked";} ?> >
                    <span class="control-icon"> <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	C9.1,11.7,10.7,10.8,10.1,9.8L10.1,9.8z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                   <label> <input type="checkbox" id="deliveryType-cycle" name="itinerary_delivery[]" value="cycle" class="custom-control-input limitSelect"  <?php if(isset($deliverydata['cycle'])){echo "checked";} ?>>
                    <span class="control-icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 41.8 33" style="enable-background:new 0 0 41.8 33;" xml:space="preserve">
		...
		C21.6,17.6,21.6,19.2,22.6,19.2z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                  <label>  <input type="checkbox" id="deliveryType-foot" name="itinerary_delivery[]" value="foot" class="custom-control-input limitSelect"  <?php if(isset($deliverydata['foot'])){echo "checked";} ?>>
                    <span class="control-icon"> <svg version="1.1"   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
      ...
      <!--       <ul class="form-row">
        ...
        <fieldset>
          ...
          <small class="text-muted">*Required dimension 1440 X 747px, size less than 5mb and format .jpg,.jpeg only</small>
