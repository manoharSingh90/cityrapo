    ...
    <div class="headingStatic border-0 pb-4">
        ...
        <div class="pt-4 text-center">
          <div class="custom-control custom-radio d-inline-block mr-2">
            <input type="radio" class="custom-control-input" id="englishRadio" name="language" value="english">
            <label class="custom-control-label pt-1" for="englishRadio">English</label>
          </div>
          <div class="custom-control custom-radio d-inline-block ml-2">
            <input type="radio" class="custom-control-input" id="hindiRadio"  name="language" value="hindi">
          ...
          <div class="row pt-2">
            <div class="col-12 col-sm-6">
              <div class="form-group mb-4">
                ...
                <input type="text" class="form-control" placeholder="Name / नाम" required/>
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <div class="form-group mb-4">
                <label>Phone Number / फ़ोन नंबर</label>
                <input type="number" class="form-control" placeholder="Phone Number / फ़ोन नंबर" required />
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <div class="form-group mb-4">
                <label>Email Address / ईमेल</label>
                <input type="email" class="form-control"  placeholder="Email Address / ईमेल" required />
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <div class="form-group mb-4">
                <label>Date / दिनांक</label>
                <input type="date" class="form-control"  placeholder="Date / दिनांक" required />
              </div>
            </div>
            <div class="col-12 pt-3">
              <button type="submit" class="btn btn-secondary btn-lg">Submit / सबमिट करे</button>
            </div>
          </div>
        </form>
      </div>
