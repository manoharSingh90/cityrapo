  ...
  <div class="heroBanner"> 
     <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
			...
			<div class="carousel-item bannerLayer active" style="background-image: url(<?php echo base_url();?>assets/img/banners/home/banner_1.jpg)"><img src="<?php echo base_url();?>assets/img/banners/home/banner_1.jpg" alt="1"/>	<div class="container"> 
				<div class="bannerText"><p>Witness & Adapt</p></div></div></div>
				...
				<div class="bannerText"><p>Spiritual Quest</p></div></div></div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div id="mfu_modal" class="modal-content moreusContent">
                <div class="modal-body">
                    ...
                    <h5 class="modal-title pb-2 pt-1"><img id="mfu_logo" src="assets/img/moreus/gandhiwalks_logo.png" alt="gandhiwalks"></h5>
                    ...
                    <form id="morefrom" class="pt-2">
                        ...
                        <ul class="form-row justify-content-center">
                            ...
                            <li class="form-group col-12">
                                ...
                                <textarea class="form-control" placeholder="Please use only up to 500 characters" name="mfu_travel_plan" required></textarea>
                            </li>
                            <li class="form-group col-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="agreeCheck" name="mfu_agree" value="yes" required />
