   ...
   <li>
	  ...
	  <?php if($serviceId==1){?>
          <div class="itinerariesBox">		  
            <div class="itinerariesBox-img"><img src="<?php echo base_url();?><?php echo $img3;?>" alt="feature_75" /></div>
			...
			?> 
			 <?php if(!empty($hostData)){?>	
              <p class="itinerariesBox-user pt-1 mb-2"> <span class="itinerariesBox-userimg"><img src="<?php echo base_url();?>assets/upload/profile_pic/<?php echo $hostData['profile_picture'];?>" alt="Profile" /></span> <?php echo $hostData['host_first_name'].' '.$hostData['host_last_name']?> <small class="itinerariesBox-verify"><b class="callVerify"> <img src="<?php echo base_url();?>assets/img/icon/<?php echo $verifyimg;?>" alt="Call_Verified" /> </b>Verified</small> </p>
			 <?php } ?>
              ...
              <p class="itinerariesBox-text font-weight-semibold"><?php echo strlen($val->itinerary_description) > 90 ? substr($val->itinerary_description,0,90)."..." : $val->itinerary_description;?> <a href="javascript:void(0);"  data-toggle="modal" data-target="#guestReadMoreModal" class="text-primary">View More</a></p>
              ...
              <ul class="itinerariesBox-other text-dark">
				...
				<?php 		
				  if(@$privatePrice!==null && @$groupPrice!==null && @$adultPrice!==null){	
				    $minPrice = min(@$privatePrice,@$groupPrice,@$adultPrice);
					$maxPrice = max(@$privatePrice,@$groupPrice,@$adultPrice);
			   ...
			   elseif(@$privatePrice==null && @$groupPrice!==null && @$adultPrice!==null){
				     $minPrice = min(@$groupPrice,@$familyPrice->adults_price);
					 $maxPrice = max(@$groupPrice,@$familyPrice->adults_price);
					 echo '&#8377; '.$minPrice.' - '.'&#8377; '.$maxPrice;
					 }
			   elseif(@$privatePrice!==null && @$groupPrice==null && @$adultPrice!==null){
	  ...
	  <?php }
	   if($serviceId==2){
		  ...
		  if(!empty($hostData)){
		   ...
		   ?>
		    <div class="itinerariesBox">
            <div class="itinerariesBox-img"> <img src="<?php echo base_url();?><?php echo $img3;?>" alt="feature_77" /><img class="sponsoredImg" src="<?php echo base_url();?>assets/itinerary_files/sponsor_file/<?php echo $sponsorImg[0];?>" alt="sponsor_02" /></div>
            <div class="itinerariesBox-info">
              <h2 class="itinerariesBox-title font-weight-bold text-uppercase"><?php echo $val->itinerary_title;?></h2>
              <div class="row">
                <div class="col-12 col-sm-6">
                  ...
                  <p class="itinerariesBox-date"><img src="<?php echo base_url();?>assets/img/icon/date.svg" alt="Date" />
					<?php if(!empty($val->aviaiable_time_form_host))echo $val->aviaiable_time_form_host;?> - <?php if(!empty($val->aviaiable_time_to_host))echo $val->aviaiable_time_to_host;?></p>
                ...
                <div class="col-12 col-sm-6">
                  <p class="itinerariesBox-cmy flyCenter"> <span class="itinerariesBox-cmyimg"><img src="<?php echo base_url();?>assets/upload/profile_pic/<?php echo $hostData['profile_picture'];?>" alt="cmy" /></span> <?php echo $hostData['host_first_name'].' '.$hostData['host_last_name']?><small class="itinerariesBox-verify"><b class="callVerify"> <img src="<?php echo base_url();?>assets/img/icon/<?php echo $verifyimg;?>" alt="Verified Icon" /> </b>Verified</small></p>
                </div>
              </div>
            </div>
         <div class="itinerariesBox-links">
		  ...
		  if($serviceId==3){?>
            ...
            <div class="itinerariesBox-info">
              ...
              <div class="itinerariesBox-links">
                <div class="itinerarieslanguage">
                <select class="form-control itinerary_selected_lang" >
                  <option value="<?php echo $val->itinerary_language;?>" selected><?php echo $val->itinerary_language;?></option> 
				  <?php 
					  if($val->itinerary_language!=='English'){
					  ?>
				     <option value="English">English</option>
		  ...
		  if($serviceId==4){
			 ...
			 ?>
			<div class="itinerariesBox">
            <div class="itinerariesBox-img"> <img src="<?php echo base_url();?><?php echo $img3;?>" alt="feature_76" /><img class="sponsoredImg" src="<?php echo base_url();?>assets/itinerary_files/sponsor_file/<?php echo $sponsorImg[0];?>" alt="sponsor_01" /> </div>
            <div class="itinerariesBox-info">
              <h2 class="itinerariesBox-title font-weight-bold text-uppercase"><?php echo $val->itinerary_title;?></h2>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body legalPopup">
		...
		<?php 
			echo $val->itinerary_description;
			?>          
        </ul>
      </div>
