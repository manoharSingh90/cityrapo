...
<div class="profilePage">
  ...
  <div class="profilePage-body clearfix">
		...
		<?php 
          ...
          <ul class="form-row no-gutters">
           ...
           <?php if($selectOtherLang!='English'){ ?>
			...
			<?php if($selectOtherLang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
			<label class="col-form-sublabel">Type My City (<?php echo $selectOtherLang;?>)</label>             
			...
			<?php if($selectOtherLang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Meet-up Title (<?php echo $selectOtherLang;?>)</label>
			...
			<?php if($selectOtherLang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Type Tag Line (<?php echo $selectOtherLang;?>)</label>
	...
	C9.1,11.7,10.7,10.8,10.1,9.8L10.1,9.8z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                   <label> <input type="checkbox" id="deliveryType-cycle" name="itinerary_delivery[]" value="cycle" class="custom-control-input limitSelect" 
	 ...
	 viewBox="0 0 41.8 33" style="enable-background:new 0 0 41.8 33;" xml:space="preserve">
		...
		C21.6,17.6,21.6,19.2,22.6,19.2z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                  <label>  <input type="checkbox" id="deliveryType-foot" name="itinerary_delivery[]" value="foot" class="custom-control-input limitSelect" 
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 placeVaild">
                  ...
                  <input id="pickup_point" type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Venue" value="<?php echo @$draftRoutData->pickup_point;?>" data-rule-required="true" autocomplete="off"/>
                </div>
