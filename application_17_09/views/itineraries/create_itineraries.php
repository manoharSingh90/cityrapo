...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    <h1 class="cmyLogo float-left">
      <img src="<?php echo base_url();?>assets/img/iwl_hr_white_logo.svg" alt="India with locals" />
    </h1>
  ...
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Type Category (
      <?php echo $selectOtherLang;?>)
    </label>
    <input type="text" class="form-control" id="type_category" name="type_category" value="<?php if(isset($draftData->other_category_type))echo $draftData->other_category_type;?>" required data-rule-required="true"/>
  </li>
  <?php }	?>
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Select My City
    </label>
...
<li class="form-group col-12 col-md-6 placeVaild">
  ...
  <input type="text" class="form-control" name="other_tag_line"  id="other_tag_line" 
         value="<?php if(isset($draftData->itinerary_other_tagline))echo $draftData->itinerary_other_tagline;?>" required data-rule-required="true"/>
</li>
<?php } ?>
...
<li class="form-group col-12 col-md-12 placeVaild">
  ...
  <textarea class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 5000 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="5000"><?php echo (@$draftData->other_itinerary_description?$draftData->other_itinerary_description:'');?></textarea>
</li>
<?php } ?>
<li class="form-group col-12 col-md-12 placeVaild">
...
<fieldset>
  ...
  <small class="text-muted">*Required dimension 400 X 127px, size less than 10mb and format .jpg,.jpeg only
  </small>
  <ul class="form-row">
    <?php $sponsorArr = '';
...
?>
    <li class="form-group col-12 placeVaild">
      <label class="dragImageBox">
        ...
        <span>Drag file here or click to upload
        </span> 
        </div>
      <div class="infoShow" 
...
<small class="text-muted">*Required dimension 1440 X 810px, size less than 10mb and format .jpg,.jpeg only
</small>
<ul class="form-row">
  <li class="form-group col-12 placeVaild">
    <label class="dragImageBox">
...
<small class="text-muted">*Required dimension 250 X 158px, size less than 10mb and format .jpg,.jpeg only
</small>
<ul class="form-row">
