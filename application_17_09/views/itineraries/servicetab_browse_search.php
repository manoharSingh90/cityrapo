	  ...
	  ?>      
	   ...
	   if($serviceId==2){
		  ...
		  if(!empty($hostData)){			   
		   ...
		   ?>
            ...
            <div class="itinerariesBox-info">
			  ...
			  <?php } ?>
			  <small class="internal-verify"><b> <img src="<?php echo base_url();?>assets/img/icon/tourguide.svg" alt="tourguide"> </b> </small>
			  <small class="itinerariesBox-verify"><b class="callVerify"> <img src="<?php echo base_url();?>assets/img/icon/<?php echo $verifyimg;?>" alt="Verified Icon" /> </b>Verified</small>
         ...
         <div class="itinerariesBox-links">
             ...
             <div class="itinerariesAnchor"> <a href="#" class="btn btn-link btn-sm text-secondary mr-1 pl-0 pr-0 guest_itinerary_viewdetail" >View Details</a> <a href="#" class="btn btn-link btn-sm text-primary ml-1 pl-0 pr-0 book_guest_itinerary">Book</a> </div>
		  ...
		  if($serviceId==4){
			 ...
			 ?>
			<div class="itinerariesBox">
            <div class="itinerariesBox-img"> <img src="<?php echo base_url();?><?php echo $img3;?>" alt="feature_76" />
			<?php if(!empty(array_filter($sponsorImg))){?>
			 <span class="sponsorMark">Sponsored </span>
			<?php } ?>
			<?php if(!empty(array_filter($sponsorImg))):?>
...
$('.itinerary_selected_lang').each(function(){
	...
	if(serviceid==2){
		...
		var detailURL = '<?php echo base_url()?>session/'+itinerary_id+'/'+serviceid+'/'+itinerary_lang+'/'+itinerary_city+'/'+itinerary_title+'/true';
	...
	if(serviceid==3){
		...
		var detailURL = '<?php echo base_url()?>experience/'+itinerary_id+'/'+serviceid+'/'+itinerary_lang+'/'+itinerary_city+'/'+itinerary_title+'/true';
   ...
   if(serviceid==4){
		 ...
		 var detailURL = '<?php echo base_url()?>meetup/'+itinerary_id+'/'+serviceid+'/'+itinerary_lang+'/'+itinerary_city+'/'+itinerary_title+'/true';
...
$('.itinerary_selected_lang').on('change',function(){
   ...
   if(serviceid==4){
    ...
    if(serviceid==2){
		window.location.href = '<?php echo base_url()?>home/detail_itineraries_sessions?itinerary_id='+itinerary_id+'&serviceid='+serviceid+'&user_type=Guest&lang='+itinerary_lang;
		}
	if(serviceid==3){
		window.location.href = '<?php echo base_url()?>home/detail_itineraries_experiences?itinerary_id='+itinerary_id+'&serviceid='+serviceid+'&user_type=Guest&lang='+itinerary_lang;
		}
	if(serviceid==4){
		window.location.href = '<?php echo base_url()?>home/detail_itineraries_meetup?itinerary_id='+itinerary_id+'&serviceid='+serviceid+'&user_type=Guest&lang='+itinerary_lang;
		}
	 $(this).closest('.itinerariesBox-links').find('.guest_itinerary_viewdetail').attr('href', detailURL)
...
$('.rsvpModalData').on('click',function(){
	...
	//service_id = $('.itinerariesBox-links').find('.service_ids').val();
	$('.service_ids').val($('.itinerariesBox-links').find('.service_ids').val());
