...
<div class="createItineraries profilePage">
  ...
  <div class="profilePage-body clearfix">
    <div class="chooseService">
	  ...
	  <a href="javascript:void(0);" class="btn btn-outline-primary" id="download_product">Download PDF</a>
    </div>	
  </div>  
</div>
	 ...
	 <form id="trainingForm">
      ...
      <div class="modal-body">	 
        <div class="confirmationText">
          ...
          <hr>
          <div class="text-center placeVaild">
          <div class="custom-control custom-checkbox custom-control-inline">
            ...
            <label class="custom-control-label" for="trainingCheckInput"> Training Done</label>
          </div>
          </div>
        </div>
      </div>
