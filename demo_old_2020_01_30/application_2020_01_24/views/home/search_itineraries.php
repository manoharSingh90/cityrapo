...
?></small>
			...
			<?php } ?>	
				...
				<br/><small class="hostInfo-verified mt-1"><b> <img src="<?php echo base_url(); ?>assets/img/icon/<?php echo $verifyimg; ?>" alt="verified" /> </b>Verified</small>
				 </p>
                </div>
              </div>
            </div>
