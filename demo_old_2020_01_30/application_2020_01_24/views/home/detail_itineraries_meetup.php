          ...
          <div class="row mt-4">
            <div class="col-12">
              <div class="bookIntro boxStyle">
                <h3 class="normalTitle d-inline-block align-middle mr-1">Interested in going?</h3>
                <p class="text-default small d-inline-block align-middle mr-2 mb-0"><em>(You will be added to our waitlist. If you want immediate confirmation, please make a booking.)</em></p>
                <a href="#" class="text-uppercase text-primary font-weight-bold d-inline-block align-middle"  data-toggle="modal" data-target="#rsvpModal" >Yes</a> </div>
        ...
        <div class="col-12 col-lg-4">
          <div class="otherIntro boxStyle moveUp">
            ...
            <div class="highList">
              ...
              <ul class="clearfix">
                <?php 
           if(!empty($itineraryData->type_highlights)){$highLights = explode(',',$itineraryData->type_highlights);$count = count($highLights);}
          ...
          <div class="createrIntro boxStyle ">
			...
			<br/><small class="internal-verify mt-3 d-inline-block"><b class="callVerify"> <img src="<?php echo base_url();?>assets/img/icon/<?php echo $verifyimg;?>" alt="<?php echo $hostData['verified_by'];?>" /> </b>&nbsp; Verified</small>
			</p>
	...
	<form class="pt-3" id="rsvpFormData">
      <div class="modal-body">
        ...
        <p class="font-weight-semibold text-center pl-2 pr-2">Please give us your details so we can add you to our waitlist.<br>
		  ...
		  <input type="hidden" class="form-control"name="itinerary_id" value="<?php echo $itineraryData->id;?>"/>		 
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="rsvpDoneX">Done</button>
      </div>
	  </form>
    </div>
  </div>
...
$("#rsvpFormData").validate({
			...
			submitHandler: function(form, event) {
				...
				meetRsvpData();
				$('#rsvpFormData')[0].reset();
				}
	});
				
function meetRsvpData(){				
