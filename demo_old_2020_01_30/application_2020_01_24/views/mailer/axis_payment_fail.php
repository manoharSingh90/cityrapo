  ...
  <tr>
    <td>
	  ...
	  <tr valign="top" bgcolor="#f9f9f9">
        <td width="25"><img src="<?php echo base_url();?>assets/mailer_img/mailerheader_left.png" alt="left" style="display: block; border: none; max-width: 100%;"/></td>
        <td width="670"><table cellpadding="0" cellspacing="0" width="670" style="width: 100%; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #888; box-shadow:0 0 10px rgba(0,0,0,0.2); font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
            ...
            <tr>
              <td width="25"></td>
              <td width="620" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">Dear Guest,</td>
              <td width="25"></td>
            </tr>
			<tr>
              <td width="25"></td>
              <td width="620" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">We noticed that you have tried to a make a booking on City Explores website, but unfortunately the booking could not be processed due to payment failure.</td>
              <td width="25"></td>
            </tr>
			<tr>
              <td width="25"></td>
              <td width="620" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">Please go back to the City Explorers and kindly make the booking again.</td>
              <td width="25"></td>
            </tr>
			<tr>
              <td width="25"></td>
              <td width="620" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">Any deductions from your bank account will be reversed with 72 hours.</br>
			<p>Any deductions from your bank account will be reversed with 72 hours.</p></td>
              <td width="25"></td>
            </tr>
            <tr>
              <td colspan="3" height="20"></td>
			...
			<tr>
				<td width="30"></td>
			  <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif; line-height:1.75;">For any assistance, please write to us at - help@cityexplorers.in</td>
			  <td width="30"></td>
			</tr>
			<tr>
			  <td colspan="3" height="30"></td>
