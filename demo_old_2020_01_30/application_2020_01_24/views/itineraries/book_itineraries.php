		...
		//	}			
          ...
          <fieldset class="infoFill">
			...
			<?php 
              ...
              <li class="form-group col-6 col-sm-4">
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="bookingTraveller-01" name="traveller-type" value="privateType" class="custom-control-input" checked required />
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-sm-6 placeVaild">
                ...
                <input type="text" name="default_full_name" class="form-control" placeholder="Full Name" id="adult_fullname" value="Ankush Chauhan" required />
				<div class="name_error"></div>
              </li>
              <li class="form-group col-12 col-sm-6 placeVaild">
                <label class="col-form-sublabel">Email</label>
                <input type="email" name="email" class="form-control" placeholder="Email" id="email" value="ankush@unikove.com"  required />
		  ...
		  <input type="hidden" name="additional_total_price" id="additional_total_price" value="<?php //echo $additionalPrice;?>"/>		
            ...
            <ul class="infoTax-list">
              <li><span>SGST <b id="sgst_percent"></b></span> Rs. <b id="sgst_price">0</b><input type="hidden" name="sgst_price_value" id="sgst_price_value"/></li>
            ...
            <div class="text-center infoTerms placeVaild mt-3">
              <div class="custom-control custom-checkbox custom-control-inline ">
                <input type="checkbox" name="term_condition" id="terms-agree" value="1" class="custom-control-input" checked required /> 
...
if(chkbox==true){
	...
	//$('#sgst_price_value').val($('#sgst_price').html());
	//$('#cgst_price_value').val($('#cgst_price').html());
	//$('#igst_price_value').val($('#igst_price').html());
  ...
  if(valdata=='privateType'){
		...
		else
		{
		 ...
		 //======= SGST Code ==========//
		 var SgstPercent = (parseInt(adultPrice)+parseInt(aditionalCost))*parseInt(sgst)/100;
		 $('#sgst_price').html(SgstPercent);
		 $('#sgst_price_value').val(SgstPercent);
		 //======= CGST Code ==========//
		 var CgstPercent = (parseInt(adultPrice)+parseInt(aditionalCost))*parseInt(cgst)/100;
		 $('#cgst_price').html(CgstPercent);
		 $('#cgst_price_value').val(CgstPercent);
		 //======= IGST Code ==========//
		 var IgstPercent = (parseInt(adultPrice)+parseInt(aditionalCost))*parseInt(igst)/100;
  ...
  if(valdata=='groupType'){
		...
		else
		{
		 ...
		 var aditionalCost = $('#additional_cost_price').val(); //'<?php echo $itineraryData->additional_price;?>';
		//======= SGST Code ==========//
		 var SgstPercent = (parseInt(adultGroupPrice)+parseInt(aditionalCost))*parseInt(sgst)/100;
		 $('#sgst_price').html(SgstPercent);
		 $('#sgst_price_value').val(SgstPercent);
		 //======= CGST Code ==========//
		 var CgstPercent = (parseInt(adultGroupPrice)+parseInt(aditionalCost))*parseInt(cgst)/100;
		 $('#cgst_price').html(CgstPercent);
		 $('#cgst_price_value').val(CgstPercent);
		 //======= IGST Code ==========//
		 var IgstPercent = (parseInt(adultGroupPrice)+parseInt(aditionalCost))*parseInt(igst)/100;
		 $('#igst_price').html(IgstPercent);
		 $('#igst_price_value').val(IgstPercent);
  ...
  if(valdata=='familyType'){
		...
		else
		{
		 ...
		 //alert(familyKidsPrice_5);
		 var aditionalCost = $('#additional_cost_price').val(); //'<?php echo $itineraryData->additional_price;?>';
		 //======= SGST Code ==========//		 
		 var SgstPercent = (parseInt(adultFamilyPrice)+parseInt(aditionalCost))*parseInt(sgst)/100;
		 $('#sgst_price').html(SgstPercent);
		 $('#sgst_price_value').val(SgstPercent);		
		 //======= CGST Code ==========//
		 var CgstPercent = (parseInt(adultFamilyPrice)+parseInt(aditionalCost))*parseInt(cgst)/100;
		 $('#cgst_price').html(CgstPercent);
		 $('#cgst_price_value').val(CgstPercent);
		 //======= IGST Code ==========//
		 var IgstPercent = (parseInt(adultFamilyPrice)+parseInt(aditionalCost))*parseInt(igst)/100;
		 $('#igst_price').html(IgstPercent);
		 $('#igst_price_value').val(IgstPercent);
...
function calcTotal() {
    ...
    //======= SGST Code ==========//
    var SgstPercent = (parseInt(adultFamilyPrice) + parseInt(aditionalCost) + parseInt(familyKidsPrice) + parseInt(familyKidsPrice_5) + parseInt(familyKidsPrice_7)) * parseInt(sgst) / 100;
    $('#sgst_price').html(SgstPercent);
    $('#sgst_price_value').val(SgstPercent);
    //======= CGST Code ==========//
    var CgstPercent = (parseInt(adultFamilyPrice) + parseInt(aditionalCost) + parseInt(familyKidsPrice) + parseInt(familyKidsPrice_5) + parseInt(familyKidsPrice_7)) * parseInt(cgst) / 100;
    $('#cgst_price').html(CgstPercent);
    $('#cgst_price_value').val(CgstPercent);
    //======= IGST Code ==========//
    var IgstPercent = (parseInt(adultFamilyPrice) + parseInt(aditionalCost) + parseInt(familyKidsPrice) + parseInt(familyKidsPrice_5) + parseInt(familyKidsPrice_7)) * parseInt(igst) / 100;
    $('#igst_price').html(IgstPercent);
    $('#igst_price_value').val(IgstPercent);

    var gstPrice = parseInt(SgstPercent) + parseInt(CgstPercent) + parseInt(IgstPercent);
    var familyNetPrice = adultFamilyPrice + gstPrice + parseInt(aditionalCost);
    var totalAmounts = parseInt(familyNetPrice) + parseInt(familyKidsPrice) + parseInt(familyKidsPrice_5) + parseInt(familyKidsPrice_7);
