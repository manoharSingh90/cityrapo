        ...
        <td width="670"><table cellpadding="0" cellspacing="0" width="670" style="width: 100%; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #888; box-shadow:0 0 10px rgba(0,0,0,0.2); font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
            ...
            <tr bgcolor="#fcfcfc" valign="middle">
              ...
              <td width="620" style="color: #888; font-size: 13px; font-family:Arial, Helvetica, sans-serif;"><table cellpadding="0" cellspacing="0" style="width:100%; margin: 0 auto; border: none; color: #888888; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">
                  <tr>
                    <td width="380"><div style="display: inline-block; vertical-align: middle; color: #888; font-size: 13px; font-family:Arial, Helvetica, sans-serif; line-height:1.75;"><span style="display: inline-block; vertical-align: middle; width: 35px; height: 35px; border-radius: 50%; overflow: hidden; background: #ccc; margin-right:10px;"><img src="<?php echo base_url();?>assets/mailer_img/placeholder.jpg" style="display: block; border: none; max-width: 100%; " alt="#"/></span> with <?php echo $userdetail->host_first_name.' '.$userdetail->host_last_name;?> </div></td>
                    <td width="240"><strong style="font-weight:normal; font-size:12px; color:#555; line-height:1.75;">Want to connect?</strong><br>
                      <a href="mailto:travelswithnalina@gmail.com" target="_blank" style="color: #3c8aca; text-decoration: none;  line-height:1.75;"><img src="<?php echo base_url();?>assets/mailer_img/icon-mail-blue.png" style="display: inline-block; vertical-align: middle; border: none; margin-top:-2px;" alt="#"/> <?php echo $userdetail->host_email;?></a><br>
                      <a href="#" target="_blank" style="color: #3c8aca; text-decoration: none;  line-height:1.75;"><img src="<?php echo base_url();?>assets/mailer_img/icon-call-blue.png" style="display: inline-block; vertical-align: middle; margin-top:-2px; border: none; " alt="#"/> +91 <?php echo $userdetail->host_mob_no;?></a></td>
                  </tr>
                </table></td>
              <td width="25"></td>
            </tr>
              ...
              <td width="620"><table cellpadding="0" cellspacing="0" style="width:100%; margin: 0 auto; border: none; color: #888888; font-size: 12px; font-family:Arial, Helvetica, sans-serif;">
                  ...
                  <tr>
                    ...
                    <td width="600"><table cellpadding="0" cellspacing="0"  bgcolor="#fdfdfd" style="width:100%; margin: 0 auto; background: #fdfdfd; border:1px solid #f7f7f7; color: #888888; font-size: 13px; font-family:Arial, Helvetica, sans-serif;">
                        ...
                        <tr>
                          <td width="25"></td>
                          <td width="530" style="color:#888; font-size: 13px; font-family:Arial, Helvetica, sans-serif;"><img src="<?php echo base_url();?>assets/mailer_img/icon-location.png" style="display: inline-block; vertical-align: middle; border: none; margin-top:-3px;" alt="#"/> <?php echo $hostdetail->origin_city;?></td>
                          <td width="25"></td>
                        </tr>
                        <tr>
            ...
            ?>
                          ...
                          <td width="530" style="color:#888; font-size: 12px; font-family:Arial, Helvetica, sans-serif;"><img src="<?php echo base_url();?>assets/mailer_img/icon-date.png" style="display: inline-block; vertical-align: middle; border: none; margin-top:-3px;" alt="#"/> <?php echo $itinerary_date;?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $slotdata->start_pickup_time.' ('.$Smtime.' UTC )';?> - <?php echo $slotdata->end_dropoff_time.' ('.$Emtime.' UTC )';?>&nbsp;&nbsp;|&nbsp;&nbsp;Cut-Off Time: <?php echo $slotdata->cutt_off_time;?></td>
                          <td width="25"></td>
                        </tr>
                        <tr>
                          <td colspan="3" height="20"></td>
          ...
          ?></strong></td>
              ...
              <td width="25"></td>
               ...
               <td align="left" style="line-height:1.5;">Rs.<?php echo $additional_cost; ?></td>
                ...
                <?php
                         ...
                         $overallmount = $additional_total_cost + $traveller_price + (isset($kids10Data[0]['kids10_price']) ? $kids10Data[0]['kids10_price'] : 0) + (isset($kids7Data[0]['kids7_price']) ? $kids7Data[0]['kids7_price'] : 0) + (isset($kids5Data[0]['kids5_price']) ? $kids5Data[0]['kids5_price'] : 0);
            ...
            ?>
                        <tr>
                          <td><strong><?php echo $hostdetail->host_first_name.' '.$hostdetail->host_last_name;?></strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="color:#3c8aca; line-height:1.5;"><img src="<?php echo base_url();?>assets/mailer_img/icon-mail-blue.png" style="display: inline-block; vertical-align: middle; border: none; margin-top:-2px; " alt="#"/> <?php echo $hostdetail->host_email;?>&nbsp;&nbsp;&nbsp;&nbsp; <img src="<?php echo base_url();?>assets/mailer_img/icon-call-blue.png" style="display: inline-block; margin-top:-2px; vertical-align: middle; border: none; " alt="#"/><?php echo '+91 '.$hostdetail->host_mob_num;?></td>
                        </tr>
                        <tr>
                          <td height="15"></td>
                        </tr>
