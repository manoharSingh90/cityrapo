	...
	?>
      ...
      <div class="container">
        <div class="bookingIntro"> <a href="<?php echo base_url();?>home/<?php echo $back;?>" class="text-uppercase">
          <svg version="1.1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16" style="enable-background:new 0 0 16 16;" xml:space="preserve">
          ...
          <h3>
            <svg version="1.1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 19.2 19" style="enable-background:new 0 0 19.2 19;" xml:space="preserve">
    ...
    <div class="modal-content">
	  ...
	  <?php echo $termConditionData[0]->booking_guidline;?>
        ...
        <!--<ul class="list-bullet">
          <li>Ensure that you reach meeting point on time.</li>
          <li>You can bring along those who have registered for the walk.</li>
          ...
          <li>Keep yourself hydrated. Carry bottled water.</li>
           </ul>-->
      </div>
      <div class="modal-footer">
...
if(chkbox==true){
  ...
  if(valdata=='privateType'){
		...
		if(mk_city=='New Delhi') {
		 ...
		 var privateNetPrice = adultPrice+parseInt(aditionalCost);
  ...
  if(valdata=='groupType'){
		...
		if(mk_city=='New Delhi') {
		 ...
		 var groupNetPrice = adultGroupPrice+parseInt(aditionalCost);
  ...
  if(valdata=='familyType'){
		...
		if(mk_city=='New Delhi') {
		 ...
		 var familyNetPrice = adultFamilyPrice+parseInt(aditionalCost);
		 if(familyVal<=1){
