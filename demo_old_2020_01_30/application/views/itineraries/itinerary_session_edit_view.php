...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    ...
    <div class="float-right floatBtn"> <a href="my_itineraries.html" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">cancel</a> <a id="saveCall" href="#" class="btn btn-secondary mr-3">Draft</a> <a id="callDone" href="#" class="btn btn-primary">Done</a> </div>
  </div>
  ...
  <ul>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="itineraryUrl" id="itineraryUrl" value="<?php echo base_url().'session/'.base64_encode($itineraryId).'/'.$serviceId.'/'.$otherlang.'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->origin_city)).'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->itinerary_title));?>"/>
		...
		<?php }?>
          ...
          <ul class="form-row no-gutters">
           ...
           <?php if($otherlang!='English'){ ?>
			...
			<?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Meet-up Title (<?php echo $otherlang;?>)</label>
			...
			<?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Type Tag Line (<?php echo $otherlang;?>)</label>
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_description" class="form-control" name="itinerary_description" placeholder="Give details of your service (max 5000 characters)" data-rule-required="true" data-rule-maxlength="5000" required><?php if(isset($editDataSet->itinerary_description))echo trim($editDataSet->itinerary_description);?></textarea>
            </li>
           <?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-label text-light text-capitalize">What to Expect (<?php echo $otherlang;?>)</label>
              <textarea id="other_lang_desc" class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 5000 characters)" data-rule-required="true" data-rule-maxlength="5000" required><?php if(isset($editDataSet->other_itinerary_description))echo trim($editDataSet->other_itinerary_description);?></textarea>
            </li>
			<?php } ?>
            <li class="form-group col-12 placeVaild">
		...
		<div class="col-6 col-sm-auto">
		  ...
		  <div class="mb-3 mt-1" > <a href="#" class="text-uppercase font-weight-bold text-primary" data-toggle="modal" data-target="#addSpeakerModal">+ Add More</a></div>
		   
          <h3 id="fillInclusions" class="col-form-label">Inclusions & exclusions</h3>
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Inclusions</label>
              <textarea id="itinerary_inclusions" class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 1000 characters)" data-rule-maxlength="1000" data-rule-required="true"><?php if(isset($editDataSet->itinerary_inclusions))echo $editDataSet->itinerary_inclusions;?></textarea>
            </li>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Exclusions</label>
              <textarea id="itinerary_exclusions" class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 1000 characters)" data-rule-maxlength="1000" data-rule-required="true"><?php if(isset($editDataSet->itinerary_exclusions))echo $editDataSet->itinerary_exclusions;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_splmention" class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" data-rule-maxlength="1500" data-rule-required="true"><?php if(isset($editDataSet->itinerary_spl_mention))echo $editDataSet->itinerary_spl_mention;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters mb-4">
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <div class="placeVaild">
                <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 1000 characters)" data-rule-maxlength="1000" id="faq_answer_01" data-rule-required="true"><?php echo trim($faqs->itinerary_faq_answer);?></textarea>				
              </div>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input id="host_firstname" type="text" name="itinerary_host_firstname" class="form-control ignore text-capitalize" placeholder="First Name" 
			  value="<?php if(isset($editDataSet->host_first_name) && $editDataSet->host_first_name!='')echo $editDataSet->host_first_name;else{echo $hostProfile[0]->host_first_name;}?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Last Name</label>
              <input id="host_lastname" type="text" name="itinerary_host_lastname" class="form-control ignore text-capitalize" placeholder="Last Name" 
			  value="<?php if(isset($editDataSet->host_last_name) && $editDataSet->host_last_name!='')echo $editDataSet->host_last_name;else{echo $hostProfile[0]->host_last_name;}?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Mobile</label>
			  <span class="mobileCheck">+91-</span>
              <input id="host_mobile" type="text" name="itinerary_host_mobile" class="form-control ignore" placeholder="Mobile Number" 
			  value="<?php if(isset($editDataSet->host_mob_num) && $editDataSet->host_mob_num!='')echo $editDataSet->host_mob_num;else{echo $hostProfile[0]->host_mob_no;}?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_email) && $editDataSet->host_email!='')echo $editDataSet->host_email;else{echo $hostProfile[0]->host_email;}?>" data-rule-required="true"/>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  <span class="mobileCheck">+91-</span>
              <input id="host_emergency_no" type="text" name="itinerary_host_emergency" class="form-control ignore" placeholder="Mobile Number" value="<?php if(isset($editDataSet->host_emergency_contact_num))echo $editDataSet->host_emergency_contact_num;?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
            </li>
          </ul>
        </fieldset>
         <fieldset>
          ...
          <ul class="form-row">
		   <?php 
            ...
            <li class="form-group col-6 placeVaild">
              ...
              <input id="route_slot01_duration" type="text" name="itinerary_route_slot01_duration[]" class="form-control ignore hourpicker" placeholder="Total Duration" value="<?php if(!empty(@$draftRoutData->total_durations))echo @$draftRoutData->total_durations;else{echo '0:00';}?>" data-rule-required="true" autocomplete="off"/>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Cut-off Time (Hours)</label>
              <input id="route_slot01_cutofftime" type="text" name="itinerary_route_slot01_cutofftime[]" class="form-control ignore cutoffpicker" placeholder="Cut-off Time" value="<?php if(!empty(@$draftRoutData->cutt_off_time))echo @$draftRoutData->cutt_off_time;else{echo '0:00';}?>" data-rule-required="true" autocomplete="off"/>
            </li>			
          </ul>      
             ...
             <li class="form-group col-12 col-sm-6 pt-2 offset-0 offset-sm-6" data-id="kids-3">
              ...
              <li class="form-group col-12 col-sm-6  pt-2">
                <div class="form-row">
                  <div class="col-12 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Kids (Age)</label>
                    <select class="form-control ignore" name="itinerary-traveller-family-kids01-age[]" data-rule-required="true">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Min. No. Kids</label>
                    <input type="number" class="form-control ignore" name="itinerary_traveller_family_kids01_minnumber[]" placeholder="0" min="1" id="family_kids_min_no" data-rule-required="true" value="1" disabled/>
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Max. No. Kids</label>
                    <input type="number" class="form-control ignore" name="itinerary-traveller-family-kids01-maxnumber[]" placeholder="0" id="family_kids_max_no" data-rule-required="true" disabled/>
                  </div>
                </div>
              </li>
              -->
              <?php } ?>
              <!--<li class="form-group col-12 text-right"><a href="#" class="text-uppercase font-weight-bold" data-toggle="modal" data-target="#addKidsModal" id="addMoreKids">+ Add More</a> </li>-->
            </ul>
          </div>
        </fieldset>
        <fieldset>
...
$(window).on('load', function() {
    ...
    if (adminStatus == 1) {
        ...
        $('.floatBtn').html('');
		$('#addSponsor').remove();		
        $('.floatBtn').append('<a href="<?php echo base_url()?>itineraries/session" class="btn btn-link text-default">Back</a>')
    }
...
$(document).on('click', '#saveCall', function(e) {
    e.preventDefault();
    validator.destroy();
    $('#formItinerary').attr('action', 'editSessionSaveItinerary');
    $('.loadingWrap').show();
...
$(document).on('click', '#callDone', function(e) {
    ...
    validator.destroy();
    $('#formItinerary').attr('action','editSessionDoneItinerary');
    $('.loadingWrap').show();
    $("#formItinerary").validate({
        errorElement: 'small',
        errorPlacement: function(error, element) {
