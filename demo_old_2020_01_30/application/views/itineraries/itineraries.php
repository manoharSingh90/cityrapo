  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
	 <form id="trainingForm">
      ...
      <div class="modal-body">	 
        <div class="confirmationText text-left pl-1 pr-1">
		<h5 class="mb-3 text-dark">Dear Host,</h5>
		<p class="mb-3 text-dark"><strong class="font-weight-bold text-secondary h5 d-block">Congratulations!</strong> You are now part of the City Explorers team.</p>
		<p class="mb-3 text-dark">You have joined our mission to transform ordinary trips into customized, extraordinary experiences.</p>
		<p class="mb-3 text-dark">Our common passion to share and exchange highlights of our country to travellers and fellow citizens shall bring great results ahead for society and help in preserving the true spirit of the diverse nation. </p>
		<p class="mb-3 text-dark">We have many ideas to share with you. We begin with some training documents which give you complete clarity about processes. </p>
		<p class="mb-4 text-dark">How to <a href="#">Create Products Guidelines</a> / <a href="#">Do’s & Don’ts</a></p>
<p class="mb-2 text-dark">You will be able to create your first itinerary after you agree to have read the training documents.</p>
<div class="custom-control custom-checkbox custom-control-inline text-left small">
  ...
  <label class="custom-control-label text-dark pt-1" for="trainingCheckInput">I check here to agree to have read the training documents</label>
</div>
<small class="d-block pb-3 pt-2 font-italic text-light">*In case of any queries you may please write to us at <a href="mailto:training@cityexplorers.in">training@cityexplorers.in</a></small>
<p class="text-dark">Follow City Explorers to find great new ideas! </p>
