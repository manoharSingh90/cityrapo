...
<main>
  <div class="container">
    ...
    <?php /* $hostDatas = getHostDetail($hostData['host_verification_type']);
      ...
      <div class="profileRight clearfix">
        <div class="profileData">
          ...
          <div class="row">
            <div class="col-12 pt-2">
              ...
              <ul class="clearfix mb-3 pt-2">
               ...
               foreach ($interest as $value) { ?>
                 <li class="roundedBox d-inline-block m-1 text-capitalize"><?php echo $value;?></li>
              <?php  } ?>
            ...
            <div class="col-12 col-sm-6 pt-2">
              ...
              <p class="text-capitalize"><?php echo $profile_data->known_languages = str_replace(',', ',&nbsp;', $profile_data->known_languages); ?></p>
            </div>
            <div class="col-12 pt-2">
              <p class="smallTitle">Preferred Cities</p>
              <p class="text-capitalize"><?php echo $profile_data->preferred_cities = str_replace(',', ',&nbsp;', $profile_data->preferred_cities); ?></p>
            </div>
            <div class="col-12 pt-2">
            ...
            <div class="col-12 pt-2">
			 ...
			 ?>
			  ...
			  <?php
				 ...
				 <div class="custom-control custom-checkbox custom-control-inline titleCheck ml-0">
                <input type="checkbox" id="sameAbove" class="custom-control-input" checked="checked" disabled>
    ...
    <div class="modal-content">
	 <form id="trainingForm">
      ...
      <div class="modal-body">	 
		...
		<p class="mb-3 text-dark">How to <a href="#">Create Products Guidelines</a> / <a href="#">Do’s & Don’ts</a></p>
