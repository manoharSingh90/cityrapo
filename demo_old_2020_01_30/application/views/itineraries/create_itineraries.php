...
<ul class="form-row">
  <li class="form-group col-12 placeVaild">
    <label class="dragImageBox">
      ...
      <input type="text" class="form-control lowKey ignore" name="hide_feature_img" value="<?php if(@$draftData->feature_img!='')echo $draftData->feature_img;?>" data-rule-required="true" >
      <div class="dragImageBox-info" 
...
<ul class="form-row">
  <li class="form-group col-12 col-md-4 placeVaild">
    <label class="dragImageBox text-center">
      ...
      <input type="text" class="form-control lowKey ignore" name="hide_additional_img1" value="<?php if(@$draftData->additional_img_1!='')echo $draftData->additional_img_1;?>" data-rule-required="true" >
      <div class="dragImageBox-info" 
...
<li class="form-group col-12 col-md-4 placeVaild">
  <label class="dragImageBox text-center">
    ...
    <input type="text" class="form-control lowKey ignore" name="hide_additional_img2" value="<?php if(@$draftData->additional_img_2!='')echo $draftData->additional_img_2;?>" data-rule-required="true">
    <div class="dragImageBox-info" 
...
<li class="form-group col-12 col-md-4 placeVaild">
  <label class="dragImageBox text-center">
    ...
    <input type="text" class="form-control lowKey ignore" name="hide_additional_img3" value="<?php if(@$draftData->additional_img_3!='')echo $draftData->additional_img_3;?>" data-rule-required="true" >
    <div class="dragImageBox-info" 
