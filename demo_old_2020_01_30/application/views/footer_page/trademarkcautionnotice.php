    ...
    <div class="container text-dark font-regular">
      ...
      <table class="table-bordered table mt-3 mb-4">
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td><img src="<?php echo base_url();?>assets/img/trademark/cityexplorer_logo.jpg" alt="cityexplorer" /></td>
            <td>39</td>
            <td>3770899</td>
            <td>Registered</td>
          </tr>
          <tr>
            <td>2</td>
            <td><img src="<?php echo base_url();?>assets/img/trademark/delhiwalk_logo.jpg" alt="delhiwalk" /></td>
            <td>39</td>
            <td>2553097</td>
            <td>Registered</td>
          </tr>
          <tr>
            <td>3</td>
            <td><img src="<?php echo base_url();?>assets/img/trademark/cilinar_logo.jpg" alt="cilinar" /></td>
            <td>39</td>
            <td>2606077</td>
            <td>Registered</td>
          </tr>
          <tr>
            <td>4</td>
            <td><img src="<?php echo base_url();?>assets/img/trademark/citymavericks_logo.jpg" alt="citymavericks" /></td>
            <td>39</td>
            <td>3180350</td>
            <td>Registered</td>
          </tr>
