  ...
  <div class="knowmoreData">
      ...
      <div class="container">
        ...
        <div class="row areaIntro pt-5 pb-5 border-top align-items-center">
          <div class="col-12 col-sm-6">
            <div class="areaIntro-img"><img src="<?= base_url('assets/img/knowmore/south/fullimage_01.jpg')?>" alt="fullimage_01"/></div>
          </div>
          <div class="col-12 col-sm-6">
            <h3>States</h3>
    ...
    <div class="container">
      ...
      <ul class="blockList clearfix">
        <li> <a> <img src="<?= base_url('assets/img/knowmore/south/thumbimage_01.jpg')?>" alt="thumbimage_01"/> </a> </li>
        <li> <a> <img src="<?= base_url('assets/img/knowmore/south/thumbimage_03.jpg')?>" alt="thumbimage_03"/> </a> </li>
        <li> <a> <img src="<?= base_url('assets/img/knowmore/south/thumbimage_02.jpg')?>" alt="thumbimage_02"/> </a> </li>
      </ul>
    </div>
  </div>
