	  ...
	  <span data-toggle="modal" data-target="#rejectModal">Reject</span></a> 
		  <?php if($itineraryData->translator==0){
			    $targetId = '#approveModal';
                    ...
                    if($itineraryData->translator_confirm==0){
          ...
          <div class="itinerariesSetting">
            ...
            <label>
              ...
              <path d="M14.6,5.7l-1.7,0.5L13,6.5c0.8,2.7-0.7,5.6-3.5,6.5s-5.6-0.7-6.5-3.5S3.8,3.8,6.5,3c1.2-0.4,2.5-0.3,3.7,0.3l0.3,0.1
				...
				l3.7,3.4l6.5-6.5l-1.3-1.3L7.9,7.7L5.4,5.4z"/>
            </svg> </label>
          </div>
			<?php } ?>
              ...
              <div class="row">
                <div class="col-12 col-sm-7">
                  <p class="intro-theme d-inline-block align-middle float-none"><span>Themes:</span>
					 <?php $themesArr = array();
				       $totalTime = 0;
					 if(!empty($itineraryData->itinerary_theme)){
          ...
          <div class="bookIntro boxStyle">
            ...
            <div class="row pt-4 clearfix">
              <div class="col-12 col-sm-9">
                <div class="bookIntro-cost pt-4 pb-4">
                  <ul>
				   <?php 
              ...
              <!--<div class="col-12 col-sm-3"> <a class="btn btn-primary btn-block mt-5" href="#">Book</a> </div>-->
            </div>
          </div>
        </div>
...
//========== itinerary rejected reason keypress js ===========//
...
$('.changeLang').on('change',function(){
	...
	var detailURL = '<?php echo base_url()?>admin/admin_detail_itineraries_experience?itinerary_id='+itinerary_id+'&flag=<?php echo $flag?>'+'&service_id='+serviceid+'&lang='+itinerary_lang;		
