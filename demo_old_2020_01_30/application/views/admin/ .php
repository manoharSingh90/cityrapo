                ...
                <fieldset id="filldetail">
                    ...
                    <ul class="form-row no-gutters">
                            ...
                            <select class="form-control" name="originCity" id="originCity" required data-rule-required="true">
                                ...
                                foreach($userCity as $city):
                                    ...
                                    foreach($cityArr as $value):
                                        ...
                                        <option value="<?php echo $value;?>" <?php if(isset($editDataSet->origin_city)==$value)echo 'selected';?> > <?php echo $value;?> </option>
                        ...
                        <li class="form-group col-12 col-md-12 placeVaild">
                            ...
                            <textarea class="form-control" name="itinerary_description" placeholder="Give details of your service (max 400 characters)" id="itinerary_description" required data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_description))echo trim($editDataSet->itinerary_description);?></textarea>
                            <div id="DescError" class="error errorOwn"></div>
                        </li>
                        <?php if($otherlang!='English'){ ?>
                            <li class="form-group col-12 col-md-12 placeVaild">
                                <label class="col-form-label text-light">What to Expect (<?php echo $otherlang;?>)</label>
                                <textarea class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 400 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->other_itinerary_description))echo trim($editDataSet->other_itinerary_description);?></textarea>
                        ...
                        <li class="form-group col-12 placeVaild">
                            ...
                            <ul class="tagList">
                                <?php
                                if(!empty($editDataSet->experience_type)){
                                    $expType = explode(',',$editDataSet->experience_type);
                                    $expType1 = explode(',',$editDataSet->experience_type);
                                    $expvalue = array_combine($expType,$expType1);
                                    if(!empty($expvalue['Indoor'])){
                                        $indoorclass = 'active';
                                    }
                                    else{
                                        $indoorclass = '';
                                    }
                                    if(!empty($expvalue['Outdoor'])){
                                        $outdoorclass = 'active';
                                    }
                                    else{
                                        $outdoorclass = '';
                                ...
                                <li>
                                    <label class="tagBox <?php echo @$indoorclass;?>">
                                        <input type="checkbox" class="ignore" name="experience_itinerary_type[]" data-rule-required="true" value="Indoor" <?php if(isset($expvalue['Indoor'])=='Indoor') echo 'checked="checked"';?> />
                                        Indoor</label>
                                </li>
                                <li>
                                    <label class="tagBox <?php echo @$outdoorclass;?>">
                                        <input type="checkbox" name="experience_itinerary_type[]" value="Outdoor" <?php if(isset($expvalue['Outdoor'])=='Outdoor') echo 'checked="checked"'; ?> />
                                        Outdoor</label>
                                </li>
                            </ul>
                        </li>
                        <li class="form-group col-12 col-md-12 placeVaild">
                            ...
                            <select id="typeThemes" name="itinerary_theme[]" class="form-control ignore" placeholder="Select themes" multiple data-rule-required="true">
                                <?php
                                if(!empty($editDataSet->itinerary_theme)){
                    ...
                    <ul class="form-row no-gutters">
                        <li class="form-group col-12 placeVaild">
                            ...
                            <select id="typeHighlights" class="form-control" name="itinerary_highlights[]" placeholder="Type a highlight (separate using commas)" multiple data-rule-required="true">
                                <?php
                        ...
                        <li class="form-group col-12 placeVaild">
                            ...
                            <select id="typeFeatures" type="text" class="form-control" name="itinerary_features[]" placeholder="Type a features (separate using commas)" multiple data-rule-required="true">
                                <?php
                        ...
                        <li class="form-group col-12 placeVaild">
                            ...
                            <select id="typeSearchTags" type="text" name="itinerary_searchtags[]" class="form-control" placeholder="Search Tags" multiple data-rule-required="true">
                                <?php
	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
                    ...
                    <ul class="form-row no-gutters">
                        <li class="form-group col-12 placeVaild">
                            ...
                            <select id="typeLanguages" type="text" class="form-control" name="preferences_languages[]" placeholder="Select my languages" multiple data-rule-required="true">
                                <?php
                    ...
                    <ul class="form-row no-gutters">
                        <li class="form-group col-12 placeVaild">
                            ...
                            <textarea class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 400 characters)" id="itinerary_inclusions" data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_inclusions))echo trim($editDataSet->itinerary_inclusions);?></textarea>
                        </li>
                        <li class="form-group col-12 placeVaild">
                            <label class="col-form-sublabel">Exclusions</label>
                            <textarea class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 400 characters)" id="itinerary_exclusions" data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_exclusions))echo trim($editDataSet->itinerary_exclusions);?></textarea>
                        </li>
                    </ul>
                    ...
                    <ul class="form-row no-gutters">
                        <li class="form-group col-12 placeVaild">
                            ...
                            <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 400 characters)" id="itinerary_splmention" data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_spl_mention))echo trim($editDataSet->itinerary_spl_mention);?></textarea>
                        </li>
                    </ul>
                        ...
                        if(!empty($draFaqData)){
                            foreach($draFaqData as $key=>$faqs):
                                ...
                                <li class="form-group col-12 placeVaild">
                                    ...
                                    <div class="placeVaild"> <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 200 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="200"><?php echo trim($faqs->itinerary_faq_answer);?></textarea>
                                        <?php
                                        if($key!=0){
                                            if(count($draFaqData)!=1)echo '<a href="#" class="btn btn-link removeFaqli">Remove</a>';} ?>
                                    </div>
                                </li>
                            <?php endforeach;} ?>
                ...
                <fieldset>
                    ...
                    <ul class="form-row">
                        ...
                        <li class="form-group col-12 col-md-12">
                            <div class="form-row">
                                <div class="col-12 col-sm-6 placeVaild">
                                    ...
                                    <input type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Drop-Off Point" id="dropoff_point" value="<?php echo $routdata->drop_off_point;?>" data-rule-required="true" autocomplete="off"/>
                                </div>
                                <div class="col-12 col-sm-6 placeVaild">
                        ...
                        <li class="form-group col-6 placeVaild">
                            <label class="col-form-sublabel">Cut-off Time (minutes)</label>
                        ...
                        <li class="form-group col-12 col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-sm-7 placeVaild">
                                    ...
                                    <input type="text" name="itinerary_route_slot01_stop01_location[]" class="form-control ignore" placeholder="Type a location" id="route_slot01_stop01_location" value="<?php echo $routdata->stop_location;?>" data-rule-required="true" autocomplete="off"/>
                                </div>
                                <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
                                    <label class="col-form-sublabel">Time</label>
                                    <input type="text" name="itinerary_route_slot01_stop01_time[]" class="form-control timepicker ignore" placeholder="Time" id="route_slot01_stop01_time" value="<?php echo $routdata->stop_time;?>" data-rule-required="true" autocomplete="off"/>
                                </div>
                                <div class="col-12 col-sm-7 pt-4 placeVaild">
                                    <textarea class="form-control ignore" name="itinerary_route_slot01_stop01_description[]" placeholder="Add a description" id="route_slot01_stop01_description" data-rule-required="true"><?php echo trim($routdata->description);?></textarea>
                                </div>
                            </div>
                        </li>
                        <?php endforeach;} ?>
                                ...
                                <li class="form-group col-12 col-sm-6 mb-1  pt-2">
                                    <div class="form-row">
                                        ...
                                        <div class="col-6 col-sm-4 placeVaild">
                                            ...
                                            <input type="number" class="form-control ignore" name="itinerary_traveller_family_adult_minnumber" placeholder="0" min="1" id="adult_min_no" value="<?php echo isset($drafFamilyData[0]["family_adult_min_no"]) ? $drafFamilyData[0]["family_adult_min_no"] : ""; ?>" data-rule-required="true"  />
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Adult - Max. No.</label>
                                            <input type="number" class="form-control ignore" name="itinerary_traveller_family_adult_maxnumber" placeholder="0" id="adult_max_no" value="<?php echo isset($drafFamilyData[0]["family_adult_max_no"]) ? $drafFamilyData[0]["family_adult_max_no"] : ""; ?>" data-rule-required="true" />
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 col-sm-4  placeVaild">
                                            ...
                                            <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                                                <input id="travellerType-kids-below10" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore keepCheck" value="10" <?php echo isset($ageTenKey) ? "checked" : ""; ?> data-rule-required="true"  />
                                        ...
                                        <div class="col-6 col-sm-4 placeVaild">
                                            ...
                                            <input id="family_kids_min_no" type="number" class="form-control ignore disabledPaa" name="itinerary_traveller_family_kids01_minnumber[]" placeholder="0" min="1" value="<?php echo isset($ageTenKey) ? $drafFamilyData[$ageTenKey]["min_no_kides"] : "1"; ?>" data-rule-required="true" />
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Max. No. Kids</label>
                                            <input id="family_kids_max_no" type="number" class="form-control ignore disabledPaa" name="itinerary-traveller-family-kids01-maxnumber[]" placeholder="0" value="<?php echo isset($ageTenKey) ? $drafFamilyData[$ageTenKey]["max_no_kides"] : ""; ?>" data-rule-required="true" />
                                        </div>
                                    </div>
                                </li>
                                <li class="form-group col-12 col-sm-6 pt-2 offset-0 offset-sm-6" data-id="kids-2">
                                    <div class="form-row">
                                        <div class="col-12 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Kids (Age)</label>
                                            <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                                                <input id="travellerType-kids-below7" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore disabledDad keepCheck" value="7" <?php echo isset($ageSevenKey) ? "checked" : ""; ?> data-rule-required="true"  />
                                                <label class="custom-control-label" for="travellerType-kids-below7">Below 7</label>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Min. No. Kids</label>
                                            <input type="number" class="form-control append_min_val disabledPaa" name="itinerary_traveller_family_kids01_minnumber[]" placeholder="0" min="1" value="<?php echo isset($ageSevenKey) ? $drafFamilyData[$ageSevenKey]["min_no_kides"] : "1"; ?>" data-rule-required="true" >
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Max. No. Kids</label>
                                            <input type="number" class="form-control append_max_val disabledPaa" name="itinerary-traveller-family-kids01-maxnumber[]" placeholder="0" data-rule-required="true" value="<?php echo isset($ageSevenKey) ? $drafFamilyData[$ageSevenKey]["max_no_kides"] : ""; ?>" >
                                        </div>
                                    </div>
                                </li>
                                <li class="form-group col-12 col-sm-6 pt-2 offset-0 offset-sm-6" data-id="kids-3">
                                    <div class="form-row">
                                        <div class="col-12 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Kids (Age)</label>
                                            <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                                                <input id="travellerType-kids-below5" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore disabledDad keepCheck" value="5" <?php echo isset($ageFiveKey) ? "checked" : ""; ?> data-rule-required="true"  />
                                                <label class="custom-control-label" for="travellerType-kids-below5">Below 5</label>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Min. No. Kids</label>
                                            <input type="number" class="form-control append_min_val disabledPaa" name="itinerary_traveller_family_kids01_minnumber[]" placeholder="0" min="1" value="<?php echo isset($ageFiveKey) ? $drafFamilyData[$ageFiveKey]["min_no_kides"] : "1"; ?>" data-rule-required="true" >
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Max. No. Kids</label>
                                            <input type="number" class="form-control append_max_val disabledPaa" name="itinerary-traveller-family-kids01-maxnumber[]" placeholder="0" data-rule-required="true" value="<?php echo isset($ageFiveKey) ? $drafFamilyData[$ageFiveKey]["max_no_kides"] : ""; ?>"  >
                                        </div>
                                    </div>
                                </li>
                                <?php
                                ...
                                <li class="form-group col-12 col-sm-6 pt-2" data-id="kids-1">
                                    <div class="form-row">
                                        <div class="col-12 col-sm-4  placeVaild">
                                            <label class="col-form-sublabel">Kids (Age)</label>
                                            <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                                                <input id="travellerType-kids-below10" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore keepCheck" value="10" data-rule-required="true" disabled />
                                                <label class="custom-control-label" for="travellerType-kids-below10">Below 10</label>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Min. No. Kids</label>
                                            <input id="family_kids_min_no" type="number" class="form-control ignore disabledPaa" name="itinerary_traveller_family_kids01_minnumber[]" placeholder="0" min="1" value="1" data-rule-required="true" disabled/>
                                        </div>
                                        <div class="col-6 col-sm-4 placeVaild">
                                            <label class="col-form-sublabel">Max. No. Kids</label>
                                            <input id="family_kids_max_no" type="number" class="form-control ignore disabledPaa" name="itinerary-traveller-family-kids01-maxnumber[]" placeholder="0" data-rule-required="true" disabled/>
                                        </div>
                                    </div>
                                </li>
                                <li class="form-group col-12 col-sm-6 pt-2 offset-0 offset-sm-6" data-id="kids-2">
                ...
                <fieldset>
                        ...
                        <?php } else{ ?>
                            ...
                            <li id="addMoreKidsPrice" data-rel="familyCheck" class="form-group col-12 col-md-6 hidden ">
                                <div class="form-row">
                                    <div class="col-6 placeVaild">
                                        <label class="col-form-sublabel">Age (Kids)</label>
                                        <input type="number" class="form-control ignore" placeholder="0"  name="itinerary_traveller_family_kids01_age[]" id="itinerary_family_kids_age" data-rule-required="true"/>
                                    </div>
                                    <div class="col-6 placeVaild">
                                        <label class="col-form-sublabel">Price (Kids)</label>
                                        <input type="number" class="form-control ignore" placeholder="0" name="itinerary_traveller_family_kids01_price[]" id="itinerary_family_kids_price" data-rule-required="true"/>
                                    </div>
                                </div>
                            </li>
                        <?php } ?>
                    ...
                    <?php
                    $additional_editDataSet = json_decode(json_encode($editDataSet), true);
                    ...
                    <ul class="form-row">
                        ...
                        <li class="form-group col-12 placeVaild">
                            ...
                            <textarea class="form-control ignore" placeholder="Type the message" name="itinerary_confirmationtype_msg" id="instant_conf_msg" data-rule-required="true"><?php if(isset($editDataSet->Instant_confirmation_message))echo trim($editDataSet->Instant_confirmation_message);?></textarea>
                        </li>
                    </ul> -->
                ...
                <fieldset>  <?php /*
                    ...
                    <small class="text-muted">*Required min. dimension 1440 X 1053px, size less than 5mb and format .jpg,.jpeg only</small>

                    <ul class="form-row">
                        <li class="form-group col-12 placeVaild">
                            <label class="dragImageBox">
                                <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_cover" id="image_gallery" accept="image/jpg, image/jpeg" data-height="1053" data-width="1440" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only"  />
                    ...
                    <small class="text-muted">*Required min. dimension 250 X 158px, size less than 5mb and format .jpg,.jpeg only</small>
                ...
                <div class="modal-body">
                    <ul class="pl-2 pr-2">
                        <li class="form-group col-12 col-md-12">
                            ...
                            <div class="placeVaild">
                                <textarea id="add_newAns" class="form-control mt-4" name="new-answer" placeholder="Answer (max 200 characters)" required></textarea>
                            </div>
                        </li>
                    </ul>
                </div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="cancleItinerary">Cancel</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(window).on('load',function(){
        ...
        if(adminStatus==1){
            ...
            $('a[href="#"]').remove();
            $('.floatBtn').html('');
            $('.floatBtn').append('<a href="<?php echo base_url()?>itineraries" class="btn btn-link text-default">Back</a>')
        }
...
//LEFT MENU
        ...
        $(document).on('click', '#callDone', function(e) {
            ...
            validator.destroy();
            $('#formItinerary').attr('action','translator_editexperience_itinerary');
            $('.loadingWrap').show();
