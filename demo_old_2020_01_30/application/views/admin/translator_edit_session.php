...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    ...
    <div class="float-right floatBtn"> <a href="#" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">cancel</a> <!--<a id="saveCall" href="#" class="btn btn-secondary mr-3">Draft</a>--> <a id="callDone" href="#" class="btn btn-primary">Done</a> </div>
  </div>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data">
        ...
        <fieldset id="filldetail">		
          ...
          <ul class="form-row no-gutters">
           ...
           <?php if($otherlang!='English'){ ?>
               ...
               <option value="">Select</option>
                <?php 
				  foreach($userCity as $city):
				   ...
				   if($value==$editDataSet->origin_city){
					    $selected = 'selected';
					   }
					else{
						$selected = '';
			...
			<?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
			<label class="col-form-sublabel">Type My City (<?php echo $otherlang;?>)</label>             
              <input id="origin_otherCity" type="text" class="form-control" name="origin_otherCity" value="<?php if(isset($editDataSet->origin_other_city)) echo $editDataSet->origin_other_city;?>" data-rule-required="true" required/>
            </li>
			<?php } ?>			
          
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Meet-up Title</label>
              <input id="itinerary_title" type="text" class="form-control" name="itinerary_title" placeholder="Itinerary Title" data-rule-required="true" value="<?php if(isset($editDataSet->itinerary_title))echo $editDataSet->itinerary_title;?>"  required/>
            </li>
			<?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Meet-up Title (<?php echo $otherlang;?>)</label>
              <input id="itinerary_other_title" type="text" class="form-control" name="itinerary_other_title" value="<?php if(isset($editDataSet->itinerary_other_title))echo $editDataSet->itinerary_other_title;?>" data-rule-required="true" required/>
            </li>
			<?php } ?>			
			
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Tag Line</label>
              <input id="itinerary_tagline" type="text" class="form-control" name="itinerary_tagline" placeholder="Tag Line" data-rule-required="true" value="<?php if(isset($editDataSet->itinerary_tagline))echo $editDataSet->itinerary_tagline;?>" required/>
            </li>
			<?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Type Tag Line (<?php echo $otherlang;?>)</label>
              <input id="other_tag_line" type="text" class="form-control" name="other_tag_line"  value="<?php if(isset($editDataSet->itinerary_other_tagline))echo $editDataSet->itinerary_other_tagline;?>" data-rule-required="true" required/>
            </li>
			<?php } ?>   
			
            <li class="form-group col-12 placeVaild">
              <label class="col-form-label text-light">What to Expect</label>
              <textarea id="itinerary_description" class="form-control" name="itinerary_description" placeholder="Give details of your service (max 400 characters)" data-rule-required="true" data-rule-maxlength="400" required><?php if(isset($editDataSet->itinerary_description))echo $editDataSet->itinerary_description;?></textarea>
            </li>
           <?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-label text-light">What to Expect (<?php echo $otherlang;?>)</label>
              <textarea id="other_lang_desc" class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 400 characters)" data-rule-required="true" data-rule-maxlength="400" required><?php if(isset($editDataSet->other_itinerary_description))echo $editDataSet->other_itinerary_description;?></textarea>
            </li>
			<?php } ?>
            <li class="form-group col-12 placeVaild">
              ...
              <ul class="tagList">
			   <?php 
				  if(!empty($editDataSet->meetup_type)){
				  $indoorclass = '';
				  $outdoorclass ='';
					  $expType = explode(',',$editDataSet->meetup_type);					 
					  if(!empty($expType[0])){
						  $indoorclass = 'active';
						  }
					else{
                ...
                <li>
                  <label class="tagBox <?php echo @$indoorclass;?>">
                    <input type="checkbox" class="ignore" name="meetup_itinerary_type[]" value="Indoor" <?php if(isset($expType[0])=='Indoor') echo 'checked="checked"'; ?> data-rule-required="true"/>
                    Indoor</label>
                </li>
                <li>
                  <label class="tagBox <?php echo @$outdoorclass;?>">
                    <input type="checkbox" name="meetup_itinerary_type[]" value="Outdoor" <?php if(isset($expType[1])=='Outdoor') echo 'checked="checked"'; ?> />
                    Outdoor</label>
                </li>
              </ul>
            </li>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
			 ...
			 if(!empty($editDataSet->type_highlights)){
				 ...
				 $highlights1 = explode(',',$editDataSet->type_highlights);
				 $highlightsData = array_combine($highlights,$highlights1);
				// print_r($highlights);
				 }
				 ?>
                <option value="Rafting" <?php if(isset($highlightsData['Rafting'])=='Rafting')echo 'selected';?>>Rafting</option>
                <option value="Safari" <?php if(isset($highlightsData['Safari'])=='Safari')echo 'selected';?>>Safari</option>
                <option value="Bungee Jumping" <?php if(isset($highlightsData['Bungee Jumping'])=='Bungee Jumping')echo 'selected';?>>Bungee Jumping</option>
                <option value="Kayaking" <?php if(isset($highlightsData['Kayaking'])=='Kayaking')echo 'selected';?>>Kayaking</option>
                <option value="Biking" <?php if(isset($highlightsData['Biking'])=='Biking')echo 'selected';?>>Biking</option>
                <option value="Skiing" <?php if(isset($highlightsData['Skiing'])=='Skiing')echo 'selected';?>>Skiing</option>
                <option value="Scuba diving" <?php if(isset($highlightsData['Scuba diving'])=='Scuba diving')echo 'selected';?>>Scuba diving</option>
                <option value="Surfing" <?php if(isset($highlightsData['Surfing'])=='Surfing')echo 'selected';?>>Surfing</option>  
              </select>
            </li>
            <li class="form-group col-12 placeVaild">
		...
		<div class="col-6 col-sm-auto">
              ...
              <select id="typeLanguages" name="preferences_languages[]" class="form-control ignore" placeholder="Select my languages"  data-rule-required="true" multiple>
               <?php
				 foreach($languages as $langVal):
				  ...
				  if(isset($editDataSet->prefer_languages)){
          ...
          <ul class="form-row no-gutters">
		  <?php 
			  if(!empty($drafSpeakerData)){
				  foreach($drafSpeakerData as $speaker):?>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_inclusions" class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 400 characters)" data-rule-maxlength="400" data-rule-required="true"> <?php if(isset($editDataSet->itinerary_inclusions))echo $editDataSet->itinerary_inclusions;?></textarea>
            </li>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Exclusions</label>
              <textarea id="itinerary_exclusions" class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 400 characters)" data-rule-maxlength="400" data-rule-required="true"><?php if(isset($editDataSet->itinerary_exclusions))echo $editDataSet->itinerary_exclusions;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_splmention" class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 400 characters)" data-rule-maxlength="400" data-rule-required="true"><?php if(isset($editDataSet->itinerary_spl_mention))echo $editDataSet->itinerary_spl_mention;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters mb-4">
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <div class="placeVaild">
                <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 200 characters)" data-rule-maxlength="200" id="faq_answer_01" data-rule-required="true"><?php echo $faqs->itinerary_faq_answer;?></textarea>				
              </div>
			...
			<?php endforeach;}else{ ?>
			 <li class="form-group col-12">
			  ...
			  <div class="placeVaild">
              <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 200 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="200"></textarea>
             </div>
			 </li>
			<?php } ?>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_first_name))echo $editDataSet->host_first_name;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_last_name))echo $editDataSet->host_last_name;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_mob_num))echo $editDataSet->host_mob_num;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input id="host_emergency_no" type="number" name="itinerary_host_emergency" class="form-control ignore" placeholder="Mobile Number" value="<?php if(isset($editDataSet->host_emergency_contact_num))echo $editDataSet->host_emergency_contact_num;?>" data-rule-required="true"/>
            </li>
          </ul>
        </fieldset>
        <fieldset>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                ...
                <div class="col-6 placeVaild">
                  ...
                  <input id="time_from" type="text" name="itinerary_aviaiable_time_from" class="form-control timepicker ignore" placeholder="Time" value="<?php if(isset($editDataSet->aviaiable_time_form_host))echo $editDataSet->aviaiable_time_form_host;?>" data-rule-required="true"/>
                </div>
                <div class="col-6 placeVaild">
                  <label class="col-form-sublabel">To</label>
                  <input id="time_to" type="text" name="itinerary_aviaiable_time_to" class="form-control timepicker ignore" placeholder="Time" value="<?php if(isset($editDataSet->aviaiable_time_to_host))echo $editDataSet->aviaiable_time_to_host;?>" data-rule-required="true"/>
                </div>
              </div>
            </li>
            <li class="col-6 placeVaild">
              <label class="col-form-sublabel">Start Date</label>
              <input id="startDateInput" name="itinerary_aviaiable_start_date" type="text" class="form-control ignore" placeholder="Start Date" value="<?php if(isset($editDataSet->start_date_from_host) && $editDataSet->start_date_from_host!='1970-01-01')echo $editDataSet->start_date_from_host;?>"data-rule-required="true"/>
            </li>
            <li class="col-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->end_date_to_host) && $editDataSet->end_date_to_host!='1970-01-01')echo $editDataSet->end_date_to_host;?>" data-rule-required="true"/>
            </li>
          </ul>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6">
                  ...
                  <select id="service_frequency" class="form-control ignore" name="itinerary_service_frequency" data-rule-required="true">
                ...
                <div class="col-12 col-sm-6 placeVaild">
				  ...
				  if(isset($editDataSet->days)){
                      ...
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Mon" name="itinerary_service_days[]" class="ignore" data-rule-required="true" <?php if(isset($daysdata['Mon']))echo 'checked';?>/>
                          M</label>
                      </li>
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Tue" name="itinerary_service_days[]" <?php if(isset($daysdata['Tue']))echo 'checked';?> />
                          T</label>
                      </li>
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Wed" name="itinerary_service_days[]" <?php if(isset($daysdata['Wed']))echo 'checked';?> />
                          W</label>
                      </li>
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Thu" name="itinerary_service_days[]" <?php if(isset($daysdata['Thu']))echo 'checked';?> />
                          T</label>
                      </li>
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Fri" name="itinerary_service_days[]" <?php if(isset($daysdata['Fri']))echo 'checked';?> />
                          F</label>
                      </li>
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Sat" name="itinerary_service_days[]" <?php if(isset($daysdata['Sat']))echo 'checked';?> />
                          S</label>
                      </li>
                      <li>
                        <label class="dayBox">
                          <input type="checkbox" value="Sun" name="itinerary_service_days[]" <?php if(isset($daysdata['Sun']))echo 'checked';?> />
                          S</label>
                      </li>
                    </ul>
                  </div>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 placeVaild">
                  ...
                  <input id="pickup_point" type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="click to open map and select location" value="<?php echo @$draftRoutData->pickup_point;?>" data-rule-required="true"/>
                </div>
            ...
            <li class="form-group col-12 col-md-12">            
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
				  ...
				  value="<?php echo @$draftRoutData->start_pickup_time;?>" placeholder="Time" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
				  ...
				  value="<?php echo @$draftRoutData->end_dropoff_time;?>" placeholder="Time" data-rule-required="true" autocomplete="off"/>
                </div>
              </div>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Total Duration (hours)</label>
              <input id="route_slot01_duration" type="text" name="itinerary_route_slot01_duration[]" class="form-control ignore hourpicker" placeholder="Total Duration" value="<?php echo @$draftRoutData->total_durations;?>" data-rule-required="true" autocomplete="off"/>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Cut-off Time (minutes)</label>
              <input id="route_slot01_cutofftime" type="text" name="itinerary_route_slot01_cutofftime[]" class="form-control ignore hourpicker" placeholder="Cut-off Time" value="<?php echo @$draftRoutData->cutt_off_time;?>" data-rule-required="true" autocomplete="off"/>
            </li>
      ...
      <!--       <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-12 pt-2">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    ...
                    <input id="private_min_no_travllers" type="number" name="itinerary_traveller_private_minnumber" class="form-control ignore" placeholder="0" min="1" value="<?php if(isset($editDataSet->private_min_no_travellers))
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    ...
                    <input type="number" name="itinerary_traveller_private_maxnumber" class="form-control ignore" placeholder="0" min="1" id="private_max_no_travllers" value="<?php if(isset($editDataSet->private_max_no_travellers))
                ...
                <div class="form-row">
                  <div class="col-12 col-sm-4">
                    <div class="custom-control custom-checkbox custom-control-inline pt-3 pb-1">
					  ...
					  <?php if(isset($editDataSet->group_traveller)==1)echo 'checked';?> />
                      <label class="custom-control-label font-weight-semibold" for="travellerType-group">Group</label>
                    </div>
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Min. No. Travellers</label>
                    <input id="group_min_no_travllers"  type="number" class="form-control ignore" name="itinerary_traveller_group_minnumber" placeholder="0" min="1" value="<?php if(isset($editDataSet->group_min_no_travellers))
					  echo $editDataSet->group_min_no_travellers;else{echo '1';}?>" data-rule-required="true" disabled/>
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Max. No. Travellers</label>
                    <input id="group_max_no_travllers" type="number"  class="form-control ignore" name="itinerary_traveller_group_maxnumber" placeholder="0" min="1" value="<?php if(isset($editDataSet->group_max_no_travellers))
          ...
          <ul class="form-row">
            <li data-rel="privateCheck" class="form-group col-12 col-md-12 hidden">
              <div class="form-row">
                ...
                <div class="col-12 col-sm-4 placeVaild">
                  ...
                  <input id="itinerary_private_price" type="number" class="form-control ignore" name="itinerary_traveller_private_price"  placeholder="0" value="<?php if(isset($editDataSet->private_price))echo $editDataSet->private_price;?>" data-rule-required="true"/>
                </div>
              </div>
            </li>
            <li data-rel="groupCheck" class="form-group col-12 col-md-12 hidden">
              <div class="form-row">
                ...
                <div class="col-12 col-sm-4 placeVaild">
                  <label class="col-form-sublabel">Price</label>
                  <input id="itinerary_group_price" type="number" class="form-control ignore" name="itinerary_traveller_group_price" placeholder="0" value="<?php if(isset($editDataSet->group_price))echo $editDataSet->group_price;?>" data-rule-required="true"/>
                </div>
              </div>
            </li>
             <?php
		...
		<?php } ?>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              ...
              <div class="custom-control custom-radio custom-control-inline ml-3">
                <input type="radio" id="confirmationType-instant" name="itinerary-confirmationtype" value="instant" class="custom-control-input ignore" data-rule-required="true" <?php echo @$editDataSet->confirmation_type=='instant'?'checked="checked"':'';?> />
              ...
              <div class="custom-control custom-radio custom-control-inline ml-3">
				...
				<?php echo @$editDataSet->confirmation_type=='review'?'checked="checked"':'';?> />
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="instant_conf_msg" class="form-control ignore" placeholder="Type the message" name="itinerary_confirmationtype_msg"  data-rule-required="true"><?php if(isset($editDataSet->Instant_confirmation_message))echo $editDataSet->Instant_confirmation_message;?></textarea>
            </li>
          </ul> -->
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild cancelRadio-01">
              ...
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="cancelByHostInput-other-yes" name="itinerary-cancellations-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->itinerary_cancelbyhost_agree==1?'checked="checked"':'';?> data-rule-required="true" />
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->itinerary_cancelbyhost_agree==''?'':(@$editDataSet->itinerary_cancelbyhost_agree==0?'checked="checked"':'');?> />
            ...
            <li class="form-group col-12 placeVaild cancelRadio-02">
              ...
              <p class="pt-1 pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras convallis consectetur convallis. Etiam imperdiet neque eget augue fermentum pulvinar. Phasellus nec aliquet risus, et elementum augue. Etiam in ultrices diam. Cras est ipsum, aliquet id diam ac, mollis ultricies velit. Fusce et consectetur urna. Pellentesque sit amet hendrerit diam, at finibus quam. Sed ullamcorper et metus et varius. Integer nibh metus, pulvinar id urna vel, ullamcorper vestibulum massa. Nunc tincidunt nunc id mauris fermentum interdum. Cras non ligula in tortor facilisis dignissim in vel purus.</p>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="cancelBytravellerInput-other-yes" name="itinerary-donetraveller-agree" value="1" class="custom-control-input ignore"<?php echo @$editDataSet->itinerary_cancelbytraveller_agree==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->itinerary_cancelbytraveller_agree==''?'':(@$editDataSet->itinerary_cancelbytraveller_agree==0?'checked="checked"':'');?>/>
            ...
            <li class="form-group col-12 placeVaild cancelRadio-03">
              ...
              <div class="custom-control custom-radio custom-control-inline">
				...
				<?php echo @$editDataSet->itinerary_refund_agree==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->itinerary_refund_agree==''?'':(@$editDataSet->itinerary_refund_agree==0?'checked="checked"':'');?> />
         ...
         <fieldset>
          <h3 id="fillSponsor" class="col-form-label mt-2">Sponsor</h3>
           <small class="text-muted">*Required min. dimension 640 X 100px, size less than 5mb and format .jpg,.jpeg only</small>
		  ...
		  <?php $sponsorArr = '';
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]" accept="image/jpg, image/jpeg" data-height="100" data-width="640" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
              <input id="add_sponsor_check" type="text" class="form-control lowKey ignore" name="itinerary_sponsor_hide_image_cover[]" 
			  value="<?php if(@$images!='')echo $images;?>" data-rule-required="true"/>
			 ...
			 <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]" id="add_sponsor"  accept="image/jpg, image/jpeg" data-height="100" data-width="640" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
              <input id="add_sponsor_check" type="text" class="form-control lowKey ignore" name="itinerary_sponsor_hide_image_cover[]" 
			   data-rule-required="true"/>
        ...
        <fieldset> <?php /*
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              ...
              <input id="add_video_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_hide_video" value="<?php if(@$editDataSet->video!='')echo $editDataSet->video;?>" data-rule-required="true"/>
              ...
              <div class="infoShow" <?php if(@$editDataSet->video!='' && @$editDataSet->video!=null) echo 'style="display:block"'; ?>>
                <p class="text-primary"><?php if(@$editDataSet->video!='')echo $editDataSet->video;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
          </ul> */ ?>
          ...
          <h3 id="fillImage" class="col-form-label mt-2">Image Gallery</h3>
           <small class="text-muted">*Required min. dimension 1440 X 563px, size less than 5mb and format .jpg,.jpeg only</small>

          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_cover" id="image_gallery"  accept="image/jpg, image/jpeg" data-height="563" data-width="1440" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
              <input id="image_gallery_check" type="text" class="form-control lowKey ignore"  name="itinerary_gallery_hide_image_cover" value="<?php if(@$editDataSet->feature_img!='')echo $editDataSet->feature_img;?>" data-rule-required="true"/>
              ...
              <div class="infoShow" <?php if(@$editDataSet->feature_img!='' && @$editDataSet->feature_img!=null)echo 'style="display:block"';?>>
                <p class="text-primary"><?php if(@$editDataSet->feature_img!='')echo $editDataSet->feature_img;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
          </ul>
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input id="additional_image_1_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_image_hide_01" value="<?php if(@$editDataSet->additional_img_1!='')echo $editDataSet->additional_img_1;?>" data-rule-required="true"/>
              ...
              <div class="infoShow" <?php if(@$editDataSet->additional_img_1!='' && @$editDataSet->additional_img_1!=null) echo 'style="display:block"';?>>
                <p class="text-primary"><?php if(@$editDataSet->additional_img_1!='')echo $editDataSet->additional_img_1;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input id="additional_image_2_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_image_hide_02" value="<?php if(@$editDataSet->additional_img_2!='')echo $editDataSet->additional_img_2;?>" data-rule-required="true"/>
              ...
              <div class="infoShow" <?php if(@$editDataSet->additional_img_2!='' && @$editDataSet->additional_img_2!=null) echo 'style="display:block"';?>>
                <p class="text-primary"><?php if(@$editDataSet->additional_img_2!='')echo $editDataSet->additional_img_2;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input id="additional_image_3_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_image_hide_03" value="<?php if(@$editDataSet->additional_img_3!='')echo $editDataSet->additional_img_3;?>" data-rule-required="true"/>
              ...
              <div class="infoShow" <?php if(@$editDataSet->additional_img_3!='' && @$editDataSet->additional_img_3!=null) echo 'style="display:block"';?>>
                <p class="text-primary"><?php if(@$editDataSet->additional_img_3!='')echo $editDataSet->additional_img_3;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
          </ul>
        ...
        <h3 id="fillLegalLiabilities" class="col-form-label mb-1">Code of Conduct <a href="javascript:void(0);"  data-ref="liability_diclaimer" class="text-primary read_popup small font-weight-bold ml-1">View Detail</a></h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="disclaimerCheckInput-yes" name="itinerary-disclaimer-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->itinerary_liabilitie_disclaimer==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->itinerary_liabilitie_disclaimer==''?'':(@$editDataSet->itinerary_liabilitie_disclaimer==0?'checked="checked"':'');?>/>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="privacyCheckInput-yes"  name="itinerary-privacy-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->itinerary_privacy_policy==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->itinerary_privacy_policy==''?'':(@$editDataSet->itinerary_privacy_policy==0?'checked="checked"':'');?> />
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
				...
				<?php echo @$editDataSet->itinerary_terms_condition==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->itinerary_terms_condition==''?'':(@$editDataSet->itinerary_terms_condition==0?'checked="checked"':'');?> />
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild cancelRadio-01">
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->last_doneby_host==''?'':(@$editDataSet->last_doneby_host==0?'checked="checked"':'');?>/>
  ...
  <ul class="form-row">
            <li class="form-group col-12 placeVaild cancelRadio-02">
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->last_doneby_traveller==''?'':(@$editDataSet->last_doneby_traveller==0?'checked="checked"':'')?> />
...
<ul class="form-row">
            <li class="form-group col-12 placeVaild cancelRadio-03">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="refundCheckInput-yes1" name="itinerary-refund-agree-copy" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->last_refund==1?'checked="checked"':''?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->last_refund==''?'':(@$editDataSet->last_refund==0?'checked="checked"':'')?> />
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="copyrightCheckInput-yes"  name="itinerary-copyright-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->media_infringement==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php echo @$editDataSet->media_infringement==''?'':(@$editDataSet->media_infringement==0?'checked="checked"':'');?>/>
      ...
      <div class="modal-body">
        <ul class="form-row">
          <li class="form-group col-12 col-md-5 placeVaild">
            ...
            <label class="dragImageBox text-center">
            <input id="newSpeakerImg" type="file" class="form-control uploadDoc" name="speakerImages[]" required/>
            <div class="dragImageBox-info">
              <div class="dragImageBox-icon"><img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" /></div>
...
$("#addItemsForm").validate({
    ...
    submitHandler: function() {
        ...
        var data = $('<li class="form-group col-12 placeVaild"><label class="dragImageBox"><input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]" id="add_sponsor-02" accept="image/jpg, image/jpeg" data-height="100" data-width="640" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" data-rule-required="true" /><input type="text"  class="form-control lowKey ignore" name="itinerary_sponsor_hide_image_cover[]"/><div class="dragImageBox-info"><div class="dragImageBox-icon"><img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" /></div><p>Add a Sponsor Image</p><span>Drag file here or click to upload</span> </div><div class="infoShow"><p class="text-primary">File Name</p><small class="text-muted">000 KB</small></div></label><a href="javascript:void(0);" class="text-light text-uppercase clearSponsor">Remove</a></li>');
...
$(document).on('click', '#callDone', function(e) {
    ...
    validator.destroy();
    $('#formItinerary').attr('action','translator_sessionitinerary');
    $('.loadingWrap').show();
