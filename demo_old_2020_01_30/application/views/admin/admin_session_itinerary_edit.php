		...
		<div class="col-6 col-sm-auto">
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_inclusions" class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 1000 characters)" data-rule-maxlength="1000" data-rule-required="true"><?php if(isset($editDataSet->itinerary_inclusions))echo trim($editDataSet->itinerary_inclusions);?></textarea>
            </li>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Exclusions</label>
              <textarea id="itinerary_exclusions" class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 1000 characters)" data-rule-maxlength="1000" data-rule-required="true"><?php if(isset($editDataSet->itinerary_exclusions))echo trim($editDataSet->itinerary_exclusions);?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_splmention" class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" data-rule-maxlength="1500" data-rule-required="true"><?php if(isset($editDataSet->itinerary_spl_mention))echo trim($editDataSet->itinerary_spl_mention);?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row">
		   <?php 
            ...
            <li class="form-group col-6 placeVaild">
              ...
              <input id="route_slot01_duration" type="text" name="itinerary_route_slot01_duration[]" class="form-control ignore hourpicker" placeholder="Total Duration" value="<?php echo (@$draftRoutData->total_durations?$draftRoutData->total_durations:'0:00');?>" data-rule-required="true" autocomplete="off"/>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Cut-off Time (minutes)</label>
              <input id="route_slot01_cutofftime" type="text" name="itinerary_route_slot01_cutofftime[]" class="form-control ignore cutoffpicker" placeholder="Cut-off Time" value="<?php echo (@$draftRoutData->cutt_off_time?$draftRoutData->cutt_off_time:'0:00');?>" data-rule-required="true" autocomplete="off"/>
            </li>
         ...
         <fieldset>
		  ...
		  <?php $sponsorArr = '';
            ...
            <li class="form-group col-12 placeVaild">
			  ...
			  value="<?php if(@$images!='')echo $images;?>" data-rule-required="false"/>
          ...
          <li class="form-group col-12 col-md-5 placeVaild">
            ...
            <div class="infoShow">
              ...
              <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
						 ...
						 <small class="text-muted">*Required min. dimension 300px X 300px, size less than 10mb and format .jpg,.jpeg only</small>
...
$(document).on('click', '#callDone', function(e) {
    ...
    validator.destroy();
    $('#formItinerary').attr('action','admin_sessionitineraryEdit');
    $('.loadingWrap').show();
