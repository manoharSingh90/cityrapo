  ...
  <ul>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="itineraryUrl" id="itineraryUrl" value="<?php echo base_url().'meetup/'.base64_encode($itineraryId).'/'.$serviceId.'/'.$otherlang.'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->origin_city)).'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->itinerary_title));?>"/>
          ...
          <ul class="form-row no-gutters">
           ...
           <?php if($otherlang!='English'){ ?>
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <textarea id="itinerary_description" class="form-control" name="itinerary_description" placeholder="Give details of your service (max 5000 characters)" data-rule-required="true" data-rule-maxlength="5000" required><?php if(isset($editDataSet->itinerary_description))echo $editDataSet->itinerary_description;?></textarea>
            </li>
           <?php if($otherlang!='English'){ ?>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-label text-light text-capitalize">What to Expect (<?php echo $otherlang;?>)</label>
              <textarea id="other_lang_desc" class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 5000 characters)" data-rule-required="true" data-rule-maxlength="5000" required><?php if(isset($editDataSet->other_itinerary_description))echo $editDataSet->other_itinerary_description;?></textarea>
            </li>
			<?php } ?>
			   ...
			   <?php 
                ...
                <li>
                  <label class="tagBox <?php echo @$indoorclass;?>">
                    <input type="checkbox" class="ignore" name="meetup_itinerary_type[]" value="Indoor" <?php if(isset($expType['Indoor'])=='Indoor') echo 'checked="checked"'; ?> data-rule-required="false"/>
                    Indoor</label>
                </li>
                <li>
		...
		<div class="col-6 col-sm-auto">
          ...
          <ul class="form-row no-gutters">
            ...
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_mob_num))echo $editDataSet->host_mob_num;?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
 ...
 <fieldset>         
      ...
      <!--       <ul class="form-row">
			...
			if(!empty($drafFamilyData)){
             ...
             <li class="form-group col-12 col-sm-6 mb-1 pt-2">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Adult - Min. No.</label>
                    <input type="number" class="form-control ignore disabledDad disabledPaa" name="itinerary_traveller_family_adult_minnumber" placeholder="0" min="1" id="adult_min_no" data-rule-required="true" value="1" disabled/>
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Adult - Max. No.</label>
                    <input type="number" class="form-control ignore disabledDad disabledPaa" name="itinerary_traveller_family_adult_maxnumber" placeholder="0" id="adult_max_no" data-rule-required="true" disabled/>
                  </div>
                </div>
              </li>
             <li class="form-group col-12 col-sm-6 pt-2" data-id="kids-1">
        ...
        <fieldset> <?php /*
          ...
          <small class="text-muted">*Required min. dimension 1440 X 747px, size less than 10mb and format .jpg,.jpeg only</small>

          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_cover" accept="image/jpg, image/jpeg" data-height="747" data-width="1440" data-size="10240" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
...
$('#cancleItinerary').on('click',function(){
	...
	if(returnFlag==1){
        ...
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').data("rule-required", false);
						...
						validator.destroy();
						$('#formItinerary').attr('action','admin_editmeetup_itinerary');
						$('.loadingWrap').show();
