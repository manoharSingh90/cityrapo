...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    ...
    <div class="float-right floatBtn"> <a href="#" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">cancel</a><a id="callDone" href="#" class="btn btn-secondary">Done</a> </div>
  </div>
        ...
        <fieldset id="filldetail">          
		 ...
		 <?php } ?>
          ...
          <ul class="form-row no-gutters">
            ...
            <?php if($selectOtherLang!='English' && $selectOtherLang!='ENGLISH' && $selectOtherLang!='english'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Itinerary Title (<?php echo $selectOtherLang;?>)</label>
	...
	c-0.2,0.1,0,0.1,0.4-0.2c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0s-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="text" name="itinerary_host_firstname" class="form-control ignore text-capitalize" placeholder="First Name" id="host_firstname"  data-rule-required="true" value="<?php echo $hostProfile[0]->host_first_name;?>"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Last Name</label>
              <input type="text" name="itinerary_host_lastname" class="form-control ignore text-capitalize" placeholder="Last Name" id="host_lastname"  data-rule-required="true" value="<?php echo $hostProfile[0]->host_last_name;?>"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
