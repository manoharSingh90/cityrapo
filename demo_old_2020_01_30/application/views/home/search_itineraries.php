...
?>
              ...
              <p class="itinerariesBox-text"><?php echo strlen($val->itinerary_description) > 90 ? substr($val->itinerary_description, 0, 90) . "..." : $val->itinerary_description; ?> <a href="javascript:void(0);"  data-toggle="modal" data-target="#guestReadMoreModal_<?= $val->id?>" class="text-primary small">View More</a></p>
...
<div class="modal fade" id="guestReadMoreModal_<?= $val->id?>" tabindex="-1" role="dialog" aria-hidden="true">
