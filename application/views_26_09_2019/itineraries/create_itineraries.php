...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    ...
    <div class="float-right floatBtn"> 
      <a href="#" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">cancel
      </a>
      <!--<input type="button" class="btn btn-secondary" value="Draft" id="formSave"/>-->
	  <a id="formSave" href="javascript:void(0);" class="btn btn-secondary">Draft </a> 
      &nbsp &nbsp &nbsp 
      <a id="callDone" href="#" class="btn btn-primary">Done </a> 
    </div>
  </div>
  <div class="profilePage-body clearfix">
    <div class="profilePage-links" >
      <h3>
        <span>
          <img src="<?php echo base_url();?>assets/img/icon/details.svg" alt="details" />
        </span>Basic
      </h3>
      <ul>
        <li class="active">
          <a href="#fillDetails">Details
          </a>
        </li>
        <li>
          <a href="#fillHighlight">Highlight &amp; Features
          </a>
        </li>
        <li>
          <a href="#fillInclusions">Inclusions &amp; Exclusions
          </a>
        </li>
        <li>
          <a href="#fillFaq">FAQ's
          </a>
        </li>
        <li>
          <a href="#fillhost">Host & Emergency Details
          </a>
        </li>
      </ul>
      <h3>
        <span>
          <img src="<?php echo base_url();?>assets/img/icon/plan.svg" alt="plan" />
        </span>Location &amp; Plan
      </h3>
      <ul>
        <li>
          <a href="#fillAvailability">Host Availability
          </a>
        </li>
        <li>
          <a href="#fillRoute">Route & timing
          </a>
        </li>
        <li>
          <a href="#fillConnectivity">Connectivity & Locations
          </a>
        </li>
        <li>
          <a href="#fillTraveller">Traveller Sepecifications 
          </a>
        </li>
      </ul>
      <h3>
        <span>
          <img src="<?php echo base_url();?>assets/img/icon/rupee.svg" alt="rupee" />
        </span>Pricing
      </h3>
      <ul>
        <li>
          <a href="#fillPrice">Price Chart
          </a>
        </li>
        <li>
          <!-- <a href="#fillConfirmation">Confirmation & Review -->
          </a>
        </li>
        <li>
          <a href="#fillCancellations">Cancellations
          </a>
        </li>
      </ul>
      <h3>
        <span>
          <img src="<?php echo base_url();?>assets/img/icon/media.svg" alt="media" />
        </span>Media
      </h3>
      <ul>
        <li>
          <a href="#fillVideo">Video
          </a>
        </li>
        <li>
          <a href="#fillImage">Image Gallery
          </a>
        </li>
      </ul>
      <h3>
        <span>
          <img src="<?php echo base_url();?>assets/img/icon/legal.svg" alt="legal" />
        </span>Legal
      </h3>
      <ul>
        <li>
          <a href="#fillLegalLiabilities">Liabilities &amp; disclaimers
          </a>
        </li>
        <li>
          <a href="#fillLegalPrivacy">Privacy policy & T &amp; C
          </a>
        </li>
        <li>
          <a href="#fillLegalCancellations">Cancellations & More
          </a>
        </li>
      </ul>
    </div>
...
<ul class="form-row no-gutters">
  <li class="form-group col-12 col-md-6 placeVaild">
    ...
    <input type="text" name="itinerary_host_firstname" class="form-control ignore" placeholder="First Name" id="host_firstname" value="<?php if(isset($draftData->host_first_name))echo $draftData->host_first_name;else{echo $hostProfile[0]->host_first_name;}?>" data-rule-required="true"/>
  </li>
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Last Name
    </label>
    <input type="text" name="itinerary_host_lastname" class="form-control ignore" placeholder="Last Name" id="host_lastname" value="<?php if(isset($draftData->host_last_name))echo $draftData->host_last_name;else{echo $hostProfile[0]->host_last_name;}?>" data-rule-required="true"/>
  </li>
  <li class="form-group col-12 col-md-6 placeVaild">
...
<fieldset>
  <h3 id="fillLegalLiabilities" class="col-form-label mt-2">Liabilities & Disclaimers
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <p class="pt-2 pb-2">
        <?php echo strlen($legalData[0]->preview_liability_diclaimer) > 500 ? substr($legalData[0]->preview_liability_diclaimer,0,500)."..." : $legalData[0]->preview_liability_diclaimer;?> 
        <a href="javascript:void(0);"  data-ref="liability_diclaimer" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
  ...
  <h3 id="fillLegalPrivacy" class="col-form-label mt-2">Privacy Policy
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <p class="pt-2 pb-2">
        <?php echo strlen($legalData[0]->preview_privacy_policy) > 500 ? substr($legalData[0]->preview_privacy_policy,0,500)."..." : $legalData[0]->preview_privacy_policy;?> 
        <a href="javascript:void(0);" data-ref="privacy_policy" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
  ...
  <h3 id="fillLegalTerms" class="col-form-label mt-2">Terms & Conditions
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <p class="pt-2 pb-2">
        <?php echo strlen($legalData[0]->preview_terms_condition) > 500 ? substr($legalData[0]->preview_terms_condition,0,500)."..." : $legalData[0]->preview_terms_condition;?> 
        <a href="javascript:void(0);"  data-ref="term_condition" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
  ...
  <h3 id="fillLegalCancellations" class="col-form-label mt-2">Cancellations
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <label class="col-form-sublabel">Done By You(Host)
  ...
  <h3 id="fillLegalCopyright" class="col-form-label mt-2">Media Infringement
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">				
      <p class="pt-2 pb-2">
        <?php echo strlen($legalData[0]->preview_media_infringement) > 200 ? substr($legalData[0]->preview_media_infringement,0,200)."..." : $legalData[0]->preview_media_infringement;?> 
        <a href="javascript:void(0);" data-ref="media_infri" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
        ...
        <label class="custom-control-label" for="copyrightCheckInput-yes"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="copyrightCheckInput-no"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>
  <h3 id="fillLegalCopyright" class="col-form-label mt-2">Terms &amp; Conditions
  </h3>		 
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">              
      <div class="custom-control custom-checkbox custom-control-inline">
        ...
        <label class="custom-control-label" for="term_policy"> I agree to the 
          <a href="#" target="_blank" data-toggle="modal" data-target="#tcModal">Terms &amp; Conditions
          </a>
        </label>
      </div>             
    </li>
...
<div class="modal fade " id="getMapModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" >Add Location on map 
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
          <span aria-hidden="true">&times;
          </span> 
