...
<table cellpadding="0" cellspacing="0" style="width:100%; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif';">
  <tr>
    <td><table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #888; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif; line-height:1.75;"><strong style="text-transform: uppercase; font-size: 14px;">Message</strong></td>
          <td width="30"></td>
        </tr>
		<tr>
          <td colspan="3" height="30"></td>
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;"><strong>Name :</strong> <?php echo $name;?><br><strong>Email :</strong> <?php echo $email;?><br><strong>Phone No.:</strong> <?php echo $phone_no;?><br><strong>Message:</strong> <?php echo $desc;?><br> <strong>Url :</strong> <?php echo $currentUrl;?></td>
          <td width="30"></td>
        </tr>
        <tr>
          <td colspan="3" height="30"></td>
