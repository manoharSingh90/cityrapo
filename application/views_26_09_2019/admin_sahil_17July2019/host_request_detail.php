  ...
  <div class="profilePage-body clearfix">
	...
	c1.2,0.1,2.4,0,3.6,0c1.1,0,2.3,0.1,3.4-0.1C22.9,19.9,22.5,18.4,21.6,18.6z"/>
            ...
            <li class="form-group col-12 col-md-6">
              ...
              <select class="form-control" required id="verified_type">
				...
				<?php 
					...
					?>
                <!--<option value="1" <?php //if($profiles['host_verification_type']==1){echo 'selected';}?>>City Explorer</option>
                <option value="2" <?php //if($profiles['host_verification_type']==2){echo 'selected';}?>>City Maverick</option>
                <option value="3" <?php //if($profiles['host_verification_type']==3){echo 'selected';}?>>SME</option>
                <option value="4" <?php //if($profiles['host_verification_type']==4){echo 'selected';}?>>Food Theorist</option>
                <option value="5" <?php //if($profiles['host_verification_type']==5){echo 'selected';}?>>Expat</option>
                <option value="6" <?php //if($profiles['host_verification_type']==6){echo 'selected';}?>>Internal Host</option>-->
              </select></li>
	 ...
	 viewBox="0 0 16 16" style="enable-background:new 0 0 16 16;" xml:space="preserve">
		...
		<fieldset>
          <h3 class="col-form-label">Tour Guide Badges</h3>
          <ul class="form-row">
            <li class="form-group col-12 col-md-6">
              <p class="font-weight-semibold text-light d-inline-block mb-0">Guide Badge</p>
              <div class="custom-control custom-checkbox custom-control-inline align-bottom ml-3">
               <input type="checkbox" name="guideBadge" id="guide_badge" class="custom-control-input" value="1" 
			   <?php echo ($profiles['guide_badges']==1?'checked="checked"':'');?> required />
                <label class="custom-control-label" for="guide_badge">I agree</label>
              </div>
            </li>           
          </ul>
        </fieldset>
