                        ...
                        <li class="form-group col-12 col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12 col-sm-7 pt-4 placeVaild">
                                    <textarea class="form-control ignore" name="itinerary_route_slot01_stop01_description[]" placeholder="Add a description" id="route_slot01_stop01_description" data-rule-required="true"><?php echo $routdata->description;?></textarea>
                                </div>
                            </div>
                        </li>
                        <?php endforeach;} ?>
