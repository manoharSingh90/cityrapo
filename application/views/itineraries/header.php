 ...
 <div class="container clearfix">
  ...
  <nav class="navbar navbar-expand-lg">
    <div id="navbarContent" class="collapse navbar-collapse">
      <ul class="menuLinks">
        <li class="<?php if($url=='itineraries' || $url=='walk' || $url=='session' || $url=='experience' || $url=='meetup' 
			|| $url=='' || $url=='itinerary_view_detail')echo 'active';?>"><a href="<?php echo base_url();?>itineraries">My Itineraries</a></li>
        ...
        <li class="<?php //if($itineraryUrl=='contact')echo 'active';?>"><a  href="<?php echo base_url()?>contact">Contact</a></li>
      </ul>
	  <?php 
		  if($hostimage[0]->profile_picture!=='' && $hostimage[0]->profile_picture!==null){
		  ...
		  ?>		  
      <div class="profileMenu"> <span class="profileImage"><img src="<?php echo base_url();?><?php echo $profilePic;?>" alt="user" /></span>
...
<header>
  <div class="container clearfix">	
  <h1 class="cmyLogo"><img src="<?= base_url('assets/img/iwl_hr_org_logo.svg')?>" alt="India with locals" /></h1>
  <nav class="navbar navbar-expand-lg">
    <div id="navbarContent" class="collapse navbar-collapse">
      <ul class="menuLinks">
 ...
 <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarContent"> <img src="<?= base_url('assets/img/placeholder.jpg')?>" alt="menu"></button>
  </nav>
  </div>
</header>
<?php } ?>