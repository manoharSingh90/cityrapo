...
<ul class="form-row no-gutters">
  <li class="form-group col-12 placeVaild">
    ...
    <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" id="itinerary_splmention" data-rule-required="true" data-rule-maxlength="1500"><?php if(isset($draftData->itinerary_spl_mention))echo $draftData->itinerary_spl_mention;?></textarea>
  </li>
</ul>
...
<ul class="form-row no-gutters">
    <li class="form-group col-12 placeVaild">
      ...
      <textarea class="form-control ignore" name="itinerary_youtube_video" placeholder="Embed Video" id="itinerary_youtube_video" data-rule-required="true"><?php if(isset($draftData->youtube_video))echo $draftData->youtube_video;?></textarea>
  </li>
</ul>
