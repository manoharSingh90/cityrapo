<?php 
 ...
 <div class="profilePage">
  <div class="profilePage-head clearfix">
    <h1 class="cmyLogo float-left"><img src="<?php echo base_url();?>assets/img/iwl_hr_white_logo.svg" alt="cityexplorers" /></h1>
    <div class="float-right floatBtn"> <a href="#" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">Cancel</a> <input type="button" class="btn btn-secondary mr-3" value="Draft" id="formSave"/><a id="callDone" href="#" class="btn btn-primary">Done</a> </div>
  </div>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="adminStatus" id="adminStatus" value="<?php echo $adminStatus;?>"/>
		 <input type="hidden" name="itineraryUrl" id="itineraryUrl" value="<?php echo base_url().'experience/'.base64_encode($itineraryId).'/'.$serviceId.'/'.$otherlang.'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->origin_city)).'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->itinerary_title));?>"/>
		 
		 <?php if($otherlang!=='English' && $otherlang!=='ENGLISH'){ ?>
		 <div class="alert alert-light text-center sendTo">
           ...
           <option value="0" <?php echo(@$editDataSet->translator==0)?'selected="selected"':'';?>>No, I will do it myself</option>	
           <option value="1" <?php echo(@$editDataSet->translator==1)?'selected="selected"':'';?>>Yes, Send for translation</option>
           </select>
            </p>
          </div>
		 <?php }?>
          ...
          <ul class="form-row no-gutters">
		   <li class="form-group col-12 col-md-6 placeVaild">
			...
			<?php if($otherlang!='English'){ ?>
			     <li class="form-group col-12 col-md-6 placeVaild">
               <label class="col-form-sublabel text-capitalize">Type Category (<?php echo $otherlang;?>)</label>
			...
			<?php if($otherlang!='English'){ ?>
			  <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Type My City (<?php echo $otherlang;?>)</label>
			...
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Itinerary Title (<?php echo $otherlang;?>)</label>
			...
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Tag Line (<?php echo $otherlang;?>)</label>
            ...
            <li class="form-group col-12 col-md-12 placeVaild">
              ...
              <textarea class="form-control" name="itinerary_description" placeholder="Give details of your service (max 5000 characters)" id="itinerary_description" required data-rule-required="true" data-rule-maxlength="5000"><?php if(isset($editDataSet->itinerary_description))echo trim($editDataSet->itinerary_description);?></textarea>
			  <div id="DescError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-12 placeVaild">
              <label class="col-form-label text-light text-capitalize">What to Expect (<?php echo $otherlang;?>)</label>
              <textarea class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 5000 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="5000"><?php if(isset($editDataSet->other_itinerary_description))echo trim($editDataSet->other_itinerary_description);?></textarea>
			   ...
			   <?php 
                ...
                <li>
                  <label class="tagBox <?php echo @$indoorclass;?>">
                    <input type="checkbox" class="ignore" name="experience_itinerary_type[]" data-rule-required="false" value="Indoor" <?php if(isset($expvalue['Indoor'])=='Indoor') echo 'checked="checked"';?> />
                    Indoor</label>
                </li>
                <li>
	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 1000 characters)" id="itinerary_inclusions" data-rule-required="true" data-rule-maxlength="1000"><?php if(isset($editDataSet->itinerary_inclusions))echo trim($editDataSet->itinerary_inclusions);?></textarea>
            </li>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Exclusions</label>
              <textarea class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 1000 characters)" id="itinerary_exclusions" data-rule-required="true" data-rule-maxlength="1000"><?php if(isset($editDataSet->itinerary_exclusions))echo trim($editDataSet->itinerary_exclusions);?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" id="itinerary_splmention" data-rule-required="true" data-rule-maxlength="1500"><?php if(isset($editDataSet->itinerary_spl_mention))echo trim($editDataSet->itinerary_spl_mention);?></textarea>
            </li>
          </ul>
		  ...
		  <?php
            ...
            <li class="form-group col-12 placeVaild">
			  ...
			  <div class="placeVaild"> <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 1000 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="1000"><?php echo trim($faqs->itinerary_faq_answer);?></textarea>
			  <?php				  
				  if($key>0)echo '<a href="#" class="btn btn-link removeFaqli">Remove</a>'; ?>
               </div>
              </li>
			 <?php endforeach;} ?>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="text" name="itinerary_host_firstname" class="form-control ignore text-capitalize" placeholder="First Name" id="host_firstname" value="<?php if(isset($editDataSet->host_first_name))echo $editDataSet->host_first_name;else{echo $hostProfile[0]->host_first_name;}?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
				<label class="col-form-sublabel">Last Name</label>
              <input type="text" name="itinerary_host_lastname" class="form-control ignore text-capitalize" placeholder="Last Name" id="host_lastname" value="<?php if(isset($editDataSet->host_last_name))echo $editDataSet->host_last_name;else{echo $hostProfile[0]->host_last_name;}?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Mobile</label>
			  <span class="mobileCheck">+91-</span>
              <input type="number" name="itinerary_host_mobile" class="form-control ignore" placeholder="Mobile Number" id="host_mobile" value="<?php if(isset($editDataSet->host_mob_num))echo $editDataSet->host_mob_num;else{echo $hostProfile[0]->host_mob_no;}?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="email" name="itinerary_host_email" class="form-control ignore" placeholder="Email ID" id="host_email" 
			     value="<?php if(isset($editDataSet->host_email))echo $editDataSet->host_email;else{echo $hostProfile[0]->host_email;}?>" data-rule-required="true"/>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="number" name="itinerary_host_emergency" class="form-control ignore" placeholder="Mobile Number" id="host_emergency_no" 
			   value="<?php if(isset($editDataSet->host_emergency_contact_num))echo $editDataSet->host_emergency_contact_num;?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
            </li>
          </ul>
        </fieldset>
         <fieldset>
      ...
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <input id="startDateInput" name="itinerary_aviaiable_start_date" onkeydown="return false" type="text" class="form-control ignore" placeholder="DD-MM-YYYY" 
                 value="<?php if(isset($editDataSet->start_date_from_host) && $editDataSet->start_date_from_host!='1970-01-01')
                        echo date('d-m-Y',strtotime($editDataSet->start_date_from_host));?>" data-rule-required="true" autocomplete="off"/>
        </div>
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <input id="endDateInput" name="itinerary_aviaiable_end_date" onkeydown="return false" type="text" class="form-control ignore" placeholder="DD-MM-YYYY" 
                 value="<?php if(isset($editDataSet->end_date_to_host) && $editDataSet->end_date_to_host!='1970-01-01')
                        echo date('d-m-Y',strtotime($editDataSet->end_date_to_host));?>" data-rule-required="true" autocomplete="off"/>
        </div>
        </li>
    <li class="form-group col-12 col-md-12">
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <select id="selectOffDates" class="form-control ignore" name="itinerary_set_frequency" data-rule-required="true">
            <option value="regular" 
                    <?php echo @$editDataSet->frequency_type=='regular'?'selected="selected"':'';?>>Regular
            </option>
          <option value="nonregular" 
                  <?php echo @$editDataSet->frequency_type=='nonregular'?'selected="selected"':'';?>>Non-Regular
          </option>
        </select>
    </div>
  <div class="col-12 col-sm-6 placeVaild offDates">
    ...
    <input id="selectDateInput" name="itinerary_aviaiable_all_date" data-date-start-date="<?php if(isset($editDataSet->start_date_from_host) && $editDataSet->start_date_from_host!='1970-01-01')
                        echo date('d-m-Y',strtotime($editDataSet->start_date_from_host));?>" data-date-end-date="<?php if(isset($editDataSet->end_date_to_host) && $editDataSet->end_date_to_host!='1970-01-01')
                        echo date('d-m-Y',strtotime($editDataSet->end_date_to_host));?>" type="text" class="form-control ignore" 
           value="<?php if(!empty(@$editDataSet->frequency_off_days)){echo $editDataSet->frequency_off_days;}?>" 
  ...
  <div class="form-row">
    ...
    <div class="col-6 placeVaild">
      ...
      <input type="text" name="itinerary_aviaiable_time_from" class="form-control timepicker ignore" placeholder="Time" id="time_from" 
             value="<?php if(isset($editDataSet->aviaiable_time_form_host))echo $editDataSet->aviaiable_time_form_host;else{echo '12:00 AM';}?>" data-rule-required="true" autocomplete="off"/>
    </div>
    <div class="col-6 placeVaild">
      ...
      <input type="text" name="itinerary_aviaiable_time_to" class="form-control timepicker ignore" placeholder="Time"  id="time_to" 
             value="<?php if(isset($editDataSet->aviaiable_time_to_host))echo $editDataSet->aviaiable_time_to_host;else{echo '12:00 AM';}?>" data-rule-required="true" autocomplete="off"/>
    </div>
  </div>
</li>
</ul>
     ...
     <fieldset> 
		  ...
		  <?php 
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <input type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" id="pickup_point" value="<?php echo $routdata->pickup_point;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">Start Time</label>
                  <input type="text" name="itinerary_route_slot01_pickup_time[]" class="form-control timepicker ignore" placeholder="Time" id="pickup_time" value="<?php echo ($routdata->start_pickup_time?$routdata->start_pickup_time:'12:00 AM');?>" data-rule-required="true" autocomplete="off"/>
                </div>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <input type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" id="dropoff_point" value="<?php echo $routdata->drop_off_point;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">End Time</label>
                  <input type="text" name="itinerary_route_slot01_dropoff_time[]" class="form-control timepicker ignore" placeholder="Time" id="dropend_time" value="<?php echo ($routdata->end_dropoff_time?$routdata->end_dropoff_time:'12:00 AM');?>" data-rule-required="true" autocomplete="off"/>
                </div>
            ...
            <li class="form-group col-6 placeVaild">
              ...
              <input type="text" name="itinerary_route_slot01_duration[]" class="form-control ignore hourpicker" placeholder="Total Duration" id="route_slot01_duration" value="<?php if(!empty($routdata->total_durations))echo $routdata->total_durations;else{echo '0:00';}?>" data-rule-required="true" autocomplete="off"/>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Cut-off Time (hours)</label>
              <input type="text" name="itinerary_route_slot01_cutofftime[]" class="form-control ignore cutoffpicker" placeholder="Cut-off Time" id="route_slot01_cutofftime" value="<?php if(!empty($routdata->cutt_off_time))echo $routdata->cutt_off_time;else{echo '0:00';}?>" data-rule-required="true" autocomplete="off"/>
            </li>
          </ul>
          <ul class="form-row">
            <li class="form-group col-12 col-md-12">
		   ...
		   <ul class="form-row">		  
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">Pick-Up Point</label>
                  <input id="pickup_point" type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">Start Time</label>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">Drop-Off Point</label>
                  <input id="dropoff_point" type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">End Time</label>
             ...
             <select id="connectivity_airport" class="form-control ignore" name="itinerary_connectivity_airport" data-rule-required="true">
				<option value="">Select</option>
                 <?php foreach($airPortData as $airports):
					if($editDataSet->nearest_airport==$airports->airport_name){
						 $selected = 'selected';
						}else{
						 $selected = '';
						}
            ...
            <li class="form-group col-12 col-md-6 placeVaild">
             ...
             <select id="connectivity_railway" class="form-control ignore" name="itinerary_connectivity_railway" data-rule-required="true">
                ...
                <?php foreach($railwayData as $railways):
					if($editDataSet->nearest_railway_station==$railways->railway_name){
						 $selected = 'selected';
						}else{
						 $selected = '';
						}
              ...
              <li class="form-group col-12 col-sm-6 mb-1  pt-2">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    ...
                    <input type="number" class="form-control ignore disabledDad" name="itinerary_traveller_family_adult_minnumber" placeholder="0" min="1" id="adult_min_no" value="<?php echo isset($drafFamilyData[0]["family_adult_min_no"]) ? $drafFamilyData[0]["family_adult_min_no"] : ""; ?>" data-rule-required="true"  />
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Adult - Max. No.</label>
                    <input type="number" class="form-control ignore disabledDad" name="itinerary_traveller_family_adult_maxnumber" placeholder="0" id="adult_max_no" value="<?php echo isset($drafFamilyData[0]["family_adult_max_no"]) ? $drafFamilyData[0]["family_adult_max_no"] : ""; ?>" data-rule-required="true" />
                  </div>
                </div>
              </li>
              <li class="form-group col-12 col-sm-6 pt-2" data-id="kids-1">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    ...
                    <input id="family_kids_min_no" type="number" class="form-control ignore disabledPaa defaultActive" name="itinerary_traveller_family_kids01_minnumber[]" placeholder="0" min="1" value="<?php echo isset($ageTenKey) ? $drafFamilyData[$ageTenKey]["min_no_kides"] : "1"; ?>" data-rule-required="true" />
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Max. No. Kids</label>
                    <input id="family_kids_max_no" type="number" class="form-control ignore disabledPaa defaultActive" name="itinerary-traveller-family-kids01-maxnumber[]" placeholder="0" value="<?php echo isset($ageTenKey) ? $drafFamilyData[$ageTenKey]["max_no_kides"] : ""; ?>" data-rule-required="true" />
                  </div>
                </div>
              </li>
		...
		<div class="form-group col-12 col-sm-6 placeVaild">
		  ...
		  <input type="text" class="form-control ignore" name="itinerary_additionalcost_description[]" placeholder="Item description" id="additionalcost_desc" value="<?php if(isset($editDataSet->additional_cost_description))
			   echo $editDataSet->additional_cost_description;?>" />
		</div>
		<div class="form-group col-12 col-sm-6 placeVaild">
		  <label class="col-form-sublabel">Price</label>
		  <input type="number" class="form-control ignore" name="itinerary_additionalcost_amt[]" placeholder="Price" id="additionalcost_amt" value="<?php if(isset($editDataSet->additional_price))echo $editDataSet->additional_price;?>" />
		</div>
		</li>
		<li class="text-right"> <a href="#" id="addItemLink" data-toggle="modal" data-target="#addItemsModal" class="text-uppercase font-weight-bold mb-2 pt-0">+ Add More</a> </li>
		</ul>
        ...
        <fieldset>
          ...
          <h3 id="fillVideo" class="col-form-label mt-2">Embed Video</h3>
          <ul class="form-row no-gutters">
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Add a video 
                  <small>(*Paste in the entire EMBED code from the video's website)    </small> 
                </label>
                <textarea class="form-control ignore" name="itinerary_youtube_video" placeholder="Embed Video" id="itinerary_youtube_video" data-rule-required="true"><?php echo $editDataSet->youtube_video;?></textarea>
            </li>
          </ul>
          <h3 id="fillImage" class="col-form-label mt-2">Image Gallery</h3>
                 		  <small class="text-muted">*Required min. dimension 1440 X 1053px, size less than 10mb and format .jpg,.jpeg only</small>

          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_cover" id="image_gallery" accept="image/jpg, image/jpeg" data-height="1053" data-width="1440" data-size="10240" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only"  />
          ...
          <h3 class="col-form-sublabel mt-2">Additional Images</h3>
                		  <small class="text-muted">*Required min. dimension 250 X 158px, size less than 10mb and format .jpg,.jpeg only</small>
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_01" id="additional_image_1"  accept="image/jpg, image/jpeg" data-height="158" data-width="250" data-size="10240" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only"  />
			   <input id="itinerary_gallery_image_01_check" type="text" class="form-control lowKey ignore" name="hide_additional_img1" value="<?php if(isset($editDataSet->additional_img_1))echo $editDataSet->additional_img_1;?>" data-rule-required="true" >
            ...
            <li class="form-group col-12 col-md-4 placeVaild">
			  ...
			  <input id="itinerary_gallery_image_02_check" type="text" class="form-control lowKey ignore" name="hide_additional_img2" value="<?php if(isset($editDataSet->additional_img_2))echo $editDataSet->additional_img_2;?>" data-rule-required="true">
            ...
            <li class="form-group col-12 col-md-4 placeVaild">
			  ...
			  <input id="itinerary_gallery_image_03_check"  type="text" class="form-control lowKey ignore" name="hide_additional_img3" value="<?php if(isset($editDataSet->additional_img_3))echo $editDataSet->additional_img_3;?>"  data-rule-required="true" >
...
<ul class="form-row">
            <li class="form-group col-12 placeVaild">              
              <div class="custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" id="term_policy"  name="term_condition" value="1" <?php echo @$editDataSet->term_condition==1?'checked="checked"':'';?> class="custom-control-input ignore" data-rule-required="true" data-msg-required="If you need any clarification or have a question, please email us at help@iwl.com."/>
        ...
        <div class="modal-body">
          <ul class="pl-2 pr-2">
            <li class="form-group col-12 col-md-12">
              ...
              <div class="placeVaild">
                <textarea id="add_newAns" class="form-control mt-4" name="new-answer" placeholder="Answer (max 1000 characters)" requireddata-rule-maxlength="1000" ></textarea>
              </div>
            </li>
          </ul>
        </div>
...
$(window).on('load', function() {
    ...
    if (adminStatus == 1) {
        ...
        $('.floatBtn').html('');
        $('.floatBtn').append('<a href="<?php echo base_url()?>itineraries/experience" class="btn btn-link text-default">Back</a>')
...
$('#selectDateInput').datepicker({
   ...
   multidateSeparator: ", ",
		  ...
		  $(document).on('click', '#formSave', function(e) {
		      e.preventDefault();
		      validator.destroy();
			  $('#formItinerary').attr('action','editExperienceSaveItinerary');
		      $('.loadingWrap').show();
        ...
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').data("rule-required", false);
		      ...
		      validator.destroy();
		      $('#formItinerary').attr('action','editExperienceDoneItinerary');
		      $('.loadingWrap').show();
		      $("#formItinerary").validate({
		          errorElement: 'small',
		          errorPlacement: function(error, element) {
