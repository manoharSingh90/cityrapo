      ...
      <div class="row">
        <div class="col-12 col-lg-8">
          <div class="mainIntro boxStyle">
            <div class="mainIntro-top"> <a href="<?php echo base_url();?>itineraries/session" class="text-uppercase"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                  ...
                  <div class="videoPlay">
				   <?php /*
                    ...
                    <video controls>
                  	...
                  	*/ ?>
                  <?= $itineraryData->youtube_video;?></div>
                </div>
