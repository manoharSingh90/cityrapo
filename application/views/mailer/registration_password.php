    ...
    <td>
      <table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; background-image: url(mailer_img/bg.png); background-repeat: no-repeat; background-position: right top;">
        ...
        <tr>
          ...
          <td colspan="4">
            <p style="color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Dear <?php echo $name?>,</p>
            <br>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="color: #000; font-size: 14px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Thank you for registering with City Explorers, please complete your sign up using the password given below - <br/>
            <strong style="color: #ee474c; font-size:18px;">Password- <?php echo $pass ;?></strong></td>
          <td style="width: 30px;"></td>
        </tr>
		<tr>
          <td colspan="4" style="padding: 10px;"></td>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="color: #000; font-size: 14px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Please enter/copy this password on the sign up page.</td>
          <td style="width: 30px;"></td>
        </tr>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="font-style: italic; color: #999; font-size: 80%;">(The password is only valid for 24 hours, after which you will need register again.)</td>
          <td style="width: 30px;"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="color: #000; font-size: 16px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Best regards,<br>
