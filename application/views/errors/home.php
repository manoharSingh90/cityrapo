          ...
          <div class="itinerariesHead-left">
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-6">
                ...
                <input type="text" id="searchDateInput" class="form-control dateIcon rightSide" name="searchDate" placeholder="Select a dates" autocomplete="off" /><a href="#" id="clearDate" class="clearText">clear</a>
              </li>
