...
<table cellpadding="0" cellspacing="0" style="width:100%; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif';">
  <tr>
    <td><table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #888; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 15px; font-family:Arial, Helvetica, sans-serif; line-height:1.75;"><strong>Thank you for submitting your cityexplorer profile.</strong></td>
          <td width="30"></td>
        </tr>
        <tr>
        <td colspan="3" height="30"></td>
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">Your registration is complete. Someone from our team will get in touch with you shortly<br>For any assistance, please write to us at - help@cityexplorers.in</td>
          <td width="30"></td>
        </tr>
        <tr>
          <td colspan="3" height="30"></td>
