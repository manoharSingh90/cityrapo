...
$('.itinerary_selected_lang').each(function(){
	...
	if(serviceid==1){
	 ...
	 if(serviceid==2){
		 var detailURL = '<?php echo base_url()?>Admin/admin_detail_itineraries_sessions?itinerary_id='+itinerary_id+'&flag=2'+'&serviceid='+serviceid+'&lang='+itinerary_lang;
		 }
	if(serviceid==3){
		 var detailURL = '<?php echo base_url()?>Admin/admin_detail_itineraries_experience?itinerary_id='+itinerary_id+'&flag=2'+'&serviceid='+serviceid+'&lang='+itinerary_lang;
		 }
    if(serviceid==4){
		 var detailURL = '<?php echo base_url()?>Admin/admin_detail_itineraries_meetup?itinerary_id='+itinerary_id+'&flag=2'+'&serviceid='+serviceid+'&lang='+itinerary_lang;
		 }				 
