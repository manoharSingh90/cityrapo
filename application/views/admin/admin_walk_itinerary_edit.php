	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" id="itinerary_splmention" data-rule-required="true" data-rule-maxlength="1500"><?php if(isset($editDataSet->itinerary_spl_mention))echo $editDataSet->itinerary_spl_mention;?></textarea>
            </li>
          </ul>
