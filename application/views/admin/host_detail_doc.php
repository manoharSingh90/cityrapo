      ...
      <div class="profileRight">
        ...
        <div class="profileData docList">
          ...
          <div class="pt-3 pb-3 row">
            ...
            <?php if($details->passport_number_doc != '') { ?>
            <div class="col-4">
              <div class="downloadCard">
                <div class="dcIcon"><img src="<?php echo base_url();?>assets/img/icon/filejpg.svg" alt="filejpg" /></div>
                <div class="dcInfo">
                  <p><?php echo $details->passport_number_doc;?></p>                  
                    <a href="<?php echo base_url();?>assets/upload/profile_pic/<?php echo $details->passport_number_doc;?>" download>Download</a>
                </div>
              </div>
            </div>
          <?php } ?>
          ...
          <div class="pt-3 pb-3 row">
            ...
            <?php if($details->license_guide_number_doc !='') { ?>
            <div class="col-4">
              <div class="downloadCard">
                <div class="dcIcon"><img src="<?php echo base_url();?>assets/img/icon/filejpg.svg" alt="filejpg" /></div>
                <div class="dcInfo">
                  <p><?php echo $details->license_guide_number_doc;?></p>                  
                  <a href="<?php echo base_url();?>assets/upload/profile_pic/<?php echo $details->license_guide_number_doc;?>" download>Download</a>
                </div>
              </div>
            </div>
          <?php } ?>
