	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="text" name="itinerary_host_firstname" class="form-control ignore text-capitalize" placeholder="First Name" id="host_firstname" value="<?php if(isset($editDataSet->host_first_name))echo $editDataSet->host_first_name;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
				<label class="col-form-sublabel">Last Name</label>
              <input type="text" name="itinerary_host_lastname" class="form-control ignore text-capitalize" placeholder="Last Name" id="host_lastname" value="<?php if(isset($editDataSet->host_last_name))echo $editDataSet->host_last_name;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
...
$('#cancleItinerary').on('click', function() {
    ...
    if (returnFlag == 1) {
        ...
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').data("rule-required", false);
		      ...
		      validator.destroy();
		      $('#formItinerary').attr('action','admin_editexperience_itinerary');
		      $('.loadingWrap').show();
