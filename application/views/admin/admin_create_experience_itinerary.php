            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <input id="pickup_point" type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" value="<?php echo $routdata->pickup_point;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <input id="dropoff_point" type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" value="<?php echo $routdata->drop_off_point;?>" data-rule-required="true" autocomplete="off" />
                </div>
                <div class="col-12 col-sm-6 placeVaild">
