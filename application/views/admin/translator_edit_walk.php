<?php 
 ...
 <div class="profilePage">
  <div class="profilePage-head clearfix">
    ...
    <div class="float-right floatBtn"> <a href="#" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">cancel</a> <a id="callDone" href="#" class="btn btn-primary">Done</a> </div>
  </div>
  <div class="profilePage-body clearfix">
  <div class="profilePage-links" >
  <h3><span><img src="<?php echo base_url();?>assets/img/icon/details.svg" alt="Basic" /></span>Basic</h3>
  <ul>
    ...
    <li> <a href="#fillhost">Additional Contact Details</a> </li>
  </ul>
  <h3><span><img src="<?php echo base_url();?>assets/img/icon/plan.svg" alt="plan" /></span>Location &amp; Plan</h3>
  <ul>
    <li> <a href="#fillAvailability">Service Frequency</a> </li>
    <li> <a href="#fillRoute">Route & Timings</a> </li>
    <li> <a href="#fillConnectivity">Connectivity & Locations</a> </li>
    <li> <a href="#fillTraveller">Traveller Specifications</a> </li>
  </ul>
  <h3><span><img src="<?php echo base_url();?>assets/img/icon/rupee.svg" alt="Pricing" /></span>Pricing</h3>
  <ul>
  ...
  <ul>
    <li> <a href="#fillSponsor">Sponsor</a> </li>
  ...
  <ul>
    <li> <a href="#fillLegalLiabilities">Code of Conduct</a> </li>
    <li> <a href="#fillLegalPrivacy">Non Discrimination & Sexual Harassment Policy </a> </li>
    <li> <a href="#fillLegalCancellations">Confidential Information, Safety of Guests, Picture & Social Media Policy</a> </li>
    <li> <a href="#fillLegalCancellations">Branding Merchandise & Identity Card Policy</a> </li>
    <li> <a href="#fillLegalCancellations">Policy on Shopping Activities</a> </li>
    <li> <a href="#fillLegalCancellations">Intellectual Property Policy</a> </li>
  </ul>
</div>
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="selLang" id="select_lang" value="<?php echo $otherlang;?>"/>
		<input type="hidden" name="itinerary_id" id="itinerary_id" value="<?php echo $itineraryId;?>"/>
		<input type="hidden" name="adminStatus" id="adminStatus" value="<?php echo $adminStatus;?>"/>
		<input type="hidden" name="user_id" id="user_id" value="<?php echo $userId;?>"/>
		<input type="hidden" name="returnUrl" id="returnUrl" value="<?php echo $flag;?>"/>
        <h3 id="fillDetails" class="col-form-label">Details</h3>
          <ul class="form-row no-gutters">
		   <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <select class="form-control" name="category" id="categoryName" onchange="checkValidate();" required data-rule-required="true">
			    <option value="">Select</option>
				<?php 
					foreach($allCategory as $cateList):
					?>
                <option value="<?php echo $cateList->id;?>" <?php echo ($editDataSet->itinerary_category==$cateList->id?'selected="selected"':'');?>><?php echo $cateList->category_name;?></option>
               <?php endforeach;?>
              </select>
			  <div id="cateError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			     <li class="form-group col-12 col-md-6 placeVaild">
               <label class="col-form-sublabel">Type Category (<?php echo $otherlang;?>)</label>
               <input type="text" class="form-control" id="type_category" name="type_category" 
			    value="<?php if(isset($editDataSet->other_category_type))echo $editDataSet->other_category_type;?>" required data-rule-required="true"/>
            ...
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  <?php 
				  ...
				  ?>
               <!-- <option value="<?php //echo $city->id;?>" <?php //if($draftData->origin_city==$city->id)echo 'selected';?>><?php //echo $city->city_name;?></option>-->
				<option value="<?php echo $value;?>" <?php echo (@$editDataSet->origin_city==$value?'selected="selected"':'');?> > <?php echo $value;?> </option>
                <?php endforeach;endforeach;?>
              </select>
			  <div id="cityError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			  <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Select My City (<?php echo $otherlang;?>)</label>
              <input type="text" class="form-control" name="origin_otherCity"  id="origin_otherCity" 
			       value="<?php if(isset($editDataSet->origin_other_city)) echo $editDataSet->origin_other_city;?>" required data-rule-required="true"/>
			  <div id="othercityError" class="error errorOwn"></div>
            </li>
			<?php } ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Itinerary Title</label>
              <input type="text" class="form-control" name="itinerary_title" placeholder="Itinerary Title" id="itinerary_title"  value="<?php if(isset($editDataSet->itinerary_title))echo $editDataSet->itinerary_title;?>" required data-rule-required="true"/>
			  <div id="titleError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Itinerary Title (<?php echo $otherlang;?>)</label>
              <input type="text" class="form-control" name="itinerary_other_title"  id="itinerary_other_title" 
			    value="<?php if(isset($editDataSet->itinerary_other_title))echo $editDataSet->itinerary_other_title;?>" required data-rule-required="true"/>
			  <div id="othertitleError" class="error errorOwn"></div>
            </li>
			<?php } ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="text" class="form-control" name="itinerary_tagline" placeholder="Tag Line" id="itinerary_tagline"  
			        value="<?php if(isset($editDataSet->itinerary_tagline))echo $editDataSet->itinerary_tagline;?>" required data-rule-required="true"/>
			  <div id="tagLineError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Tag Line (<?php echo $otherlang;?>)</label>
              <input type="text" class="form-control" name="other_tag_line"  id="other_tag_line" 
			      value="<?php if(isset($editDataSet->itinerary_other_tagline))echo $editDataSet->itinerary_other_tagline;?>" required data-rule-required="true"/>
			  <div id="othertagLineError" class="error errorOwn"></div>
            </li>
			<?php } ?>
            <li class="form-group col-12 col-md-12 placeVaild">
              <label class="col-form-label text-light">Description</label>
              <textarea class="form-control" name="itinerary_description" placeholder="Give details of your service (max 5000 characters)" id="itinerary_description" required data-rule-required="true" data-rule-maxlength="5000"><?php if(isset($editDataSet->itinerary_description))echo $editDataSet->itinerary_description;?></textarea>
			  <div id="DescError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-12 placeVaild">
              <label class="col-form-label text-light">Description (<?php echo $otherlang;?>)</label>
              <textarea class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 5000 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="5000"><?php if(isset($editDataSet->other_itinerary_description))echo $editDataSet->other_itinerary_description;?></textarea>
			  <div id="otherLangError" class="error errorOwn"></div>
            </li>
			<?php } ?>
            <li class="form-group col-12 col-md-12 placeVaild">
             ...
             <!-- <input id="typeThemes" type="text" name="itinerary_theme[]" class="form-control" placeholder="Select themes" />
			  <input id="typeThemesCheckbox" type="checkbox" name="itinerary-theme-checkbox" class="lowKey ignore" data-rule-required="true" />-->
			   ...
			   <?php 
				   ...
				   $themesIds = explode(',',$editDataSet->itinerary_theme);
				   if(in_array($value->id,$themesIds)){
					   $selected = 'selected';
					   }
					  else{
						   $selected = '';
				   ...
				   ?>
                <option value="<?php echo $value->id;?>" <?php echo $selected;?>><?php echo $value->theme_name;?></option>
               <?php endforeach;?>
              </select>
			 <div id="themeError" class="error errorOwn"></div>
          ...
          <ul class="form-row no-gutters">
           ...
           <!-- <input id="typeHighlights" type="text" class="form-control" name="itinerary_highlights[]" placeholder="Type a highlight (separate using commas)" data-rule-required="true"/>
			<input id="typeHighlightsCheckbox" type="checkbox" name="itinerary_highlights-checkbox" class="lowKey ignore" data-rule-required="true" />-->
			
			 <select id="typeHighlights" class="form-control ignore" name="itinerary_highlights[]" placeholder="Type a highlight (separate using commas)" multiple data-rule-required="true">
			   <?php 			  
			       if(!empty($editDataSet->type_highlights)){
				   $highlights = explode(',',$editDataSet->type_highlights);
				   foreach($highlights as $key=>$value):
				   ?>
                <option value="<?php echo $value;?>" <?php if(isset($value))echo 'selected';?>><?php echo $value;?></option>
				   <?php endforeach;} ?>
              </select>
           ...
           <!--<input id="typeFeatures" type="text" class="form-control" name="itinerary_features[]" placeholder="Type a highlight (separate using commas)" data-rule-required="true"/>
		   			 			  <input id="typeFeaturesCheckbox" type="checkbox" name="itinerary_features-checkbox" class="lowKey ignore" data-rule-required="true" />-->
              <select id="typeFeatures" type="text" class="form-control ignore" name="itinerary_features[]" placeholder="Type a features (separate using commas)" multiple data-rule-required="true">
			   <?php 
			      foreach($features as $key=>$value):
			       if(!empty($editDataSet->type_features)){				  
				   $featurArr = explode(',',$editDataSet->type_features);				  
				   if(in_array($value->id,$featurArr)){
					   $selected = 'selected';
					   }
					  else{
						   $selected = '';
				   ...
				   ?>
                <option value="<?php echo $value->id;?>" <?php echo $selected;?>><?php echo $value->feature_name;?></option>
				   <?php endforeach ;?>
              </select>
            ...
            <!--<input id="typeSearchTags" type="text" name="itinerary_searchtags[]" class="form-control" placeholder="Search Tags" data-rule-required="true"/>
			 <input id="typeSearchTagsCheckbox" type="checkbox" name="itinerary_searchtags-checkbox" class="lowKey ignore" data-rule-required="true" />-->
			 ...
			 <select id="typeSearchTags" type="text" name="itinerary_searchtags[]" class="form-control ignore" placeholder="Search Tags" multiple data-rule-required="true">
			   <?php 
				   if(!empty($editDataSet->itinerary_searchtags)){
				   $searchTagsArr = explode(',',$editDataSet->itinerary_searchtags);
			  ...
			  <div id="searchTagError" class="error errorOwn"></div>
            </li>
            <li class="form-group col-12 placeVaild">
              ...
              <div class="form-row">
				...
				<?php 
					 if(isset($editDataSet->itinerary_delivery)){
						  $delivery = explode(',',$editDataSet->itinerary_delivery);
						  $delivery1 = explode(',',$editDataSet->itinerary_delivery);
                  ...
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                    <input type="checkbox" id="deliveryType-bus" name="itinerary_delivery[]" value="bus" class="custom-control-input limitSelect ignore" <?php if(isset($deliverydata['bus'])){echo "checked";} ?> data-rule-required="true"/>
	...
	c0,0.7,0,1.5,0.8,1.7c0.6,0.2,1.5,0.1,2.1,0.1C22.4,32.3,22.4,30.9,21.6,30.9z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                   <input type="checkbox" id="deliveryType-auto" name="itinerary_delivery[]" value="auto" class="custom-control-input limitSelect" <?php if(isset($deliverydata['auto'])){echo "checked";} ?> >
                    <span class="control-icon">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	C23.8,28.7,23.8,27.3,22.9,27.3z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                    <input type="checkbox" id="deliveryType-car" name="itinerary_delivery[]" value="car" class="custom-control-input limitSelect" <?php if(isset($deliverydata['car'])){echo "checked";} ?>>
                    <span class="control-icon">
                    <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	C9.1,11.7,10.7,10.8,10.1,9.8L10.1,9.8z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                    <input type="checkbox" id="deliveryType-cycle" name="itinerary_delivery[]" value="cycle" class="custom-control-input limitSelect" <?php if(isset($deliverydata['cycle'])){echo "checked";} ?>>
                    <span class="control-icon">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 41.8 33" style="enable-background:new 0 0 41.8 33;" xml:space="preserve">
		...
		C21.6,17.6,21.6,19.2,22.6,19.2z"/>
                ...
                <div class="col-6 col-sm-auto">
                  <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
                    <input type="checkbox" id="deliveryType-foot" name="itinerary_delivery[]" value="foot" class="custom-control-input limitSelect" <?php if(isset($deliverydata['foot'])){echo "checked";} ?>>
                    <span class="control-icon">
                    <svg version="1.1"   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
           ...
           <!-- <input id="typeLanguages" type="text" class="form-control" name="preferences_languages[]" placeholder="Select my languages" data-rule-required="true"/>
			 <input id="typeLanguagesCheckbox" type="checkbox" name="preferences_languages-checkbox" class="lowKey ignore" data-rule-required="true" />-->
			 <select id="typeLanguages" type="text" class="form-control ignore" name="preferences_languages[]" placeholder="Select my languages" multiple data-rule-required="true">
			   <?php 
			         $itinerraylang = explode(',',$editDataSet->prefer_languages);
					 
			        $langArr = explode(',',$languages[0]->known_languages);
				    foreach($langArr as $value):
					if(in_array($value,$itinerraylang)){
						$selected = 'selected';
						}else{
						$selected = '';
						}
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 400 characters)" id="itinerary_inclusions" data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_inclusions))echo $editDataSet->itinerary_inclusions;?></textarea>
            </li>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Exclusions</label>
              <textarea class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 400 characters)" id="itinerary_exclusions" data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_exclusions))echo $editDataSet->itinerary_exclusions;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 400 characters)" id="itinerary_splmention" data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_spl_mention))echo $editDataSet->itinerary_spl_mention;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12">
              <div class="custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" id="socialShare-facebook" name="itinerary_allowshare_facebook" class="custom-control-input" value="1" <?php if(isset($editDataSet->itinerary_allowshare_facebook)==1)echo 'checked';?> />
                <label class="custom-control-label" for="socialShare-facebook">Share on facebook</label>
              </div>
            </li>
            <li class="form-group col-12 ">
              <div class="custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" id="socialShare-instagram" name="itinerary_allowshare_instagram" class="custom-control-input" value="1" <?php if(isset($editDataSet->itinerary_allowshare_instagram)==1)echo 'checked';?> >
		  ...
		  <?php
		     if(!empty($draFaqData)){
			  ...
			  ?>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Questions</label><div class="placeVaild">

              <input type="text" name="itinerary_faq_question_01[]" class="form-control ignore" placeholder="Questions" id="faq_question_01" 
			  value="<?php echo $faqs->itinerary_faq_question;?>" data-rule-required="true"/>
             		  </div>
			  <div class="placeVaild"> <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 200 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="200"><?php echo $faqs->itinerary_faq_answer;?></textarea>			 
               </div>
			    <?php if($key>0)echo '<a href="#" class="btn btn-link removeFaqli">Remove</a>';?>
              </li>
			 <?php endforeach;} ?>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="text" name="itinerary_host_firstname" class="form-control ignore" placeholder="First Name" id="host_firstname" value="<?php if(isset($editDataSet->host_first_name))echo $editDataSet->host_first_name;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Last Name</label>
              <input type="text" name="itinerary_host_lastname" class="form-control ignore" placeholder="Last Name" id="host_lastname" value="<?php if(isset($editDataSet->host_last_name))echo $editDataSet->host_last_name;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel">Mobile</label>
              <input type="number" name="itinerary_host_mobile" class="form-control ignore" placeholder="Mobile Number" id="host_mobile" value="<?php if(isset($editDataSet->host_mob_num))echo $editDataSet->host_mob_num;?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="email" name="itinerary_host_email" class="form-control ignore" placeholder="Email ID" id="host_email" 
			     value="<?php if(isset($editDataSet->host_email))echo $editDataSet->host_email;?>" data-rule-required="true"/>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="number" name="itinerary_host_emergency" class="form-control ignore" placeholder="Mobile Number" id="host_emergency_no" 
			   value="<?php if(isset($editDataSet->host_emergency_contact_num))echo $editDataSet->host_emergency_contact_num;?>" data-rule-required="true"/>
            </li>
          </ul>
        </fieldset>
        <fieldset>
          <ul class="form-row">
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12">
                  <label id="fillAvailability" class="col-form-sublabel">Available time of host</label>
                </div>
                <div class="col-6 placeVaild">
				  ...
				  value="<?php if(isset($editDataSet->aviaiable_time_form_host))echo $editDataSet->aviaiable_time_form_host;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-6 placeVaild">
				  ...
				  value="<?php if(isset($editDataSet->aviaiable_time_to_host))echo $editDataSet->aviaiable_time_to_host;?>" data-rule-required="true" autocomplete="off"/>
                </div>
              </div>
            </li>
            <li class="col-6 placeVaild">
              <label class="col-form-sublabel">Start Date</label>
              <input id="startDateInput" name="itinerary_aviaiable_start_date" type="text" class="form-control ignore" placeholder="Start Date" 
			  value="<?php if(isset($editDataSet->start_date_from_host) && $editDataSet->start_date_from_host!='1970-01-01')echo $editDataSet->start_date_from_host;?>" data-rule-required="true" autocomplete="off"/>
            </li>
            <li class="col-6 placeVaild">
              <label class="col-form-sublabel">End Date</label>
              <input id="endDateInput" name="itinerary_aviaiable_end_date" type="text" class="form-control ignore" placeholder="End Date " 
			  value="<?php if(isset($editDataSet->end_date_to_host) && $editDataSet->end_date_to_host!='1970-01-01')echo $editDataSet->end_date_to_host;?>" data-rule-required="true" autocomplete="off"/>
            </li>
          </ul>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <select class="form-control ignore" name="itinerary_service_frequency" id="service_frequency" data-rule-required="true">				
					<option value="daily" <?php echo @$editDataSet->service_frequency=='daily'?'selected="selected"':'';?> >Daily</option>
					<option value="weekly" <?php echo @$editDataSet->service_frequency=='weekly'?'selected="selected"':'';?>>Weekly</option>
                  </select>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <div id="dailyDays" class="pt-2">
                  <label class="col-form-sublabel d-inline-block mr-2">Days</label>
				  <?php 
				  if(isset($editDataSet->days)){
					   $day = explode(',',$editDataSet->days);
					   $day1= explode(',',$editDataSet->days);
					   $daysdata = array_combine($day,$day1);					  
					  }
                  ...
                  <ul class="dayList d-inline-block">
                    <li>
                      <label class="dayBox ">
                        <input type="checkbox" name="itinerary_service_days[]" class="ignore" value="Mon" <?php if(isset($daysdata['Mon']))echo 'checked';?> data-rule-required="true"/>
                        M</label>
                    </li>
                    <li>
                      <label class="dayBox">
                        <input type="checkbox" name="itinerary_service_days[]" value="Tue" <?php if(isset($daysdata['Tue']))echo 'checked';?>/>
                        T</label>
                    </li>
                    <li>
                      <label class="dayBox">
                        <input type="checkbox" name="itinerary_service_days[]" value="Wed" <?php if(isset($daysdata['Wed']))echo 'checked';?>/>
                        W</label>
                    </li>
                    <li>
                      <label class="dayBox">
                        <input type="checkbox" name="itinerary_service_days[]" value="Thu" <?php if(isset($daysdata['Thu']))echo 'checked';?>/>
                        T</label>
                    </li>
                    <li>
                      <label class="dayBox">
                        <input type="checkbox" name="itinerary_service_days[]" value="Fri" <?php if(isset($daysdata['Fri'])){echo 'checked';} ?>/>
                        F</label>
                    </li>
                    <li>
                      <label class="dayBox">
                        <input type="checkbox" name="itinerary_service_days[]" value="Sat" <?php if(isset($daysdata['Sat'])){echo 'checked';}?>/>
                        S</label>
                    </li>
                    <li>
                      <label class="dayBox">
                        <input type="checkbox" name="itinerary_service_days[]" value="Sun" <?php if(isset($daysdata['Sun'])){echo 'checked';} ?>/>
                        S</label>
                    </li>
                  </ul>
               </div>
				
				  <div id="weeklyDays" class="hidden">
                    <ul class="nav nav-tabs smallTab">
                      <li class="nav-item active"><a class="nav-link active" data-toggle="pill" href="#week1">Week 1</a></li>
                      <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#week2">Week 2</a></li>
                      <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#week3">Week 3</a></li>
                      <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#week4">Week 4</a></li>
                      <li class="nav-item"><a class="nav-link" data-toggle="pill" href="#week5">Week 5</a></li>
                    </ul>
                    <div class="tab-content pt-2 pl-2">
					<?php 
				  if(isset($editDataSet->week1_days)){
					   $week_day1 = explode(',',$editDataSet->week1_days);
					   $week_day2= explode(',',$editDataSet->week1_days);
					   $week1days = array_combine($week_day1,$week_day2);					 
					  }
                      ...
                      <div id="week1" class="tab-pane active">
                        ...
                        <ul class="dayList d-inline-block">
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Mon" name="weekly_1[]" class="ignore" <?php if(isset($week1days['Mon'])){echo 'checked="checked"';} ?> data-rule-required="true"/>
                              M</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Tue" name="weekly_1[]" <?php if(isset($week1days['Tue'])){echo 'checked="checked"';} ?> />
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Wed" name="weekly_1[]" <?php if(isset($week1days['Wed'])){echo 'checked="checked"';} ?>/>
                              W</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Thu" name="weekly_1[]" <?php if(isset($week1days['Thu'])){echo 'checked="checked"';} ?> />
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Fri" name="weekly_1[]" <?php if(isset($week1days['Fri'])){echo 'checked="checked"';} ?>/>
                              F</label>
                          </li>
                          <li>
                            <label class="dayBox">
                           <input type="checkbox" value="Sat" name="weekly_1[]" <?php if(isset($week1days['Sat'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                          <li>
                            <label class="dayBox">
                         <input type="checkbox" value="Sun" name="weekly_1[]"<?php if(isset($week1days['Sun'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                        </ul>
                      </div>
					  ...
					  <?php 
				  if(isset($editDataSet->week2_days)){
					   $week2_days = explode(',',$editDataSet->week2_days);
					   $week2_days= explode(',',$editDataSet->week2_days);
					   $week2days = array_combine($week2_days,$week2_days);					 
					  }
					  ...
					  ?>
                        ...
                        <ul class="dayList d-inline-block">
                          <li>
                            <label class="dayBox">
                         <input type="checkbox" value="Mon" name="weekly_2[]" <?php if(isset($week2days['Mon'])){echo 'checked="checked"';} ?>/>
                              M</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Tue" name="weekly_2[]" <?php if(isset($week2days['Tue'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Wed" name="weekly_2[]" <?php if(isset($week2days['Wed'])){echo 'checked="checked"';} ?>/>
                              W</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Thu" name="weekly_2[]" <?php if(isset($week2days['Thu'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Fri" name="weekly_2[]" <?php if(isset($week2days['Fri'])){echo 'checked="checked"';} ?>/>
                              F</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sat" name="weekly_2[]" <?php if(isset($week2days['Sat'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sun" name="weekly_2[]" <?php if(isset($week2days['Sun'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                        </ul>
                      </div>
					  ...
					  <?php 
				   if(isset($editDataSet->week3_days)){
					   $week3_days = explode(',',$editDataSet->week3_days);
					   $week3_days= explode(',',$editDataSet->week3_days);
					   $week3days = array_combine($week3_days,$week3_days);					 
					  }
					  ...
					  ?>
                        ...
                        <ul class="dayList d-inline-block">
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Mon" name="weekly_3[]" <?php if(isset($week3days['Mon'])){echo 'checked="checked"';} ?>/>
                              M</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Tue" name="weekly_3[]" <?php if(isset($week3days['Tue'])){echo 'checked="checked"';} ?> />
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Wed" name="weekly_3[]" <?php if(isset($week3days['Wed'])){echo 'checked="checked"';} ?>/>
                              W</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Thu" name="weekly_3[]" <?php if(isset($week3days['Thu'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Fri" name="weekly_3[]" <?php if(isset($week3days['Fri'])){echo 'checked="checked"';} ?>/>
                              F</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sat" name="weekly_3[]" <?php if(isset($week3days['Sat'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sun" name="weekly_3[]" <?php if(isset($week3days['Sun'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                        </ul>
                      </div>
                      <div id="week4" class="tab-pane fade">
					   <?php 
				   if(isset($editDataSet->week4_days)){
					   $week4_days = explode(',',$editDataSet->week4_days);
					   $week4_days= explode(',',$editDataSet->week4_days);
					   $week4days = array_combine($week4_days,$week4_days);					 
					  }					 
					  ?>
                        <label class="col-form-sublabel d-inline-block mr-2">Days</label>
                        <ul class="dayList d-inline-block">
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Mon" name="weekly_4[]" <?php if(isset($week4days['Mon'])){echo 'checked="checked"';} ?>/>
                              M</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Tue" name="weekly_4[]" <?php if(isset($week4days['Tue'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Wed" name="weekly_4[]" <?php if(isset($week4days['Wed'])){echo 'checked="checked"';} ?>/>
                              W</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Thu" name="weekly_4[]" <?php if(isset($week4days['Thu'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Fri" name="weekly_4[]" <?php if(isset($week4days['Fri'])){echo 'checked="checked"';} ?>/>
                              F</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sat" name="weekly_4[]" <?php if(isset($week4days['Sat'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sun" name="weekly_4[]" <?php if(isset($week4days['Sun'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                        </ul>
                      </div>
                      <div id="week5" class="tab-pane fade">
					  <?php 
				    if(isset($editDataSet->week5_days)){
					   $week5_days = explode(',',$editDataSet->week5_days);
					   $week5_days= explode(',',$editDataSet->week5_days);
					   $week5days = array_combine($week5_days,$week5_days);					 
					  }					 
					  ?>
                        <label class="col-form-sublabel d-inline-block mr-2">Days</label>
                        <ul class="dayList d-inline-block">
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Mon" name="weekly_5[]" <?php if(isset($week5days['Mon'])){echo 'checked="checked"';} ?>/>
                              M</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Tue" name="weekly_5[]" <?php if(isset($week5days['Tue'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Wed" name="weekly_5[]" <?php if(isset($week5days['Wed'])){echo 'checked="checked"';} ?>/>
                              W</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Thu" name="weekly_5[]" <?php if(isset($week5days['Thu'])){echo 'checked="checked"';} ?>/>
                              T</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Fri" name="weekly_5[]" <?php if(isset($week5days['Fri'])){echo 'checked="checked"';} ?>/>
                              F</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sat" name="weekly_5[]" <?php if(isset($week5days['Sat'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                          <li>
                            <label class="dayBox">
                              <input type="checkbox" value="Sun" name="weekly_5[]" <?php if(isset($week5days['Sun'])){echo 'checked="checked"';} ?>/>
                              S</label>
                          </li>
                        </ul>
                      </div>
            ...
            <?php 
		      if(!empty($drafRouteTimeData)){
			   foreach($drafRouteTimeData as $routdata):
			    $stopsValue = fetchAll_stops($routdata->create_itinerary_id,$routdata->id);
			  ?>
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">Pick-Up Point</label>
                  <input type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Pick-up Point" id="pickup_point" value="<?php echo $routdata->pickup_point;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">Start Time</label>
                  <input type="text" name="itinerary_route_slot01_pickup_time[]" class="form-control timepicker ignore" placeholder="Time" id="pickup_time" value="<?php echo date('h:i',strtotime($routdata->start_pickup_time));?>" data-rule-required="true" autocomplete="off"/>
                </div>
              </div>
            </li>
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <input type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Pick-up Point" id="dropoff_point" value="<?php echo $routdata->drop_off_point;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6 placeVaild">
                  <label class="col-form-sublabel">End Time</label>
                  <input type="text" name="itinerary_route_slot01_dropoff_time[]" class="form-control timepicker ignore" placeholder="Time" id="dropend_time" value="<?php echo date('h:i',strtotime($routdata->end_dropoff_time));?>" data-rule-required="true" autocomplete="off"/>
                </div>
              </div>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Total Duration (hours)</label>
              <input type="text" name="itinerary_route_slot01_duration[]" class="form-control ignore hourpicker" placeholder="Total Duration" id="route_slot01_duration" value="<?php echo $routdata->total_durations;?>" data-rule-required="true" autocomplete="off"/>
            </li>
            <li class="form-group col-6 placeVaild">
              <label class="col-form-sublabel">Cut-off Time (hours)</label>
              <input type="text" name="itinerary_route_slot01_cutofftime[]" class="form-control ignore hourpicker" placeholder="Cut-off Time" id="route_slot01_cutofftime" value="<?php echo $routdata->cutt_off_time;?>" data-rule-required="true" autocomplete="off"/>
            </li>
          </ul>
          <ul class="form-row">
            <?php $i=1;
			  if(!empty($stopsValue)){			 
			  foreach($stopsValue as $key=>$stopsData):
			  ?>
            <li class="form-group col-12 col-md-12">
              <label class="col-form-sublabel text-dark font-weight-semibold d-block">Stop <?php echo $i;?></label>
              <div class="form-row slotClass">
                <div class="col-12 col-sm-7 placeVaild">
                  <label class="col-form-sublabel">Type a location</label>
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_location][<?php echo $key; ?>]" class="form-control ignore" placeholder="Type a location" id="route_slot01_stop01_location" value="<?php echo $stopsData->stop_location_type;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
                  <label class="col-form-sublabel">Time</label>
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_time][<?php echo $key; ?>]" class="form-control timepicker ignore" placeholder="Time" id="route_slot01_stop01_time" value="<?php echo $stopsData->stop_location_time;?>" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-7 pt-4 placeVaild">
                  <textarea class="form-control ignore" name="route[0][itinerary_route_slot01_stop01_description][<?php echo $key; ?>]" placeholder="Add a description" id="route_slot01_stop01_description" data-rule-required="true"><?php echo $stopsData->stop_location_desc;?></textarea>
                </div>
              </div>
              <?php if($key>0) echo '<a href="#" class="btn btn-link removeStop">Remove</a>';?>
            </li>
            ...
            <li class="form-group col-12 col-md-12">
              ...
              <div class="form-row slotClass">
                ...
                <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
                  <label class="col-form-sublabel">Time</label>
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_time][0]" class="form-control timepicker ignore" placeholder="Time" id="route_slot01_stop01_time" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-7 pt-4 placeVaild">
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->nearest_airport))echo $editDataSet->nearest_airport;?>" data-rule-required="true" autocomplete="off">               
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->nearest_railway_station))echo $editDataSet->nearest_railway_station;?>" data-rule-required="true" autocomplete="off">
               
            </li>
            <li class="form-group col-12 col-md-12 placeVaild">
              <label class="col-form-sublabel">Location Covered</label>
              <input type="text" class="form-control ignore" name="itinerary_location_covered" placeholder="Location Covered" id="location_covered"  value="<?php if(isset($editDataSet->location_covered))echo $editDataSet->location_covered;?>" data-rule-required="true"/>
            </li>
          </ul>
              ...
              <div class="form-row">
                <div class="col-12 col-sm-4">
                  <div class="custom-control custom-checkbox custom-control-inline pt-3 pb-1">
                    <input type="checkbox" id="travellerType-private" name="itinerary_traveller_private" class="custom-control-input ignore" value="1" <?php if(isset($editDataSet->private_traveller)==1)echo 'checked';?> data-rule-required="true">
                ...
                <div class="col-6 col-sm-4 placeVaild">
                  ...
                  <input type="number" name="itinerary_traveller_private_minnumber" class="form-control ignore" placeholder="0" id="private_min_no_travllers" value="<?php if(isset($editDataSet->private_min_no_travellers))
					  echo $editDataSet->private_min_no_travellers;else{echo '1';}?>" data-rule-required="true" disabled/>
                </div>
                <div class="col-6 col-sm-4 placeVaild">
                  <label class="col-form-sublabel">Max. No. Travellers</label>
                  <input type="number" name="itinerary_traveller_private_maxnumber" class="form-control ignore" placeholder="0" id="private_max_no_travllers" value="<?php if(isset($editDataSet->private_max_no_travellers))
					  echo $editDataSet->private_max_no_travellers;?>" data-rule-required="true" disabled/>
                </div>
              </div>
            </li>
            <li class="form-group col-12 col-md-12 pt-2">
              <div class="form-row">
                <div class="col-12 col-sm-4">
                  <div class="custom-control custom-checkbox custom-control-inline pt-3 pb-1">
                    <input type="checkbox" id="travellerType-group" name="itinerary_traveller_group" class="custom-control-input ignore" value="1" <?php if(isset($editDataSet->group_traveller)==1)echo 'checked';?>>
                    <label class="custom-control-label font-weight-semibold" for="travellerType-group">Group</label>
                  </div>
                </div>
                <div class="col-6 col-sm-4 placeVaild">
                  <label class="col-form-sublabel">Min. No. Travellers</label>
                  <input type="number" class="form-control ignore" name="itinerary_traveller_group_minnumber" placeholder="0" id="group_min_no_travllers" value="<?php if(isset($editDataSet->group_min_no_travellers))
					  echo $editDataSet->group_min_no_travellers;else{echo '1';}?>" data-rule-required="true" disabled/>
                </div>
                <div class="col-6 col-sm-4 placeVaild">
                  <label class="col-form-sublabel">Max. No. Travellers</label>
                  <input type="number" class="form-control ignore" name="itinerary_traveller_group_maxnumber" placeholder="0" id="group_max_no_travllers" value="<?php if(isset($editDataSet->group_max_no_travellers))
					  echo $editDataSet->group_max_no_travellers;?>" data-rule-required="true" disabled/>
                </div>
              </div>
            </li>
			<?php
              ...
              <li class="form-group col-12 col-sm-6 mb-1  pt-2">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    ...
                    <input type="number" class="form-control ignore" name="itinerary_traveller_family_adult_minnumber" placeholder="0" min="1" id="adult_min_no" value="<?php echo isset($drafFamilyData[0]["family_adult_min_no"]) ? $drafFamilyData[0]["family_adult_min_no"] : ""; ?>" data-rule-required="true" disabled />
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Adult - Max. No.</label>
                    <input type="number" class="form-control ignore" name="itinerary_traveller_family_adult_maxnumber" placeholder="0" id="adult_max_no" value="<?php echo isset($drafFamilyData[0]["family_adult_max_no"]) ? $drafFamilyData[0]["family_adult_max_no"] : ""; ?>" data-rule-required="true" disabled />
                  </div>
                </div>
              </li>
             ...
             <li class="form-group col-12 col-sm-6 mb-1 pt-2">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Adult - Min. No.</label>
                    <input type="number" class="form-control ignore" name="itinerary_traveller_family_adult_minnumber" placeholder="0" min="1" id="adult_min_no" data-rule-required="true" value="1" disabled/>
                  </div>
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Adult - Max. No.</label>
                    <input type="number" class="form-control ignore" name="itinerary_traveller_family_adult_maxnumber" placeholder="0" id="adult_max_no" data-rule-required="true" disabled/>
                  </div>
                </div>
              </li>
             <li class="form-group col-12 col-sm-6 pt-2" data-id="kids-1">
                <div class="form-row">
                  <div class="col-12 col-sm-4  placeVaild">
                    <label class="col-form-sublabel">Kids (Age)</label>
                    <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                      <input id="travellerType-kids-below10" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore disabledDad keepCheck" value="10" data-rule-required="true" disabled />
                      <label class="custom-control-label" for="travellerType-kids-below10">Below 10</label>
                    </div>
                   </div>
                  <div class="col-6 col-sm-4 placeVaild">
		...
		<fieldset>
          ...
          <ul class="form-row">
            <li  data-rel="privateCheck"  class="form-group col-12 col-md-12 hidden ">
              <div class="form-row">
                ...
                <div class="col-12 col-sm-4 placeVaild">
                  ...
                  <input type="number" class="form-control ignore"  name="itinerary_traveller_private_price"  placeholder="0" id="itinerary_private_price" value="<?php if(isset($editDataSet->private_price))
					  echo $editDataSet->private_price;?>" data-rule-required="true"/>
                </div>
              </div>
            </li>
            <li  data-rel="groupCheck"  class="form-group col-12 col-md-12 hidden ">
              <div class="form-row">
                ...
                <div class="col-12 col-sm-4 placeVaild">
                  <label class="col-form-sublabel">Price</label>
                  <input type="number" class="form-control ignore" name="itinerary_traveller_group_price" placeholder="0" id="itinerary_group_price" value="<?php if(isset($editDataSet->group_price))echo $editDataSet->group_price;?>" data-rule-required="true"/>
                </div>
              </div>
            </li>
			<?php
         ...
         <?php
			$editDataSet_data = json_decode(json_encode($editDataSet), true);
			if(isset($editDataSet_data["additional_cost_description"]) && !empty($editDataSet_data["additional_cost_description"])) {
			$costData = json_decode($editDataSet_data["additional_cost_description"],true);
		...
		<div class="form-group col-12 col-sm-6 placeVaild">
		  ...
		  <input type="text" class="form-control ignore" name="itinerary_additionalcost_description[]" placeholder="Item description" id="additionalcost_desc" value="<?php echo $value["itinerary_additionalcost_description"]; ?>" data-rule-required="true"/>
		</div>
		<div class="form-group col-12 col-sm-6 placeVaild">
		  <label class="col-form-sublabel">Price</label>
		  <input type="number" class="form-control ignore" name="itinerary_additionalcost_amt[]" placeholder="Price" id="additionalcost_amt" value="<?php echo $value["additional_price"]; ?>" data-rule-required="true"/>
		</div>
		...
		<div class="form-group col-12 col-sm-6 placeVaild">
		  <label class="col-form-sublabel">Item</label>
		  <input type="text" class="form-control ignore" name="itinerary_additionalcost_description[]" placeholder="Item description" id="additionalcost_desc" value="<?php if(isset($editDataSet->additional_cost_description))
			   echo $editDataSet->additional_cost_description;?>" data-rule-required="true"/>
		</div>
		<div class="form-group col-12 col-sm-6 placeVaild">
		  <label class="col-form-sublabel">Price</label>
		  <input type="number" class="form-control ignore" name="itinerary_additionalcost_amt[]" placeholder="Price" id="additionalcost_amt" value="<?php if(isset($editDataSet->additional_price))echo $editDataSet->additional_price;?>" data-rule-required="true"/>
		</div>
		</li>
		<li class="text-right"> <a href="#" id="addItemLink" data-toggle="modal" data-target="#addItemsModal" class="text-uppercase font-weight-bold mb-2 pt-0">+ Add More</a> </li>
		</ul>
      ...
      <!--    <h3 id="fillConfirmation" class="col-form-label mt-2 mb-3">Confirmation & Review </h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              ...
              <div class="custom-control custom-radio custom-control-inline ml-3">
                <input type="radio" id="confirmationType-instant" name="itinerary-confirmationtype" value="instant" class="custom-control-input ignore" <?php echo @$editDataSet->confirmation_type=='instant'?'checked="checked"':'';?> data-rule-required="true">
                <label class="custom-control-label" for="confirmationType-instant">Instant</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline ml-3">
                <input type="radio" id="confirmationType-review" name="itinerary-confirmationtype" value="review" class="custom-control-input" <?php echo @$editDataSet->confirmation_type=='review'?'checked="checked"':'';?> >
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" placeholder="Type the message" name="itinerary_confirmationtype_msg" id="instant_conf_msg" data-rule-required="true"><?php if(isset($editDataSet->Instant_confirmation_message))echo $editDataSet->Instant_confirmation_message;?></textarea>
            </li>
          </ul>-->
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              ...
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="cancelByHostInput-yes" name="itinerary-cancellations-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->itinerary_cancelbyhost_agree==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="cancelByHostInput-no" name="itinerary-cancellations-agree" value="0" class="custom-control-input" <?php echo @$editDataSet->itinerary_cancelbyhost_agree==''?'':(@$editDataSet->itinerary_cancelbyhost_agree==0?'checked="checked"':'');?>>
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <p class="pt-1 pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras convallis consectetur convallis. Etiam imperdiet neque eget augue fermentum pulvinar. Phasellus nec aliquet risus, et elementum augue. Etiam in ultrices diam. Cras est ipsum, aliquet id diam ac, mollis ultricies velit. Fusce et consectetur urna. Pellentesque sit amet hendrerit diam, at finibus quam. Sed ullamcorper et metus et varius. Integer nibh metus, pulvinar id urna vel, ullamcorper vestibulum massa. Nunc tincidunt nunc id mauris fermentum interdum. Cras non ligula in tortor facilisis dignissim in vel purus.</p>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="cancelBytravellerInput-yes" name="itinerary-donetraveller-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->itinerary_cancelbytraveller_agree==1?'checked="checked"':'';?> />
                <label class="custom-control-label" for="cancelBytravellerInput-yes" data-rule-required="true"> I Agree</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="cancelBytravellerInput-no" name="itinerary-donetraveller-agree" value="0" class="custom-control-input" <?php echo @$editDataSet->itinerary_cancelbytraveller_agree==''?'':(@$editDataSet->itinerary_cancelbytraveller_agree==0?'checked="checked"':'');?>>
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <p class="pt-1 pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras convallis consectetur convallis. Etiam imperdiet neque eget augue fermentum pulvinar. Phasellus nec aliquet risus, et elementum augue. Etiam in ultrices diam. Cras est ipsum, aliquet id diam ac, mollis ultricies velit. Fusce et consectetur urna. Pellentesque sit amet hendrerit diam, at finibus quam. Sed ullamcorper et metus et varius. Integer nibh metus, pulvinar id urna vel, ullamcorper vestibulum massa. Nunc tincidunt nunc id mauris fermentum interdum. Cras non ligula in tortor facilisis dignissim in vel purus.</p>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="refundCheckInput-yes" name="itinerary-refund-agree" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->itinerary_refund_agree==1?'checked="checked"':'';?> data-rule-required="true"/>
                <label class="custom-control-label" for="refundCheckInput-yes"> I Agree</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="refundCheckInput-no" name="itinerary-refund-agree" value="0" class="custom-control-input" <?php echo @$editDataSet->itinerary_refund_agree==''?'':(@$editDataSet->itinerary_refund_agree==0?'checked="checked"':'');?> >
		...
		<fieldset>
          <h3 id="fillSponsor" class="col-form-label mt-2">Sponsor</h3>
          		  <small class="text-muted">*Required min. dimension 400 X 127px, size less than 5mb and format .jpg,.jpeg only</small>

          <ul class="form-row">
		  <?php $sponsorArr = '';
			 if(!empty($editDataSet->sponsors_img)){
				   $sponsorArr = explode(',',$editDataSet->sponsors_img);
				
			  foreach($sponsorArr as $images):	   
				  
			  ?>
            <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
      <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]" id="add_sponsor" accept="image/jpg, image/jpeg" data-height="127" data-width="400" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
              <input  id="add_sponsor_check" type="text" class="form-control lowKey ignore" name="itinerary_sponsor_hide_image_cover[]"  value="<?php if(@$images!='')echo $images;?>" data-rule-required="true"/>
			 ...
			 <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
      <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]" id="add_sponsor" accept="image/jpg, image/jpeg" data-height="127" data-width="400" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
              <input id="add_sponsor_check" type="text" class="form-control lowKey ignore" name="itinerary_sponsor_hide_image_cover[]" data-rule-required="true"/>
        ...
        <fieldset>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
			  ...
			  <input id="add_video_check" type="text" class="form-control lowKey ignore" name="hide_video" value="<?php if(isset($editDataSet->video))echo $editDataSet->video;?>" data-rule-required="true">
              <div class="dragImageBox-info" <?php if($editDataSet->video!='' && $editDataSet->video!=null) echo 'style="display:none"'; ?>>
              ...
              <div class="infoShow" <?php if($editDataSet->video!='' && $editDataSet->video!=null) echo 'style="display:block"';?>>
                <p class="text-primary"><?php if(isset($editDataSet->video))echo $editDataSet->video;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
          </ul> */ ?>
          ...
          <ul class="form-row no-gutters">
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Embed video 
                  <small>(*Paste in the entire EMBED code from the video's website)    </small> 
                </label>
                <textarea class="form-control ignore" name="itinerary_youtube_video" placeholder="Embed Video" id="itinerary_youtube_video" data-rule-required="true"><?php if(isset($editDataSet->youtube_video))echo $editDataSet->youtube_video;?></textarea>
            </li>
          </ul>
          <h3 id="fillImage" class="col-form-label mt-2">Image Gallery</h3>
          		  <small class="text-muted">*Required min. dimension 1440 X 810px, size less than 5mb and format .jpg,.jpeg only</small>

          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_cover" id="image_gallery" accept="image/jpg, image/jpeg" data-height="810" data-width="1440" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
			<input id="image_gallery_check" type="text" class="form-control lowKey ignore" name="hide_feature_img" value="<?php if(isset($editDataSet->feature_img))echo $editDataSet->feature_img;?>" data-rule-required="true" >
              <div class="dragImageBox-info" <?php if($editDataSet->feature_img!='' && $editDataSet->feature_img!=null) echo 'style="display:none"'; ?>>
                <div class="dragImageBox-icon">
				<img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" /></div>
                <p>Add a Feature Image</p>
                <span>Click here to upload image</span> </div>
              <div class="infoShow" <?php if($editDataSet->feature_img!='' && $editDataSet->feature_img!=null) echo 'style="display:block"'; ?>>
                <p class="text-primary"><?php if(isset($editDataSet->feature_img))echo $editDataSet->feature_img;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
          </ul>
          <h3 class="col-form-sublabel mt-2">Additional Images</h3>
          		  <small class="text-muted">*Required dimension 250 X 158px, size less than 5mb and format .jpg,.jpeg only</small>

          <ul class="form-row">
            <li class="form-group col-12 col-md-4 placeVaild">
              <label class="dragImageBox text-center">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_01" id="additional_image_1" accept="image/jpg, image/jpeg" data-height="158" data-width="250" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
			   <input id="additional_image_1_check" type="text" class="form-control lowKey ignore" name="hide_additional_img1" value="<?php if(isset($editDataSet->additional_img_1))echo $editDataSet->additional_img_1;?>" data-rule-required="true" >
              <div class="dragImageBox-info" <?php if($editDataSet->additional_img_1!='' && $editDataSet->additional_img_1!=null) echo 'style="display:none"'; ?>>
                <div class="dragImageBox-icon">
				<img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" /></div>
                <p>Add a Feature Image</p>
                <span>Click here to upload image</span> </div>
              <div class="infoShow" <?php if($editDataSet->additional_img_1!='' && $editDataSet->additional_img_1!=null) echo 'style="display:block"'; ?>>
                <p class="text-primary"><?php if(isset($editDataSet->additional_img_1))echo $editDataSet->additional_img_1;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
            <li class="form-group col-12 col-md-4 placeVaild">
              <label class="dragImageBox text-center">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_02" id="additional_image_2" accept="image/jpg, image/jpeg" data-height="158" data-width="250" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
			  <input id="additional_image_2_check" type="text" class="form-control lowKey ignore" name="hide_additional_img2" value="<?php if(isset($editDataSet->additional_img_2))echo $editDataSet->additional_img_2;?>" data-rule-required="true">
              <div class="dragImageBox-info" <?php if($editDataSet->additional_img_2!='' && $editDataSet->additional_img_2!=null) echo 'style="display:none"'; ?>>
                <div class="dragImageBox-icon">
				<img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" /></div>
                <p>Add a Feature Image</p>
                <span>Click here to upload image</span> </div>
              <div class="infoShow" <?php if($editDataSet->additional_img_2!='' && $editDataSet->additional_img_2!=null) echo 'style="display:block"'; ?>>
                <p class="text-primary"><?php if(isset($editDataSet->additional_img_2))echo $editDataSet->additional_img_2;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
            <li class="form-group col-12 col-md-4 placeVaild">
              <label class="dragImageBox text-center">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_03" id="additional_image_3" accept="image/jpg, image/jpeg" data-height="158" data-width="250" data-size="5120" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
			  <input id="additional_image_3_check" type="text" class="form-control lowKey ignore" name="hide_additional_img3" value="<?php if(isset($editDataSet->additional_img_3))echo $editDataSet->additional_img_3;?>"  data-rule-required="true" >
              <div class="dragImageBox-info" <?php if($editDataSet->additional_img_3!='' && $editDataSet->additional_img_3!=null) echo 'style="display:none"'; ?>>
                <div class="dragImageBox-icon"><img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" /></div>
                <p>Add a Feature Image</p>
                <span>Click here to upload image</span> </div>
              <div class="infoShow" <?php if($editDataSet->additional_img_3!='' && $editDataSet->additional_img_3!=null) echo 'style="display:block"'; ?>>
                <p class="text-primary"><?php if(isset($editDataSet->additional_img_3))echo $editDataSet->additional_img_3;?></p>
                <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a></div>
              </label>
            </li>
          </ul>
        ...
        <fieldset>
        <h3 id="fillLegalLiabilities" class="col-form-label mb-1">Code of Conduct <a href="javascript:void(0);"  data-ref="liability_diclaimer" class="text-primary read_popup small font-weight-bold ml-1">View Detail</a></h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="disclaimerCheckInput-yes" name="itinerary-disclaimer-agree" value="1" class="custom-control-input ignore" <?php if($editDataSet->itinerary_liabilitie_disclaimer==1) echo 'checked="checked"';?> data-rule-required="true"/>
                <label class="custom-control-label" for="disclaimerCheckInput-yes"> I Agree</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="disclaimerCheckInput-no" name="itinerary-disclaimer-agree" value="0" class="custom-control-input" <?php if($editDataSet->itinerary_liabilitie_disclaimer==''){echo '';}elseif($editDataSet->itinerary_liabilitie_disclaimer==0){echo 'checked="checked"';} ?> >
                <label class="custom-control-label" for="disclaimerCheckInput-no"> I Don't Agree</label>
              </div>
            </li>
          </ul>
          <h3 id="fillLegalPrivacy" class="col-form-label mb-1">Non Discrimination & Sexual Harassment Policy   <a href="javascript:void(0);" data-ref="privacy_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail</a></h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="privacyCheckInput-yes"  name="itinerary-privacy-agree" value="1" class="custom-control-input ignore" 
				<?php if($editDataSet->itinerary_privacy_policy==1) echo 'checked="checked"';?> data-rule-required="true"/>
                <label class="custom-control-label" for="privacyCheckInput-yes"> I Agree</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="privacyCheckInput-no" name="itinerary-privacy-agree" value="0" class="custom-control-input" <?php if($editDataSet->itinerary_privacy_policy==''){echo '';}elseif($editDataSet->itinerary_privacy_policy==0){echo 'checked="checked"';}?>/>
                <label class="custom-control-label" for="privacyCheckInput-no"> I Don't Agree</label>
              </div>
            </li>
          </ul>
          <h3 id="fillLegalTerms" class="col-form-label mb-1">Confidential Information, Safety of Guests, Picture & Social Media Policy <a href="javascript:void(0);" data-ref="term_condition" class="text-primary read_popup small font-weight-bold ml-1">View Detail</a></h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="termsCheckInput-yes" name="itinerary-terms-agree" value="1" class="custom-control-input ignore" 
				<?php if($editDataSet->itinerary_terms_condition==1) echo 'checked="checked"';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				<?php if($editDataSet->itinerary_terms_condition==''){echo '';}elseif($editDataSet->itinerary_terms_condition==0) echo 'checked="checked"';?>>
                <label class="custom-control-label" for="termsCheckInput-no"> I Don't Agree</label>
              </div>
            </li>
            </ul>
          <h3 id="fillLegalCancellations" class="col-form-label mb-1">Branding Merchandise & Identity Card Policy   <a href="javascript:void(0);" data-ref="done_host" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="cancelByHostInput-yes1" name="itinerary-cancelbyHost-agree-copy" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->last_doneby_host==1?'checked="checked"':''?> data-rule-required="true"/>
			 ...
			 class="custom-control-input" <?php echo @$editDataSet->last_doneby_host==''?'':(@$editDataSet->last_doneby_host==0?'checked="checked"':'');?>>
                <label class="custom-control-label" for="cancelByHostInput-no1"> I Don't Agree  </label>
              </div>
            </li>
            </ul>
    <h3  id="fillLegalItinerary"  class="col-form-label mb-1">Itinerary Policy  <a href="javascript:void(0);" data-ref="done_traveller" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>
  <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="cancelBytravellerInput-yes1" name="itinerary-cancelbytraveller-agree-copy" value="1" class="custom-control-input ignore" <?php echo @$editDataSet->last_doneby_traveller==1?'checked="checked"':''?> data-rule-required="true"/>
                <label class="custom-control-label" for="cancelBytravellerInput-yes1"> I Agree</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="cancelBytravellerInput-no1" name="itinerary-cancelbytraveller-agree-copy" value="0" class="custom-control-input" <?php echo @$editDataSet->last_doneby_traveller==''?'':(@$editDataSet->last_doneby_traveller==0?'checked="checked"':'');?>>
                <label class="custom-control-label" for="cancelBytravellerInput-no1"> I Don't Agree</label>
              </div>
            </li>
            </ul>

<h3  id="fillLegalShopping"  class="col-form-label mb-1">Policy on Shopping Activities  <a  href="javascript:void(0);"  data-ref="done_refund" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>
<ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="refundCheckInput-yes1" name="itinerary-refund-agree-copy" value="1" class="custom-control-input ignore" 
				<?php echo @$editDataSet->last_refund==1?'checked="checked"':''?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
                <input type="radio" id="refundCheckInput-no1" name="itinerary-refund-agree-copy" value="0"  
				 class="custom-control-input" <?php echo @$editDataSet->last_refund==''?'':(@$editDataSet->last_refund==0?'checked="checked"':'');?>>
                <label class="custom-control-label" for="refundCheckInput-no1"> I Don't Agree</label>
              </div>
            </li>
            </ul>
          <h3 id="fillLegalCopyright" class="col-form-label mb-1">Intellectual Property Policy     <a href="javascript:void(0);" data-ref="media_infri" class="text-primary read_popup small font-weight-bold ml-1">View Detail</a></h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="copyrightCheckInput-yes"  name="itinerary-copyright-agree" value="1" 
				class="custom-control-input ignore" <?php echo @$editDataSet->media_infringement==1?'checked="checked"':'';?> data-rule-required="true"/>
              ...
              <div class="custom-control custom-radio custom-control-inline valign">
				...
				class="custom-control-input" <?php echo @$editDataSet->media_infringement==''?'':(@$editDataSet->media_infringement==0?'checked="checked"':'');?>>
      ...
      <div class="modal-body">
        <ul class="pl-2 pr-2">
          <li class="form-group col-12 col-md-12">
            ...
            <input type="text" class="form-control" placeholder="Questions" name="itinerary_faq_question_01[]" id="add_newQues"/>
            <textarea class="form-control mt-4" placeholder="Answer (max 200 characters)" name="itinerary_faq_answer_01[]" id="add_newAns"></textarea>
          </li>
        </ul>
      </div>
...
<div class="modal fade" id="addStopModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <ul class="pl-2 pr-2">
          <li class="form-group col-12 col-md-12">
            ...
            <div class="form-row">
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Type a location</label>
                <input type="text" class="form-control" placeholder="Type a location" id="new_stop_location"/>
              </div>
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Time</label>
                <input type="text" class="form-control timepicker" placeholder="Time" id="new_stop_time"/>
              </div>
              <div class="col-12 pt-4">
                <textarea class="form-control" placeholder="Add a description" id="new_stop_desc"></textarea>
              </div>
            </div>
          </li>
        </ul>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="addOtherStop">Add</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="addSlotModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <ul class="form-row">
          <li class="form-group col-12 col-md-12">
            <div class="form-row">
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Pick-Up Point</label>
                <input type="text" class="form-control" placeholder="Pick-up Point" id="add_new_pickpoint" autocomplete="off" />
              </div>
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Start Time</label>
                <input type="text" class="form-control timepicker" placeholder="Time" id="add_new_starttime" autocomplete="off"/>
              </div>
            </div>
          </li>
          <li class="form-group col-12 col-md-12">
            <div class="form-row">
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Drop-Off Point</label>
                <input type="text" class="form-control" data-toggle="modal" data-target="#getMapModal" placeholder="Pick-up Point" id="add_new_dropoint" autocomplete="off" />
              </div>
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">End Time</label>
                <input type="text" class="form-control timepicker" placeholder="Time" id="add_new_endtime" autocomplete="off"/>
              </div>
            </div>
          </li>
          <li class="form-group col-12 col-md-12">
            <div class="form-row">
              <div class="col-12 col-sm-6">
                ...
                <input type="text" class="form-control" placeholder="Total Duration" id="add_new_totalduration"/>
              </div>
            </div>
          </li>
        </ul>
        <ul class="form-row">
          <li class="form-group col-12 col-md-12">
            ...
            <div class="form-row">
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Type a location</label>
                <input type="text" class="form-control" placeholder="Type a location" id="add_new_typelocation" autocomplete="off"/>
              </div>
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Time</label>
                <input type="text" class="form-control timepicker" placeholder="Time" id="add_new_locationtime" autocomplete="off"/>
              </div>
              <div class="col-12 pt-4">
                <textarea class="form-control" placeholder="Add a description" id="add_new_locdesc" ></textarea>
              </div>
            </div>
          </li>
        </ul>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="addNewSlot">Add</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="confirmationText">
          <p class="text-center">Are you sure that you want to cancel this itinerary?</p>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close</button>
...
$(window).on('load', function() {
        ...
        $('.profilePage-body input,.profilePage-body textarea,.profilePage-body select').attr('disabled', 'disabled');
        $('.profilePage-body a[href]').remove();
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"], input[type="hidden"]').removeAttr('disabled');
});
...
var validator = $("#formItinerary").validate({
    ...
    submitHandler: function() {
        $('#formItinerary').attr('action', 'doneItinerary');
...
$("#newStopForm").validate({
      ...
      $('#add_stopTime').val('12:00 AM');
          $('#add_stopTime').timeEntry({
              ampmPrefix: ' '
      });
			$("#newStopForm")[0].reset();
		      ...
		      if ((file = this.files[0])) {
		          ...
		          if ($(this).hasClass('imgInput')) {
		              ...
		              img.onload = function() {
		                  ...
		                  if (this.width > $width || this.height > $height || this.width < $width || this.height < $height || $imgKB > $size) {
		                      $this.val('');
		                      $boxinfo.show();
		                      $fileinfo.hide();
							  $nextInput.val('');
...
$('#cancleItinerary').on('click', function() {
    var returnFlag = '<?php echo $flag;?>';
    if (returnFlag == 1) {
        window.location.href = '<?php echo base_url();?>translator_reqitineraries';
    } else {
        window.location.href = '<?php echo base_url();?>translator_all_itineraries';
    }
...
$(document).on('click', '#callDone', function(e) {
    e.preventDefault();
    validator.destroy();
    $('#formItinerary').attr('action','translator_walkeditItinerary');
    $('.loadingWrap').show();
