 ...
 */
	Configure::write('Routing.prefixes', array('admin','gym'));
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyKfyDls2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309379153542496749683645');
...
define('HTTP_ROOT','http://'.$_SERVER['HTTP_HOST'].'/StudyWiki/');
