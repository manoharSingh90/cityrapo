...
<div class="soonWrap" style="display:<?php echo isset($display_status)?$display_status:''; ?>">
   <style>
.soonWrap { position: fixed; left: 0; top: 0; width: 100%; height: 100%; z-index: 999; background: url(assets/img/varanasi.png) no-repeat left center; background-size: cover; }
.soonBg { position: absolute; left: 0; top: 0; width: 100%; height: 100%; background: -moz-linear-gradient(-45deg, rgba(234,46,50,0.65) 0%, rgba(234,46,50,0.65) 40%, rgba(48,150,229,0.65) 100%); background: -webkit-linear-gradient(-45deg, rgba(234,46,50,0.65) 0%, rgba(234,46,50,0.65) 40%, rgba(48,150,229,0.65) 100%); background: linear-gradient(135deg, rgba(234,46,50,0.65) 0%, rgba(234,46,50,0.65) 40%, rgba(48,150,229,0.65) 100%); filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#a6ea2e32', endColorstr='#a63096e5', GradientType=1 );
}
.soonCenter { position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; flex-wrap: wrap; overflow: auto; }
.hiringBox { display: block; max-width: 435px; padding: 20px; }
.hiringBox a { display: block; }
.soonDiv { color: #fff; max-width: 550px; width: 100%; margin: 0 auto; z-index: 1; }
.soonText { text-align: left; padding: 35px; padding-bottom: 80px; border: 1px solid #fff; background: rgba(0,0,0,0.9) url(assets/img/watermark.png) no-repeat 98% bottom; background-size: contain; font-size: 13px; }
.soonText h1 { max-width: 280px; }
...
.soonForm form { border-bottom: 1px solid #eee; padding: 0 25px; padding-bottom: 1.25rem; }
.soonForm .form-group { margin-bottom: 0; }
.soonForm .form-row>.col, .soonForm .form-row>[class*=col-] {
padding-right: 10px;
padding-left: 10px;
}
...
.soonCenter { flex-wrap: nowrap; overflow: hidden;  }
.soonDiv { max-width: 420px; }
.hiringBox {max-width: 540px; padding: 20px 50px; padding-right: 20px; }
}
 @media only screen and (min-width: 1200px) {
.soonDiv { max-width: 420px; }
.hiringBox { max-width: 740px; padding: 20px 160px; padding-right: 20px; }
}
    </style>
  <div class="soonBg" data-start="background: linear-gradient(135deg, rgba(234,46,50,0.65) 0%, rgba(234,46,50,0.65) 40%, rgba(48,150,229,0.65) 100%);" data-end="background: linear-gradient(360deg, rgba(234,46,50,0.65) 0%, rgba(234,46,50,0.65) 40%, rgba(48,150,229,0.65) 100%);">
    <div class="soonCenter">
  <div class="hiringBox"> <a href="https://goo.gl/forms/DAclUvvL9fgGSYqi2" target="_blank"> <img src="<?php echo base_url();?>assets/img/hiring_varanasi.jpg" alt="hiring_varanasi"> </a> </div>
  <div class="soonDiv">
    <div class="soonText">
    ...
    <div class="soonForm">
      ...
      <?= form_open('home/visitor_login');?>
        ...
        <ul class="form-row">
              <li class="form-group col-12 col-sm-6 pb-3">
            ...
            <input type="password" class="form-control" placeholder="Password" name="visitor_pass" required/>
              ...
              <li class="col-12  col-sm-12  text-center">
            <!-- <button class="btn btn-primary" id="visitor_login">Login</button> -->
            <?= form_submit('mysubmit', 'Login',['class'=>'btn btn-primary']); ?>
          </li>
        </ul>
      </form>
      <p class="pt-3 pb-2 text-center text-light font-weight-semibold m-0 small">Host Registration is ongoing! 
        <a href="https://goo.gl/forms/DAclUvvL9fgGSYqi2" target="_blank" class="text-uppercase ml-1">Become a Host</a> </p>
    </div>
  </div>
	</div>
 </div> 
