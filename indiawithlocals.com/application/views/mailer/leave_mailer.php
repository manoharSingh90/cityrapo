    ...
    <td>
      <table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; background-image: url(<?= base_url('assets/mailer_img/bg.png')?>); background-repeat: no-repeat; background-position: right top;">
        ...
        <tr>
          ...
          <td colspan="4">
            <p style="color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Hi India with locals,</p>
            <br>
            <p style="color: #000; font-size: 22px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;"></p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="color: #000; font-size: 14px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial,'sans-serif'; margin: 0; padding: 0;">User Name :
            <strong style="color: #ee474c; text-transform: uppercase;">
              <?php echo $user_name?>    
            </strong><br>
            User Email Id :
            <strong style="color: #ee474c; text-transform: lowercase;">
              <?php echo $user_email?>    
            </strong><br>
            User Contact Number :
            <strong style="color: #ee474c; text-transform: uppercase;">
      ...
      <table cellpadding="0" cellspacing="0" style=" width:720px; margin: 0 auto; background: #f4f4f4; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif';">
        ...
        <tr>
          <!-- <td colspan="4"  style="color: #666; font-size: 12px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0; text-align: center;">This email is sent to Hosts and Admins of the IWL Portal<br>
            ...
            <a href="mailto:info@iwl.com" target="_blank" style="color: #3c8aca; text-decoration: none;">ask@iwl.help</a>  •  <a href="mailto:info@iwl.com" target="_blank" style="color: #3c8aca; text-decoration: none;">+91 729 197 2715</a></td> -->
        </tr>
        <tr>
          <td colspan="4" style="padding: 10px;"></td>
        </tr>
