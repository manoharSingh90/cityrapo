...
<main>
  <div class="legalPage">
    <div class="container">
      <h2 class="pageTilte">Policy</h2>
    </div>
    <div>
      <div class="container-fluid">
        <ul class="nav justify-content-center nav-tabs iwlTab" role="tablist">
          <li class="nav-item"> <a class="nav-link text-uppercase active" href="policies" >Privacy Policy</a> </li>
      ...
      <div class="container">
        <div class="tab-content iwlTab-content">
            ...
            <?php include('policies/policie.php');?>
          </div>
        </div>
      </div>
    </div>
