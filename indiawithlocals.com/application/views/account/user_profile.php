...
<div class="profilePage">
    <div class="profilePage-head clearfix">
      ...
      <div class="float-right">
       ...
       <button class="btn btn-link mr-3" id="save" value="Save" type="submit" formnovalidate name="save">Save</button>
       <button class="btn btn-primary" id="done" value="Done" type="submit"  name="done">Done</button>
...
<!-- Flash MSG--> 
          ...
          <fieldset id="filldetail">
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-6">
                ...
                <input type="text" class="form-control" id="first_name" required name="first_name" placeholder="First Name" value="<?php if($user_data->host_first_name == ''){}else{echo $user_data->host_first_name;}?>" autocomplete="off"/>
                
              </li>
              
              <li class="form-group col-12 col-md-6">
                <label class="col-form-sublabel">Last Name</label>
                <input type="text" class="form-control" id="last_name" required name="last_name" placeholder="Last Name" value="<?php if($user_data->host_last_name == ''){}else{echo $user_data->host_last_name;}?>" autocomplete="off"/>
              </li>
              <li class="form-group col-12 col-md-6">
                <label class="col-form-sublabel">Mobile</label>
                <input type="number" class="form-control" id="mobile_number" autocomplete="off" required name="mobile_number" placeholder="Mobile"  value="<?php if($user_data->host_mob_no == ''){}else{echo $user_data->host_mob_no;}?>" minlength ='10' maxlength ='14' />
              ...
              <li class="form-group col-12 col-md-6">
                ...
                <input type="email" class="form-control" id="email_id" name="email_id" placeholder="Email ID" readonly value="<?php if($user_data->host_email == ''){}else{echo $user_data->host_email;}?>" autocomplete="off"/>
              </li>
            </ul>
            <ul class="form-row pt-3">
              <li class="form-group col-12 col-md-6">
                ...
                <div class="custom-control custom-control-inline valign userImage">
                 ...
                 <input type="hidden" class="checkValue" name="profile_img" value="<?php if($user_data->profile_picture == ''){}else{echo $user_data->profile_picture;}?>" />
  ...
  C9.6,27.5,8,29,8.9,30.1L8.9,30.1z"/>
                ...
                <div class="custom-control custom-radio custom-control-inline valign">
                  <input type="radio" name="gender" id="maleRadioInput" class="custom-control-input" value="M"
                  <?php if($user_data->gender == ''){}else{ echo set_radio('gender', 'M', $user_data->gender == 'M');}?> required>
                  <span class="control-icon"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-6">
                ...
                <select class="form-control" name="nationality" id="nationality" required>
                  ...
                  <option  value="India" <?php if($user_data->nationality == ''){
}elseif($user_data->nationality == "India"){ echo 'selected="selected"'; } ?>>Indian</option>
                  <option  value="USA" <?php if($user_data->nationality == ''){
}elseif($user_data->nationality == "USA"){ echo 'selected="selected"'; } ?>>USA</option>
                  <option  value="UK" <?php if($user_data->nationality == ''){
}elseif($user_data->nationality == "UK"){ echo 'selected="selected"'; } ?>>UK</option>
                </select>
              </li>
              <li class="form-group col-12 col-md-6">
                <label class="col-form-label">DATE OF BIRTH</label>
                <input type="text" class="form-control"  name="date_of_birth" required id="date_of_birth" value="<?php if($user_data->date_of_birth == ''){}else{echo date('d-m-Y',strtotime($user_data->date_of_birth)) ;}?>" placeholder="DD/MM/YYYY"  readonly/>
              </li>
              <li class="form-group col-12 col-md-12">
                <label class="col-form-label">DESCRIPTION</label>
                <textarea class="form-control" onkeyup="countChar(this)" placeholder="Describe yourself (max 200 characters)" name="description" required id="description" ><?php if($user_data->description == ''){}else{echo $user_data->description ;}?></textarea>
          ...
          <fieldset id="fillresidence">
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-12">
                ...
                <input type="text" class="form-control" placeholder="Address Line 3"  name="per_address_3" value="<?php if($user_data->permanent_address_3 == ''){}else{echo $user_data->permanent_address_3 ;}?>" required autocomplete="off"/>
              </li>
              <li class="form-group col-12 col-md-6">
                ...
                <select class="form-control" name="state" id="state" required >
                  ...
                  <option value="<?php echo $states->id ;?>"<?php if($user_data->state == ''){}elseif($user_data->state == $states->id){ echo 'selected="selected"'; } ?>><?php echo $states->state_name ;?></option>
                  <?php } ?>
              ...
              <li class="form-group col-12 col-md-6">
                ...
                <select class="form-control" name="city" id="city" placeholder="select State" required>
                  ...
                  <option value="Bhopal"<?php if($user_data->city == ''){}elseif($user_data->city == "Bhopal"){ echo 'selected="selected"'; } ?>>Bhopal</option>
                  <option value="Chanderi"<?php if($user_data->city == ''){}elseif($user_data->city == "Chanderi"){ echo 'selected="selected"'; } ?>>Chanderi</option>
                  <option value="Gwalior"<?php if($user_data->city == ''){}elseif($user_data->city == "Gwalior"){ echo 'selected="selected"'; } ?>>Gwalior</option>
                  <option value="Gwalior"<?php if($user_data->city == ''){}elseif($user_data->city == "Gwalior"){ echo 'selected="selected"'; } ?>>Indore</option>
                   <option value="Jabalpur"<?php if($user_data->city == ''){}elseif($user_data->city == "Jabalpur"){ echo 'selected="selected"'; } ?>>Jabalpur</option>
                  <option value="Khajuraho"<?php if($user_data->city == ''){}elseif($user_data->city == "Khajuraho"){ echo 'selected="selected"'; } ?>>Khajuraho </option>
                  <option value="Orchha"<?php if($user_data->city == ''){}elseif($user_data->city == "Orchha"){ echo 'selected="selected"'; } ?>>Orchha</option>
                  <option value="Panna"<?php if($user_data->city == ''){}elseif($user_data->city == "Panna"){ echo 'selected="selected"'; } ?>>Panna </option>
                  <option value="Ujjain"<?php if($user_data->city == ''){}elseif($user_data->city == "Ujjain"){ echo 'selected="selected"'; } ?>>Ujjain </option>
                  <option value="Vidisha"<?php if($user_data->city == ''){}elseif($user_data->city == "Vidisha"){ echo 'selected="selected"'; } ?>>Vidisha </option> 
                </select>
              </li>
              <li class="form-group col-12 col-md-6">
                <label class="col-form-sublabel">Pin Code</label>
                <input type="number" class="form-control" placeholder="Pin Code" name="pin_code" id="pin_code" value="<?php if($user_data->pin_code == ''){}else{echo $user_data->pin_code ;}?>" required  minlength ='6' maxlength='6' autocomplete="off"/>
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-6">
                <label class="col-form-sublabel">Pin Code</label>
                <input type="number" class="form-control" placeholder="Pin Code" name="tmp_pin_code" id="tmp_pin_code" required  value="<?php if($user_data->tmp_pin_code == ''){}else{echo $user_data->tmp_pin_code ;}?>" minlength ='6' maxlength='6' autocomplete="off"/>
          ...
          <fieldset id="fillcompany">
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-6">
                ...
                <select class="form-control" name="company_state" required  id="company_state">
                   <option value="">Select</option>
                  <?php foreach($state as $states){?>
              ...
              <li class="form-group col-12 col-md-6">
                ...
                <select class="form-control" name="company_city" required  id="company_city">
                  <option value="">Select</option>
                  <option value="Bhopal"<?php if($user_data->city == ''){}elseif($user_data->city == "Bhopal"){ echo 'selected="selected"'; } ?>>Bhopal</option>
                  <option value="Chanderi"<?php if($user_data->city == ''){}elseif($user_data->city == "Chanderi"){ echo 'selected="selected"'; } ?>>Chanderi</option>
                  <option value="Gwalior"<?php if($user_data->city == ''){}elseif($user_data->city == "Gwalior"){ echo 'selected="selected"'; } ?>>Gwalior</option>
              ...
              <li class="form-group col-12 col-md-6">
                <label class="col-form-sublabel">Pin Code</label>
                <!-- <input type="number" class="form-control" placeholder="Pin Code" name="company_pin_code" id="company_pin_code" value="<?php if( $user_data->company_pin_code == ''){}else{echo $user_data->company_pin_code ;}?>" /> -->
                <input type="number" class="form-control" required  placeholder="Pin Code" autocomplete="off" name="company_pin_code" id="company_pin_code" value="<?php echo isset($user_data->company_pin_code) ? set_value("company_pin_code", $user_data->company_pin_code) : set_value("company_pin_code"); ?>" minlength ='6' maxlength='6'/>
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-12">
                <label class="col-form-sublabel">My Interset <small class="text-default font-italic">(e.g. racing, climbing)</small></label>
                    <input name="interest[]" required  id="interset" type="text" class="form-control" placeholder="Type an interest" value=""  />
              ...
              <li class="form-group col-12 col-md-12">
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  <input type="checkbox"  name="services_offered[]" id="walksRadioInput" class="custom-control-input" value="walks"<?php if(isset($service['walks'])){echo "checked";} ?> />
  ...
  c0.2-0.4,0.1-0.9-0.3-1.1C36.1,15.2,35.5,15.3,35.3,15.7z"/>
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  <input type="checkbox" name="services_offered[]" id="sessionsRadioInput" class="custom-control-input" value="Sessions"<?php if(isset($service['Sessions'])){echo "checked";} ?>>
                  <span class="control-icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  c0-3.8,0-7.7,0-11.5C30.6,8.4,28.7,8.4,28.7,9.6z"/>
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  <input type="checkbox" name="services_offered[]" id="experiencesRadioInput" class="custom-control-input" value="Experiences"<?php if(isset($service['Experiences'])){echo "checked";} ?>>
                  <span class="control-icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  c-2.3,0.3-2.3,4.2,0,4.5c1.5,0.2,3.1,0,4.6,0C29.8,5.6,29.8,3.8,28.6,3.8z"/>
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  <input type="checkbox" name="services_offered[]" id="meetRadioInput" class="custom-control-input" value="Meet - Ups"<?php if(isset($service['Meet - Ups'])){echo "checked";} ?>>
                  <span class="control-icon"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  c1.2,0.1,2.4,0,3.6,0c1.1,0,2.3,0.1,3.4-0.1C22.9,19.9,22.5,18.4,21.6,18.6z"/>
              ...
              <li class="form-group col-12 col-md-6 pt-2">
                ...
                <small class="text-muted  d-block">Select Cities <em>(Max 3)</em></small>
                  <input name="preferred_cities" id="preferred_cities" name="preferred_cities[]" type="text" class="form-control" placeholder="Select"  
                  value="" required  />
              </li>
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" value="Yes" id="yesCheckInput" name="host_before" class="custom-control-input" <?php if( $user_data->host_before == ''){}else{echo set_radio('host_before', 'Yes', $user_data->host_before == 'Yes');}?>/>
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6">
                    <label class="col-form-sublabel">Preferred Languages <em>(To communicate with IWL)</em></label>
                  </div>
              ...
              <li class="form-group col-12 col-md-12">
                ...
                <ul class="tagList">
                  <!-- <li class="selected">
                    <label class="tagBox">
                      <input type="checkbox" name="know_languages[]" value="English"<?php if(isset($known_langs['English'])){echo "checked";} ?> />
                      English</label>
                  </li>-->
                 ...
                 if(empty($result)){}else{
                  ...
                  <spam> <a href="#" class="text-uppercase " data-toggle="modal" data-target="#knownLanguagesModal">+Add More</a></spam>
                </ul>
              </li>
            </ul>
          </fieldset>
          <fieldset>
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-6">
                <p class="font-weight-semibold text-light d-inline-block mb-0">Swachh Bharat <a href="#" class="d-block text-uppercase text-primary font-weight-semibold">View as PDF</a></p>
                <div class="custom-control custom-checkbox custom-control-inline align-bottom ml-3">
                  <input type="checkbox" id="yesToClean" class="custom-control-input" checked="checked" />
                  <label class="custom-control-label" for="yesToClean">I agree</label>
              </div>
              </li>
              <li class="form-group col-12 col-md-6">
                <p class="font-weight-semibold text-light d-inline-block mb-0">Tourism <a href="#" class="d-block text-uppercase text-primary font-weight-semibold">View as PDF</a></p>
                <div class="custom-control custom-checkbox custom-control-inline align-bottom ml-3">
                  <input type="checkbox" id="yesToTravel" class="custom-control-input" checked="checked" />
                ...
                <div class="form-row">
                  ...
                  <div class="dragBox-info">  <?php  if($user_data->adhaar_number_doc == ''){ ?>
                   ...
                   <?php }else{ ?>
                      ...
                      <!-- <small class="text-muted">000 KB</small> --><a href="" class="text-light text-uppercase clearDargbox" id="removeAdhaar" onclick="removeAdhaar()">Remove</a></div>
                  <?php } ?>
                  </div>
                  </label>
                                    <input type="file" id="fileInput-adhaar" class="form-control uploadDoc fileInput" name="adhaar_num_doc"  />
    <input type="hidden" class="checkValue" name="adhaar_doc" value="<?php if($user_data->adhaar_number_doc == ''){}else{echo $user_data->adhaar_number_doc ;}?>" />
                                   <input type="checkbox" name="adhaarImg" class="vaildValue hideInput" required = 'required' >
                </div>
                </div>
              </li>
            </ul>
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6">
                    <label class="col-form-sublabel">Personal Account Number</label>
                    <input type="text" class="form-control" autocomplete="off" placeholder="Personal Account Number" name="pan_number" id="pan_number" required  value="<?php if( $user_data->pan_number == ''){}else{echo $user_data->pan_number ;}?>" />
                  </div>
                  <div class="col-12 col-sm-6 text-right">
      ...
      <input type="hidden" class="checkValue" name="pan_doc" value="<?php if($user_data->pan_number_doc == ''){}else{echo $user_data->pan_number_doc ;}?>" />
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder="Passport Number" name="passport_number" id="passport_number" value="<?php if( $user_data->passport_number == ''){}else{echo $user_data->passport_number ;}?>" required   />
                  </div>
                  <div class="col-12 col-sm-6 text-right">
         ...
         <input type="hidden" class="checkValue" name="passport_doc" value="<?php if($user_data->passport_number_doc == ''){}else{echo $user_data->passport_number_doc ;}?>" />
                                                <input type="checkbox" name="passportImg" class="vaildValue hideInput" required = 'required' >
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6">
                    ...
                    <input type="text" autocomplete="off" class="form-control" placeholder="License Guide Number" name="license_guide_number" id="license_guide_number" value="<?php if( $user_data->license_guide_number == ''){}else{echo $user_data->license_guide_number ;}?>" required  />
                  </div>
                  <div class="col-12 col-sm-6 text-right">
      ...
      <input type="hidden" class="checkValue" name="license_guide_doc" value="<?php if($user_data->license_guide_number_doc == ''){}else{echo $user_data->license_guide_number_doc ;}?>" />
                              ...
                              <input type="checkbox" name="licenseImg" class="vaildValue hideInput" required = 'required' >
                  </div>
                </div>
              </li>
            </ul>
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6">
                    ...
                    <input type="text" autocomplete="off" class="form-control" placeholder="GST Pin" name="gst_pin" id="gst_pin" value="<?php if( $user_data->gst_pin  == ''){}else{echo $user_data->gst_pin ;}?>"  />
                  </div>
                  <div class="col-12 col-sm-6 text-right">
...
<span style="display: none;">Drag file here or click to upload</span>
         ...
         <input type="hidden" class="checkValue" name="gst_doc" value="<?php if($user_data->gst_pin_doc ==''){}else{echo $user_data->gst_pin_doc ;}?>" />
                              ...
                              <input type="checkbox" name="gstImg" class="vaildValue hideInput" required = 'required' >
                  </div>
                </div>
              </li>
            </ul>
...
//   //state_ids = $('#company_state option:selected').val();
...
// function loadCompnyCity(state_ids){
 
//  var proceed = true;
//  if(state_ids=='' || state_ids==null){
//    proceed = false;
//  }
//  if(proceed){
...
var msCites = $('#preferred_cities').magicSuggest({
   placeholder: 'Select',
     ...
     allowFreeEntries: false,
      maxSelection: 3,
   data: ['Delhi  ', 'Mumbai','Madhya Pradesh','Bangalore', 'Hyderabad', 'Chennai', 'Ahmedabad', 'Kolkata', 'Surat']
});
