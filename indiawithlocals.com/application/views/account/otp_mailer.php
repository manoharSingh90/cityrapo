  ...
  <tr>
    <td>
      <table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; background-image: url(mailer_img/bg.png); background-repeat: no-repeat; background-position: right top;">
        ...
        <tr>
          <td colspan="4"><img src="mailer_img/header.png" alt="india with locals" style="display: block; border: none; max-width: 100%;"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="color: #000; font-size: 14px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Thank you for registering with India With Locals. Your OTP is:<br/>
            <strong style="color: #ee474c; text-transform: uppercase;"><?php echo $value ;?></strong></td>
          <td style="width: 30px;"></td>
        </tr>
        <tr>
          <td colspan="4" style="padding: 10px;"></td>
      ...
      <table cellpadding="0" cellspacing="0" style=" width:720px; margin: 0 auto; background: #f4f4f4; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif';">
        ...
        <tr>
          <td colspan="4"  style="color: #666; font-size: 12px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0; text-align: center;">This email is sent to Hosts and Admins of the IWL Portal<br>
            ...
            <a href="mailto:info@iwl.com" target="_blank" style="color: #3c8aca; text-decoration: none;">info@iwl.com</a>  •  <a href="mailto:info@iwl.com" target="_blank" style="color: #3c8aca; text-decoration: none;">729 197 2715</a></td>
        </tr>
        <tr>
          <td colspan="4" style="padding: 10px;"></td>
        </tr>
