...
*/
  ...
  endDate: new Date(),
    ...
    $('.addmore').on('click', function() {
        ...
        //alert(newLang);
        if (newLang != '') {
            $('#knownLangTags').before('<li><label class="tagBox active text-capitalize"><input type="checkbox" checked name="know_languages[]" value="' + newLang + '" />' + newLang + '</label></li>');
        }
