...
<table cellpadding="0" cellspacing="0" style="width:100%; margin: 0 auto; border: none; border-collapse: collapse; color: #888; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
  <tr>
    <td><table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #888; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif; line-height:1.75;">Thank you for registering with City Explorers,<br/>
            Please complete your sign up using the OTP given below - </td>
          <td width="30"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #555; font-size: 16px; font-family:Arial, Helvetica, sans-serif;"><strong>OTP: <span style="color:#3d8ac9;"><?php echo $value;?></span> </strong></td>
          <td width="30"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #aaa; font-size: 12px; font-family:Arial, Helvetica, sans-serif;"><em>The OTP is only valid for 24 hours, after which you will need register again.</em></td>
          <td width="30"></td>
        </tr>
        <tr>
          <td colspan="3" height="25"></td>
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">Please enter/copy this OTP on the sign up page.</td>
          <td width="30"></td>
        </tr>
        <tr>
          <td colspan="3" height="30"></td>
