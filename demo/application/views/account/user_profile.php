...
<!-- Flash MSG--> 
		  ...
		  <ul class="form-row">
             <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <input type="text" class="form-control" id="display_name" name="display_name" placeholder="Display Name" maxlength="20" value="<?php if(isset($user_data->display_name)){echo $user_data->display_name;}?>" autocomplete="off" required />
              </li>      
            </ul>
