...
<table cellpadding="0" cellspacing="0" style="width:100%; margin: 0 auto; border: none; border-collapse: collapse; color: #888; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
  <tr>
    <td><table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #888; font-size: 16px; font-family:Arial, Helvetica, sans-serif;">
        ...
        <tr>
          <td width="30"></td>
          <td width="660"><strong style="color: #282828; font-size: 15px; font-family:Arial, Helvetica, sans-serif; text-transform:uppercase;">Welcome to CityExplorers</strong></td>
          <td width="30"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif; line-height:1.75;">Thank you for registering with City Explorers. </td>
          <td width="30"></td>
        </tr>
        <tr>
          <td width="30"></td>
          <td width="660" style="color: #888; font-size: 14px; font-family:Arial, Helvetica, sans-serif;">Once your request will be accepted, You will receive a confirmation email with password to create your profile. </td>
          <td width="30"></td>
        </tr>
        <tr>
          <td colspan="3" height="30"></td>
