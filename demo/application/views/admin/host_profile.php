...
<div class="profilePage">
    <div class="profilePage-head clearfix">
      ...
      <div class="float-right floatBtn">
       <a href="<?= base_url('request');?>" class="btn btn-link text-default mr-2">Skip</a>
       <button class="btn btn-primary" id="doneProfile" type="button"  name="done">Done</button>      
     </div>
    </div>
...
<!-- Flash MSG--> 
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <div class="custom-control custom-control-inline valign userImage">
                  <label class="control-icon userImagelabel" for="userimageInput">
                    <img id="userProfileImage" class="userImageCenter" src="#" alt="user image" /></label>				
                  <!--<a href="" id="remove_pic" onclick="removePic()" class="text-uppercase userImageClear">Remove</a>-->
                </div>    
                <small class="text-muted d-block">*Required min. dimension  300 X 300px, size less than 5mb and format .jpg,.jpeg only</small>
        ...
        <input type="hidden" class="checkValue" name="profile_img" id="removeProfilepic" />
         <input type="checkbox" name="profileImg" class="vaildValue hideInput" required='required' >
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <label>
                  <input type="radio" name="gender" id="femaleRadioInput" class="custom-control-input" value="F" required/>
  ...
  C9.6,27.5,8,29,8.9,30.1L8.9,30.1z"/>
                ...
                <div class="custom-control custom-radio custom-control-inline valign">
                  ...
                  <input type="radio" name="gender" id="maleRadioInput" class="custom-control-input" value="M" required>
                  <span class="control-icon"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  C8,24.2,9.6,22.6,8.6,21.6L8.6,21.6z"/>
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <input type="text" class="form-control"  name="date_of_birth" required id="date_of_birth"  placeholder="DD/MM/YYYY"  readonly/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-label">DESCRIPTION</label>
                <textarea class="form-control" placeholder="Describe yourself (max 2000 characters)" data-rule-maxlength="2000" name="description" required id="description"></textarea>
                <!-- <small class="text-muted">Total characters left: <span id="charNum">200</span> characters. </small>-->
              </li>
            </ul>
          </fieldset>
          <?php if($user_data->i_am=='individual'){ ?>
          <fieldset id="fillresidence">
            ...
            <ul class="form-row">
              <li class="form-group col-12 placeVaild">
                ...
                <input type="text" class="form-control" placeholder="Address Line 1" name="per_address_1"  required autocomplete="off"/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Address Line 2</label>
                <input type="text" class="form-control" placeholder="Address Line 2"  name="per_address_2" required autocomplete="off"/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Address Line 3</label>
                <input type="text" class="form-control" placeholder="Address Line 3"  name="per_address_3" autocomplete="off"/>
              </li>
              <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <input type="text" class="form-control pin_codes" placeholder="Pin Code" name="pin_code" id="pin_code"  required  minlength ='6' maxlength='6' autocomplete="off"/>
            ...
            <ul class="form-row">
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Address Line 1</label>
                <input type="text" class="form-control" placeholder="Address Line 1" name="tmp_address_1" id="tmp_address_1"  autocomplete="off"/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Address Line 2</label>
                <input type="text" class="form-control" placeholder="Address Line 2" name="tmp_address_2" id="tmp_address_2"  autocomplete="off"/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Address Line 3</label>
                <input type="text" class="form-control"  placeholder="Address Line 3" name="tmp_address_3" id="tmp_address_3"  autocomplete="off"/>
              </li>
              <li class="form-group col-12 col-md-6 placeVaild">
                <label class="col-form-sublabel">State</label>
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                <label class="col-form-sublabel">Pin Code</label>
                <input type="text" class="form-control pin_codes" placeholder="Pin Code" name="tmp_pin_code" id="tmp_pin_code"  autocomplete="off" minlength ='6' maxlength='6' />
          ...
          <fieldset id="fillcompany">
            ...
            <ul class="form-row">
              <li class="form-group col-12 placeVaild">
                ...
                <input type="text" class="form-control" placeholder="Associated Companies" required   name="associated_companies" id="associated_companies" autocomplete="off" />
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Company Name</label>
                <input type="text" class="form-control" placeholder="Company Name" required  name="company_name" id="company_name"  autocomplete="off"/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Company Address Line 1</label>
                <input type="text" class="form-control" placeholder="Company Address Line 1" required  name="company_address_1" id="company_address_1" autocomplete="off"/>
              </li>
              <li class="form-group col-12 placeVaild">
                <label class="col-form-sublabel">Company Address Line 2</label>
                <input type="text" class="form-control" placeholder="Company Address Line 2" required  name="company_address_2" id="company_address_2" autocomplete="off"/>
              </li>
              <li class="form-group col-12 col-md-6 placeVaild">
                <label class="col-form-sublabel">State</label>
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                <label class="col-form-sublabel">Pin Code</label>               
                <input type="text" class="form-control pin_codes" required  placeholder="Pin Code" autocomplete="off" name="company_pin_code" id="company_pin_code"  minlength ='6' maxlength='6' />
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 placeVaild">
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  <label>
                  <input type="checkbox"  name="services_offered[]" required id="walksRadioInput" class="custom-control-input" value="Walk" />
  ...
  c0.2-0.4,0.1-0.9-0.3-1.1C36.1,15.2,35.5,15.3,35.3,15.7z"/>
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  ...
                  <input type="checkbox" name="services_offered[]" id="sessionsRadioInput" class="custom-control-input" value="Session">
                  <span class="control-icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  c0-3.8,0-7.7,0-11.5C30.6,8.4,28.7,8.4,28.7,9.6z"/>
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  ...
                  <input type="checkbox" name="services_offered[]" id="experiencesRadioInput" class="custom-control-input" value="Experience">
                  <span class="control-icon"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  c-2.3,0.3-2.3,4.2,0,4.5c1.5,0.2,3.1,0,4.6,0C29.8,5.6,29.8,3.8,28.6,3.8z"/>
                ...
                <div class="custom-control custom-checkbox custom-control-inline valign">
                  ...
                  <input type="checkbox" name="services_offered[]" id="meetRadioInput" class="custom-control-input" value="Meet-Up">
                  <span class="control-icon"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  c1.2,0.1,2.4,0,3.6,0c1.1,0,2.3,0.1,3.4-0.1C22.9,19.9,22.5,18.4,21.6,18.6z"/>
              ...
              <li class="form-group col-12 col-md-6 pt-2 placeVaild">
                ...
                <small class="text-muted  d-block">Select Cities <em></em></small>
                ...
                <div class="form-row">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" value="Yes" id="yesCheckInput" name="host_before" class="custom-control-input" required />
                      <label class="custom-control-label" for="yesCheckInput">Yes</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline valign">
                      <input type="radio" id="noCheckInput" name="host_before" class="custom-control-input" value="No" >
                      <label class="custom-control-label" for="noCheckInput">No</label>
                    </div>
					
					<div class="form-group placeVaild host_before_text hidden">
					<label class="col-form-label">Note</label>
					<textarea class="form-control" placeholder="Write here (max 2000 characters)" data-rule-maxlength="2000" name="host_before_desc" required="" id="host_before_desc"></textarea>               
                  </div>	
              ...
              <li class="form-group col-12 placeVaild">
				...
				if(!empty($known_langs)){
					foreach($known_langs as $lang):	
						?>
					<li class="selected">
                      <label class="tagBox active text-capitalize">
            ...
            <ul class="form-row">
              <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <div class="custom-control custom-checkbox custom-control-inline align-bottom ml-3">
                  <input type="checkbox" id="yesToClean" class="custom-control-input"  name="swachh_bharat" value="1" required/>
              ...
              <li class="form-group col-12 col-md-6 placeVaild">
                ...
                <div class="custom-control custom-checkbox custom-control-inline align-bottom ml-3">
                  <input type="checkbox" id="yesToTravel" class="custom-control-input" name="tourism" value="1" required />
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6 placeVaild">
                    ...
                    <input type="text" class="form-control" placeholder="Adhaar Number" autocomplete="off" name="adhaar_number" id="adhaar_number" required />
                  </div>
                  <div class="col-12 col-sm-6 text-right placeVaild">
                  <label class="dragBox text-left" for="fileInput-adhaar">
                  <div class="dragBox-icon"><img src="<?php echo base_url("assets/img/icon/file.svg"); ?>" alt="file" /></div>
                  <div class="dragBox-info">  
                    <span>Click here to upload image</span>
                     <div class="infoShow">
                      <p class="text-primary">File Name</p>
                      <small class="text-muted">000 KB</small><a href="#" class="text-light text-uppercase clearDargbox">Remove</a>
					  </div>                   
                  </div>
                  </label>
                 <input type="file" id="fileInput-adhaar" class="form-control uploadDoc fileInput" name="adhaar_num_doc"  />
				<input type="hidden" class="checkValue" name="adhaar_doc"  id="removeAdhar"/>
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6 placeVaild">
                    ...
                    <input type="text" class="form-control text-uppercase" autocomplete="off" placeholder="Permanent Account Number" name="pan_number" id="pan_number" required />
                  </div>
                  <div class="col-12 col-sm-6 text-right placeVaild">
                ...
                <input type="file" id="fileInput-pan" class="form-control uploadDoc fileInput" name="pan_num_doc" />
               <input type="hidden" class="checkValue" name="pan_doc"  id="removepancard"/>
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6 placeVaild">
                    ...
                    <input type="text" class="form-control text-uppercase" autocomplete="off" placeholder="Passport Number" name="passport_number" id="passport_number" />
                  </div>
                  <div class="col-12 col-sm-6 text-right placeVaild">
                ...
                <input id="fileInput-passport" type="file" class="form-control uploadDoc fileInput"  name="passport_num_doc" />
               <input type="hidden" class="checkValue" name="passport_doc" />
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6 placeVaild">
                    ...
                    <input type="text" autocomplete="off" class="form-control" placeholder="License Guide Number" name="license_guide_number" id="license_guide_number" />
                  </div>
                  <div class="col-12 col-sm-6 text-right placeVaild">
                 ...
                 <input type="file" id="fileInput-license" class="form-control uploadDoc fileInput" name="license_guide_num_doc" />
                 <input type="hidden" class="checkValue" name="license_guide_doc" />
              ...
              <li class="form-group col-12 col-md-12">
                <div class="form-row">
                  <div class="col-12 col-sm-6 placeVaild">
                    ...
                    <input type="text" autocomplete="off" class="form-control text-uppercase" placeholder="GST Pin" name="gst_pin" id="gst_pin"  />
                  </div>
                  <div class="col-12 col-sm-6 text-right placeVaild">
               ...
               <input type="file" id="fileInput-gst" class="form-control uploadDoc fileInput" name="gst_pin_doc" />
              <input type="hidden" class="checkValue" name="gst_doc" />
              <input type="checkbox" name="gstImg" class="vaildValue hideInput" >
               </div>
               </div>			  
             </li>
         ...
         <?php if($user_data->i_am!=='company'){?>
		  <fieldset>
            ...
            <ul class="form-row">
              <li class="form-group col-12 placeVaild">
                  <div class="custom-control custom-checkbox custom-control-inline titleCheck">
                <input type="checkbox" name="term_condition" value="1" id="term_policy" class="custom-control-input" required />
		 ...
		 <?php }else{ ?>
            ...
            <ul class="form-row">
              <li class="form-group col-12 placeVaild">
                  <div class="custom-control custom-checkbox custom-control-inline titleCheck">
                <input type="checkbox" name="noc_certificate" value="1" id="noc_certificate" class="custom-control-input" required />
...
$("#doneProfile").click(function() {
		$('#profile_form').attr('action', 'host_profile_done');
		$('.loadingWrap').show();
