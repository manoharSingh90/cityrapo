  ...
  <ul>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="itineraryUrl" id="itineraryUrl" value="<?php echo base_url().'walk/'.base64_encode($itineraryId).'/'.$serviceId.'/'.$otherlang.'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->origin_city)).'/'.preg_replace('/\s+/', '', str_replace("'",'',$editDataSet->itinerary_title));?>"/>
        ...
        <h3 id="fillDetails" class="col-form-label">Details</h3>
          <ul class="form-row no-gutters">
		   <li class="form-group col-12 col-md-6 placeVaild">
			...
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-12 placeVaild">
              <label class="col-form-label text-light text-capitalize">Description (<?php echo $otherlang;?>)</label>
	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 1000 characters)" id="itinerary_inclusions" data-rule-required="true" data-rule-maxlength="1000"><?php if(isset($editDataSet->itinerary_inclusions))echo $editDataSet->itinerary_inclusions;?></textarea>
            </li>
            <li class="form-group col-12 placeVaild">
              <label class="col-form-sublabel">Exclusions</label>
              <textarea class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 1000 characters)" id="itinerary_exclusions" data-rule-required="true" data-rule-maxlength="1000"><?php if(isset($editDataSet->itinerary_exclusions))echo $editDataSet->itinerary_exclusions;?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" id="itinerary_splmention" data-rule-required="false" data-rule-maxlength="1500"><?php if(isset($editDataSet->itinerary_spl_mention))echo $editDataSet->itinerary_spl_mention;?></textarea>
            </li>
          </ul>
		  ...
		  <?php
            ...
            <li class="form-group col-12 placeVaild">
			  ...
			  <div class="placeVaild"> <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 1000 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="1000"><?php echo $faqs->itinerary_faq_answer;?></textarea>			 
               </div>
  ...
  <fieldset> 
          ...
          <ul class="form-row">
            ...
            <li class="form-group col-12 col-md-12">
              ...
              <div class="form-row slotClass">
                ...
                <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
                  ...
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_time][<?php echo $key; ?>]" class="form-control timepicker ignore" placeholder="Time" id="route_slot01_stop01_time" value="<?php echo ($stopsData->stop_location_time?$stopsData->stop_location_time:'12:00 AM');?>" data-rule-required="true" autocomplete="off"/>
                </div>
            ...
            <li class="form-group col-12 col-md-12">
              ...
              <div class="form-row slotClass">
                ...
                <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
                  <label class="col-form-sublabel">Time</label>
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_time][0]" class="form-control timepicker ignore" placeholder="Time" id="route_slot01_stop01_time"  value="12:00 AM" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-7 pt-4 placeVaild">
		...
		<fieldset>
          <h3 id="fillSponsor" class="col-form-label mt-2">Sponsor</h3>
          		  <small class="text-muted">*Required min. dimension 400 X 127px, size less than 10mb and format .jpg,.jpeg only</small>
        ...
        <fieldset> <?php /*
          ...
          <ul class="form-row no-gutters">
              <li class="form-group col-12 placeVaild">
                ...
                <textarea class="form-control ignore" name="itinerary_youtube_video" placeholder="Embed Video" id="itinerary_youtube_video" data-rule-required="false"><?php if(isset($editDataSet->youtube_video))echo $editDataSet->youtube_video;?></textarea>
            </li>
          </ul>
          <h3 id="fillImage" class="col-form-label mt-2">Image Gallery</h3>
          		  <small class="text-muted">*Required min. dimension 1440 X 810px, size less than 10mb and format .jpg,.jpeg only</small>
      ...
      <div class="modal-body">
        <ul class="pl-2 pr-2">
          <li class="form-group col-12 col-md-12">
            ...
            <textarea class="form-control mt-4" placeholder="Answer (max 1000 characters)" name="itinerary_faq_answer_01[]" id="add_newAns" data-rule-maxlength="1000" required ></textarea>
          </li>
        </ul>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close</button>
        <button type="submit" id="addQuestion" class="btn btn-primary">Add</button>
      </div>
	 </form> 
    </div>
  </div>
        ...
        <ul class="form-row">
          <li class="form-group col-12 col-md-12">
            <div class="form-row routeClass">
              ...
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Start Time</label>
                <input type="text" class="form-control timepicker ignore" name="itinerary_route_slot01_pickup_time[]" placeholder="Time" id="add_new_starttime"  value="12:00 AM" required autocomplete="off"/>
              </div>
          ...
          <li class="form-group col-12 col-md-12">
            <div class="form-row">
              ...
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">End Time</label>
                <input type="text" class="form-control timepicker ignore" name="itinerary_route_slot01_dropoff_time[]" placeholder="Time" id="add_new_endtime"  value="12:00 AM" required autocomplete="off"/>
              </div>
        ...
        <ul class="form-row">
          <li class="form-group col-12 col-md-12">
            ...
            <div class="form-row">
              ...
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Time</label>
                <input type="text" class="form-control timepicker ignore" name="route[0][itinerary_route_slot01_stop01_time][0]" placeholder="Time"  id="add_new_locationtime"	value="12:00 AM" required autocomplete="off"/>
              </div>
              <div class="col-12 pt-4">
...
$(document).on('click', '#callDone', function(e) {
    ...
    validator.destroy();
    $('#formItinerary').attr('action','admin_editItinerary');
    $('.loadingWrap').show();
