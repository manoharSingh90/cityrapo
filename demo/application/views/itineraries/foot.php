...
<script type="text/javascript" src="<?= base_url('assets/dependencies/magicsuggest-master/magicsuggest-min.js')?>"></script> 
<script type="text/javascript" src="<?= base_url('assets/dependencies/select2-develop/dist/js/select2.full.min.js')?>"></script> 
<script type="text/javascript" src="<?php echo base_url();?>assets/dependencies/jquery.timeentry/jquery.plugin.min.js"></script> 
<script type="text/javascript" src="<?php echo base_url();?>assets/dependencies/jquery.timeentry/jquery.timeentry.min.js"></script> 
<script type="text/javascript" src="<?= base_url('assets/dependencies/jQuery-Mask-Plugin-master/dist/jquery.mask.min.js')?>"></script> 
<!--<script type="text/javascript" src="<?= base_url('assets/dependencies/DTimepicker-master/timepicker.js')?>"></script> -->
...
<!--<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&libraries=places&.js"></script>-->  
...
<script type="text/javascript" src="<?php echo base_url();?>assets/dependencies/sticky-kit-master/dist/sticky-kit.min.js"></script> 
...
<script type="text/javascript" src="<?php echo base_url();?>assets/dependencies/bootstrap-datepicker-master/dist/js/bootstrap-datepicker.min.js"></script> 
