        ...
        <fieldset id="filldetail">
          ...
          <ul class="form-row no-gutters">
            ...
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <select class="form-control" name="originCity" id="originCity" required data-rule-required="true">
                ...
                <?php 
				  ...
				  ?>
                <!-- <option value="<?php //echo $city->id;?>" <?php //if($editDataSet->origin_city==$city->id)echo 'selected';?>><?php //echo $city->city_name;?></option>-->
            ...
            <li class="form-group col-12 col-md-12 placeVaild">
              ...
              <textarea class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 2000 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="2000"><?php if(isset($editDataSet->other_itinerary_description))echo trim($editDataSet->other_itinerary_description);?></textarea>
            </li>
            <?php } ?>
            <li class="form-group col-12 col-md-12 placeVaild">
	...
	c-0.1-0.2-1.9,0-2.1,0c-0.6,0-1.4,0.2-2,0c-0.6-0.2-0.5-0.8-0.3-1.3C6.8,31.8,5.4,31.5,5.1,32.3L5.1,32.3z"/>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" id="itinerary_splmention" data-rule-required="false" data-rule-maxlength="1500"><?php if(isset($editDataSet->itinerary_spl_mention))echo trim($editDataSet->itinerary_spl_mention);?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row no-gutters mb-4">
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <div class="placeVaild">
                <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 1000 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="1000"><?php echo trim($faqs->itinerary_faq_answer);?></textarea>
              </div>
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
              ...
              <input type="number" name="itinerary_host_emergency" class="form-control ignore" placeholder="Mobile Number" id="host_emergency_no" 
			   value="<?php if(isset($editDataSet->host_emergency_contact_num))echo $editDataSet->host_emergency_contact_num;?>" data-rule-required="true" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
            </li>
          </ul>
       </fieldset>
      <fieldset>
    ...
    <div class="col-6 placeVaild">
     ...
     <fieldset>          
          ...
          <ul class="form-row">
            ...
            <li class="form-group col-12 col-md-12">
              ...
              <div class="form-row slotClass">
                ...
                <div class="col-12 col-sm-7 pt-4 placeVaild">
                  <textarea class="form-control ignore" name="route[0][itinerary_route_slot01_stop01_description][<?php echo $key; ?>]" placeholder="Add a description" id="route_slot01_stop01_description" data-rule-required="true"><?php echo trim($stopsData->stop_location_desc);?></textarea>
                </div>
              </div>
            ...
            <li class="form-group col-12 col-md-12">
              ...
              <div class="form-row slotClass">
                ...
                <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
                  <label class="col-form-sublabel">Time</label>
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_time][0]" class="form-control timepicker ignore" placeholder="Time"  value="12:00 AM" id="route_slot01_stop01_time" data-rule-required="true" autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-7 pt-4 placeVaild">
        ...
        <fieldset>
          ...
          <?php
		$editDataSet = json_decode(json_encode($editDataSet), true);
		if(isset($editDataSet["additional_cost_description"]) && !empty($editDataSet["additional_cost_description"])) {
		$costData = json_decode($editDataSet["additional_cost_description"],true);
		...
		<?php } ?>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
			  ...
			  <?php //echo '<pre>';print_r($editDataSet['confirmation_type']);?>
            ...
            <li class="form-group col-12 placeVaild">
              ...
              <textarea class="form-control ignore" placeholder="Type the message" name="itinerary_confirmationtype_msg" id="instant_conf_msg" data-rule-required="true"><?php //if(isset($editDataSet['Instant_confirmation_message']))echo $editDataSet['Instant_confirmation_message'];?>
       </textarea>
            </li>
          </ul>-->		  
...
<ul class="form-row">
      ...
      <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]" id="add_sponsor" accept="image/jpg, image/jpeg" data-height="127" data-width="400" data-size="10240" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
			  ...
			  <?php if($key>0){echo '<a href="javascript:void(0);" class="text-light text-uppercase clearSponsor">Remove</a>';}			   
				  ?>
            </li>
			  <?php endforeach;}else{?>
			 <li class="form-group col-12 placeVaild">
			...
			<?php } ?>
			 <?php 
				 if(count($sponsorArr)<2){
				   ...
				   //echo '<a href="javascript:void(0);" class="text-light text-uppercase clearSponsor">Remove</a>';  
					 }
				 ?> 
          </ul>
        </fieldset>
        <fieldset>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
			  ...
			  <input id="add_video_check" type="text" class="form-control lowKey ignore" name="hide_video" value="<?php if(@$editDataSet['video']!='')echo $editDataSet['video'];?>" data-rule-required="true">
          ...
          <ul class="form-row no-gutters">
              <li class="form-group col-12 placeVaild">
                ...
                <textarea class="form-control ignore" name="itinerary_youtube_video" placeholder="Embed Video" id="itinerary_youtube_video" data-rule-required="false"><?php echo $editDataSet['youtube_video'];?></textarea>
            </li>
          </ul>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
			 ...
			 <input id="image_gallery_check" type="text" class="form-control lowKey ignore" name="hide_feature_img" value="<?php if(@$editDataSet['feature_img']!='')echo $editDataSet['feature_img'];?>"  data-rule-required="true">
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-4 placeVaild">
			  ...
			  <input id="additional_image_1_check" type="text" class="form-control lowKey ignore" name="hide_additional_img1" value="<?php if(@$editDataSet['additional_img_1']!='')echo $editDataSet['additional_img_1'];?>"  data-rule-required="true">
            ...
            <li class="form-group col-12 col-md-4 placeVaild">
			 ...
			 <input id="additional_image_2_check" type="text" class="form-control lowKey ignore" name="hide_additional_img2" value="<?php if(@$editDataSet['additional_img_2']!='')echo $editDataSet['additional_img_2'];?>" data-rule-required="true">			 
            ...
            <li class="form-group col-12 col-md-4 placeVaild">
			  ...
			  <input id="additional_image_3_check" type="text" class="form-control lowKey ignore" name="hide_additional_img3" value="<?php if(@$editDataSet['additional_img_3']!='')echo $editDataSet['additional_img_3'];?>"  data-rule-required="true">			   
        ...
        <ul class="form-row">
          <li class="form-group col-12 col-md-12">
            ...
            <div class="form-row">
              ...
              <div class="col-12 col-sm-6">
                <label class="col-form-sublabel">Time</label>
                <input type="text" class="form-control timepicker ignore" name="route[0][itinerary_route_slot01_stop01_time][0]" 
				value="12:00 AM" placeholder="Time"  id="add_new_locationtime"	required autocomplete="off"/>
              </div>
              <div class="col-12 pt-4">
...
$(document).on('click', '#formSave', function(e) {
    var proceed = true;
    validator.destroy();
    $('#formItinerary').attr('action', 'editSaveItinerary');
    $('.loadingWrap').show();
...
$(document).on('click', '#callDone', function(e) {
    ...
    validator.destroy();
    $('#formItinerary').attr('action','editDoneItinerary');
    $('.loadingWrap').show();
    $("#formItinerary").validate({
        errorElement: 'small',
        errorPlacement: function(error, element) {
