  ...
  <ul>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data">
		...
		<?php 
			if($selectOtherLang!=='English' && $selectOtherLang!=='ENGLISH'){
			?>
          ...
          <ul class="form-row no-gutters">
           ...
           <?php if($selectOtherLang!='English'){ ?>
			...
			<?php if($selectOtherLang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Meet-up Title (<?php echo $selectOtherLang;?>)</label>
...
<li class="form-group col-12 col-md-12">
  ...
  <fieldset>         
         ...
         <h3 id="fillRoute" class="col-form-label mt-2">Venue & Timings</h3>
          ...
          <ul class="form-row">
            ...
            <!--<input type="text" id="connectivity_airport" class="form-control ignore" name="itinerary_connectivity_airport" 
			   value="<?php //if(isset($draftData->nearest_airport))echo $draftData->nearest_airport;?>" data-rule-required="true" autocomplete="off">-->
            ...
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  <!--<input type="text" id="connectivity_railway" class="form-control ignore" name="itinerary_connectivity_railway" 
			   value="<?php //if(isset($draftData->nearest_railway_station))echo $draftData->nearest_railway_station;?>" data-rule-required="true" autocomplete="off">-->            
            </li>
            ...
            <ul class="form-row">
              ...
              <li class="form-group col-12 col-md-12 pt-2">
                <div class="form-row">
                  ...
                  <div class="col-6 col-sm-4 placeVaild">
                    <label class="col-form-sublabel">Max. No. Travellers</label>
                    <input id="group_max_no_travllers" type="number"  class="form-control ignore" name="itinerary_traveller_group_maxnumber" placeholder="0" value="<?php if(isset($draftData->group_max_no_travellers))
        ...
        <fieldset>
          ...
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
              <label class="dragImageBox">
              <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_gallery_image_cover" id="image_gallery" accept="image/jpg, image/jpeg" data-height="747" data-width="1440" data-size="10240" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
              <input  id="image_gallery_check"  type="text" class="form-control lowKey ignore"  name="itinerary_gallery_hide_image_cover" value="<?php if(@$draftData->feature_img!='')echo $draftData->feature_img;?>" data-rule-required="false" />
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input  id="additional_image_1_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_image_hide_01" value="<?php if(@$draftData->additional_img_1!='')echo $draftData->additional_img_1;?>" data-rule-required="false" />
            ...
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input  id="additional_image_2_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_image_hide_02" value="<?php if(@$draftData->additional_img_2!='')echo $draftData->additional_img_2;?>" data-rule-required="false"  />
            ...
            <li class="form-group col-12 col-md-4 placeVaild">
              ...
              <input  id="additional_image_3_check" type="text" class="form-control lowKey ignore" name="itinerary_gallery_image_hide_03" value="<?php if(@$draftData->additional_img_3!='')echo $draftData->additional_img_3;?>" data-rule-required="false"  />
  ...
  <ul class="form-row">
            ...
            <h3  id="fillLegalShopping"  class="col-form-label mb-1">Policy on Shopping Activities  <a  href="javascript:void(0);"  data-ref="shopping_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3><ul class="form-row">
            <li class="form-group col-12 placeVaild cancelRadio-03">
              <div class="custom-control custom-radio custom-control-inline">
...
$(document).on('click', '.clearSponsor', function(e) {
    ...
    $("#addSponsor").parent().show();
		...
		$(document).on('click', '#saveCall', function(e) {
						e.preventDefault();
						validator.destroy();
						$('#formItinerary').attr('action', 'saveMeetupItinerary');
						$('.loadingWrap').show();
        ...
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').data("rule-required", false);
						...
						validator.destroy();
						$('#formItinerary').attr('action','doneMeetupItinerary');
						$('.loadingWrap').show();
						$("#formItinerary").validate({
										errorElement: 'small',
										errorPlacement: function(error, element) {
