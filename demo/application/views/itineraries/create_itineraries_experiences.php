...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    ...
    <div class="float-right floatBtn"> <a href="my_itineraries.html" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">cancel</a> <a id="saveCall" href="javascript:void(0);" class="btn btn-secondary mr-3">Draft</a> <a id="callDone" href="javascript:void(0);" class="btn btn-primary">Done</a> </div>
  </div>
       ...
       <input type="hidden" name="service_id" id="service_id" value="<?php echo $service_id;?>"/>
		...
		<?php } ?>
          ...
          <ul class="form-row no-gutters">
			...
			<?php if($selectOtherLang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Experience Title (<?php echo $selectOtherLang;?>)</label>
			...
			<?php if($selectOtherLang!='English'){ ?>
            <li class="form-group col-12 col-md-6 placeVaild">
              <label class="col-form-sublabel text-capitalize">Tag Line (<?php echo $selectOtherLang;?>)</label>
...
<li class="form-group col-12 col-md-12">
  ...
  <fieldset> 
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                <div class="col-12 col-sm-6 placeVaild">
                  ...
                  <input id="dropoff_point" type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Drop-Off Point" value="<?php echo $routdata->drop_off_point;?>" data-rule-required="true" autocomplete="off" />
                </div>
                <div class="col-12 col-sm-6 placeVaild">
        ...
        <fieldset>
          <?php /* <h3 id="fillVideo" class="col-form-label mt-2">Video</h3>
          <ul class="form-row">
            <li class="form-group col-12 placeVaild">
...
<ul class="form-row">
            ...
            <h3  id="fillLegalItinerary"  class="col-form-label mb-1">Itinerary Policy  <a href="javascript:void(0);" data-ref="itinerary_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>  <ul class="form-row">
...
$('#selectDateInput').datepicker({
   ...
   multidateSeparator: ", ",
        ...
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').data("rule-required", false);
		      ...
		      validator.destroy();
		      $('#formItinerary').attr('action', 'doneExperienceItinerary');
		      $('.loadingWrap').show();
		      $("#formItinerary").validate({
		          errorElement: 'small',
		          errorPlacement: function(error, element) {
