...
<div class="profilePage">
  <div class="profilePage-head clearfix">
    <h1 class="cmyLogo float-left">
      <img src="<?php echo base_url();?>assets/img/iwl_hr_white_logo.svg" alt="cityexplorers" />
    </h1>
    <div class="float-right floatBtn"> 
      <a href="javascript:void(0);" class="btn btn-link mr-3 text-default" data-toggle="modal" data-target="#rejectModal">Cancel</a><a id="formSave" href="javascript:void(0);" class="btn btn-secondary mr-3">Draft </a><a id="callDone" href="javascript:void(0);" class="btn btn-primary">Done </a> 
    </div>
  </div>
    ...
    <div class="profilePage-info">
      <form id="formItinerary" method="post" enctype="multipart/form-data" >
        ...
        <fieldset id="filldetail">
          <?php //if(!empty($hostSaveData))print_r($hostSaveData);?>
          ...
          <?php if($selectOtherLang!='English' && $selectOtherLang!='ENGLISH'){ ?>
    ...
    <ul class="form-row no-gutters">
      <li class="form-group col-12 col-md-6 placeVaild">
        ...
        <select class="form-control" name="category" id="categoryName" required data-rule-required="true">
          ...
          <option value="<?php echo $cateList->id;?>" 
                  <?php echo @$draftData->itinerary_category==$cateList->id?'selected="selected"':'';?>>
          <?php echo $cateList->category_name;?>
          </option>
        <?php endforeach;?>
      </select>
    </li>
  <?php if($selectOtherLang!='English'){ ?>
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel  text-capitalize">Type Category (<?php echo $selectOtherLang;?>)
    </label>
    <input type="text" class="form-control ignore" id="type_category" name="type_category" value="<?php if(isset($draftData->other_category_type))echo $draftData->other_category_type;?>" required data-rule-required="true"/>
  </li>
  <?php }	?>
  <li class="form-group col-12 col-md-6 placeVaild">
...
foreach($cityArr as $value): ?>
      ...
      <option value="<?php echo $value;?>" 
              <?php echo(@$draftData->origin_city==$value?'selected="selected"':'');?> > 
      <?php echo $value;?> 
      </option>
...
<?php if($selectOtherLang!='English'){ ?>
<li class="form-group col-12 col-md-6 placeVaild">
  <label class="col-form-sublabel  text-capitalize">Type My City (<?php echo $selectOtherLang;?>)
  </label>
  <input type="text" class="form-control ignore" name="origin_otherCity"  id="origin_otherCity" 
         value="<?php if(isset($draftData->origin_other_city)) echo $draftData->origin_other_city;?>" required data-rule-required="true"/>
</li>
<?php } ?>
<li class="form-group col-12 col-md-6 placeVaild">
  <label class="col-form-sublabel">Itinerary Title
  </label>
  <input type="text" class="form-control" name="itinerary_title" placeholder="Itinerary Title" id="itinerary_title"  value="<?php if(isset($draftData->itinerary_title))echo $draftData->itinerary_title;?>" required data-rule-required="true"/>
</li>
<?php if($selectOtherLang!='English'){ ?>
<li class="form-group col-12 col-md-6 placeVaild">
  <label class="col-form-sublabel  text-capitalize">Itinerary Title (<?php echo $selectOtherLang;?>)
  </label>
  <input type="text" class="form-control ignore" name="itinerary_other_title"  id="itinerary_other_title" 
         value="<?php if(isset($draftData->itinerary_other_title))echo $draftData->itinerary_other_title;?>" required data-rule-required="true"/>
</li>
<?php } ?>
<li class="form-group col-12 col-md-6 placeVaild">
  <label class="col-form-sublabel">Tag Line
  </label>
  <input type="text" class="form-control" name="itinerary_tagline" placeholder="Tag Line" id="itinerary_tagline"  
         value="<?php if(isset($draftData->itinerary_tagline))echo $draftData->itinerary_tagline;?>" required data-rule-required="true"/>
</li>
<?php if($selectOtherLang!='English'){ ?>
<li class="form-group col-12 col-md-6 placeVaild">
  <label class="col-form-sublabel  text-capitalize">Tag Line (<?php echo $selectOtherLang;?>)
  </label>
  <input type="text" class="form-control ignore" name="other_tag_line"  id="other_tag_line" value="<?php if(isset($draftData->itinerary_other_tagline))echo $draftData->itinerary_other_tagline;?>" required data-rule-required="true"/>
</li>
<?php } ?>
<li class="form-group col-12 col-md-12 placeVaild">
  <label class="col-form-label text-light">Description
  </label>
  <textarea class="form-control" name="itinerary_description" placeholder="Give details of your service (max 5000 characters)" id="itinerary_description" required data-rule-required="true" data-rule-maxlength="5000"><?php echo (@$draftData->itinerary_description?$draftData->itinerary_description:'');?></textarea>
</li>
<?php if($selectOtherLang!='English'){ ?>
<li class="form-group col-12 col-md-12 placeVaild">
  <label class="col-form-label text-light  text-capitalize">Description (<?php echo $selectOtherLang;?>)</label>
  <textarea class="form-control ignore" name="other_itinerary_description" placeholder="Give details of your service (max 5000 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="5000"><?php echo (@$draftData->other_itinerary_description?$draftData->other_itinerary_description:'');?></textarea>
</li>
<?php } ?>
<li class="form-group col-12 col-md-12 placeVaild">
  <label class="col-form-label d-block text-light">Theme
  </label>
  <label class="col-form-sublabel">Select themes 
    <small>(separate using commas)
    </small>
  </label>
...
?>
    <option value="<?php echo $themes->id;?>" 
            <?php echo $selected;?>>
...
<h3 id="fillHighlight" class="col-form-label">Highlights & features
</h3>
<ul class="form-row no-gutters">
  <li class="form-group col-12 placeVaild">
    <label class="col-form-sublabel">Highlights 
      <small class="text-default font-italic">(e.g. educational, pet friendly)
      </small>
    </label>
...
?>
      <option value="<?php echo $highlight->interest_name;?>" 
              <?php echo $selected;?>>
      <?php echo $highlight->interest_name;?>
      </option>
    <?php endforeach;?> 
  </select>
</li>
<li class="form-group col-12 placeVaild">
  <label class="col-form-sublabel d-block mb-3">Features 
    <small class="text-default font-italic">(Select all that apply)
    </small>
  </label>
...
?>
    <option value="<?php echo $value->id;?>" 
            <?php echo $selected;?>>
    <?php echo $value->feature_name;?>
    </option>
  <?php endforeach ;?>
</select>
</li>
<li class="form-group col-12 placeVaild">
  <label class="col-form-sublabel">Search Tags 
    <small>(separate using commas)
    </small>
  </label>
...
<li class="form-group col-12 placeVaild">
  <label class="col-form-sublabel d-block">Delivery Type 
    <small>(max. select 2)
    </small>
  </label>
  <div class="form-row">
...
?>
      <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
        <label>
          <input type="checkbox" id="deliveryType-bus" name="itinerary_delivery[]" value="bus" class="custom-control-input limitSelect ignore" 
                 <?php if(isset($deliverydata['bus'])){echo "checked";} ?> data-rule-required="true"/>
          ...
          <label class="custom-control-label" for="deliveryType-bus">Bus/Coach
          </label>
        </label>
      </div>
    </div>
      ...
      <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
        <label>
          <input type="checkbox" id="deliveryType-auto" name="itinerary_delivery[]" value="auto" class="custom-control-input limitSelect" 
                 <?php if(isset($deliverydata['auto'])){echo "checked";} ?> >
          <span class="control-icon"> 
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <label class="custom-control-label" for="deliveryType-auto">Auto
          </label>
        </label>
      </div>
    </div>
      ...
      <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
        <label>
          <input type="checkbox" id="deliveryType-car" name="itinerary_delivery[]" value="car" class="custom-control-input limitSelect" 
                 <?php if(isset($deliverydata['car'])){echo "checked";} ?>>
          <span class="control-icon"> 
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <label class="custom-control-label" for="deliveryType-car">Car
          </label>
        </label>
      </div>
    </div>
      ...
      <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
        <label>
          <input type="checkbox" id="deliveryType-cycle" name="itinerary_delivery[]" value="cycle" class="custom-control-input limitSelect" 
                 <?php if(isset($deliverydata['cycle'])){echo "checked";} ?>>
          <span class="control-icon"> 
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <label class="custom-control-label" for="deliveryType-cycle">Cycle
          </label>
        </label>
      </div>
    </div>
      ...
      <div class="custom-control custom-checkbox custom-control-inline p-0 ml-0 mt-1 mb-1 valign">
        <label>
          <input type="checkbox" id="deliveryType-foot" name="itinerary_delivery[]" value="foot" class="custom-control-input limitSelect" 
                 <?php if(isset($deliverydata['foot'])){echo "checked";} ?>>
          <span class="control-icon"> 
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <label class="custom-control-label" for="deliveryType-foot">On Foot
          </label>
        </label>
      </div>
    </div>
...
<h3 class="col-form-label">Language Preferences
</h3>
<ul class="form-row no-gutters">
  <li class="form-group col-12 placeVaild">
    <label class="col-form-sublabel">Select My Languages
    </label>
...
<h3 id="fillInclusions" class="col-form-label">Inclusions & exclusions
</h3>
<ul class="form-row no-gutters">
  <li class="form-group col-12 placeVaild">
    <label class="col-form-sublabel">Inclusions
    </label>
    <textarea class="form-control ignore" name="itinerary_inclusions" placeholder="Type down the inclusions (max 1000 characters)" id="itinerary_inclusions" data-rule-required="true" data-rule-maxlength="1000"><?php if(isset($draftData->itinerary_inclusions))echo $draftData->itinerary_inclusions;?></textarea>
  </li>
  <li class="form-group col-12 placeVaild">
    <label class="col-form-sublabel">Exclusions
    </label>
    <textarea class="form-control ignore" name="itinerary_exclusions" placeholder="Type down the exclusions (max 1000 characters)" id="itinerary_exclusions" data-rule-required="true" data-rule-maxlength="1000"><?php if(isset($draftData->itinerary_exclusions))echo $draftData->itinerary_exclusions;?></textarea>
  </li>
</ul>
<h3 class="col-form-label">Additional Details
</h3>
<ul class="form-row no-gutters">
  <li class="form-group col-12 placeVaild">
    <label class="col-form-sublabel">Special Mention
    </label>
    <textarea class="form-control ignore" name="itinerary_splmention" placeholder="Type any special mentions (max 1500 characters)" id="itinerary_splmention" data-rule-required="false" data-rule-maxlength="1500"><?php if(isset($draftData->itinerary_spl_mention))echo $draftData->itinerary_spl_mention;?></textarea>
  </li>
</ul>
...
<h3 id="fillFaq" class="col-form-label">FAQs
</h3>
...
?>
  <li class="form-group col-12 placeVaild">
    <label class="col-form-sublabel">Questions
    </label>
    ...
    <div class="placeVaild">
      <textarea name="itinerary_faq_answer_01[]" class="form-control mt-4 ignore" placeholder="Answer (max 1000 characters)" id="faq_answer_01" data-rule-required="true" data-rule-maxlength="1000"><?php echo $faqs->itinerary_faq_answer;?></textarea>
    </div>
  ...
  <li class="col-12 col-md-12"> 
    <a href="#" id="addQuestionLink" data-toggle="modal" data-target="#addQuestionModal" class="text-uppercase font-weight-bold">+ Add Another Question
    </a> 
  </li>
</ul>
<h3 id="fillhost" class="col-form-label">ADDITIONAL CONTACT DETAILS
</h3>
<ul class="form-row no-gutters">
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">First Name
    </label>
    <input type="text" name="itinerary_host_firstname" class="form-control ignore text-capitalize" placeholder="First Name" id="host_firstname" value="<?php if(isset($draftData->host_first_name))echo $draftData->host_first_name;else{echo $hostProfile[0]->host_first_name;}?>" data-rule-required="true"/>
  </li>
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Last Name
    </label>
    <input type="text" name="itinerary_host_lastname" class="form-control ignore text-capitalize" placeholder="Last Name" id="host_lastname" value="<?php if(isset($draftData->host_last_name))echo $draftData->host_last_name;else{echo $hostProfile[0]->host_last_name;}?>" data-rule-required="true"/>
  </li>
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Mobile
    </label>
    <span class="mobileCheck">+91-
    </span>
    <input type="text" name="itinerary_host_mobile" class="form-control ignore " placeholder="Mobile Number" id="host_mobile" value="<?php if(isset($draftData->host_mob_num))echo $draftData->host_mob_num;else{echo $hostProfile[0]->host_mob_no;}?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
  </li>
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Email ID
    </label>
...
<h3 class="col-form-label mt-4">Emergency Contact
</h3>
<ul class="form-row no-gutters">
  <li class="form-group col-12 col-md-6 placeVaild">
    <label class="col-form-sublabel">Emergency Number
    </label>
    <span class="mobileCheck">+91-
    </span>
    <input type="text" name="itinerary_host_emergency" class="form-control ignore" placeholder="Mobile Number" id="host_emergency_no" 
           value="<?php if(isset($draftData->host_emergency_contact_num))echo $draftData->host_emergency_contact_num;?>" data-rule-required="true" maxlength="10" minlength="10" data-rule-digits="true" data-msg-minlength="Please enter vaild mobile number" data-msg-maxlength="Please enter vaild mobile number" data-msg-digits="Please enter vaild mobile number"/>
  </li>
</ul>
</fieldset>
<fieldset>
  <h3 id="fillAvailability" class="col-form-label">Service frequency
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 col-md-12">
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <input id="startDateInput" name="itinerary_aviaiable_start_date" type="text" onkeydown="return false"  class="form-control ignore" placeholder="DD-MM-YYYY" 
        ...
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <input id="endDateInput" name="itinerary_aviaiable_end_date" type="text" onkeydown="return false"  class="form-control ignore" placeholder="DD-MM-YYYY" 
        ...
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <select id="selectOffDates" class="form-control ignore" name="itinerary_set_frequency" data-rule-required="true">
            <option value="regular" 
                    <?php echo @$draftData->frequency_type=='regular'?'selected="selected"':'';?>>Regular
            </option>
          <option value="nonregular" 
                  <?php echo @$draftData->frequency_type=='nonregular'?'selected="selected"':'';?>>Non-Regular
          </option>
        </select>
    </div>
  <div class="col-12 col-sm-6 placeVaild offDates">
    ...
    <input id="selectDateInput" name="itinerary_aviaiable_all_date" onkeydown="return false"  type="text" class="form-control ignore" 
           value="<?php if(!empty(@$draftData->frequency_off_days)){echo $draftData->frequency_off_days;}?>" 
           placeholder="Block Date" data-rule-required="true" autocomplete="off"/>
  </div>  
  </div>
</li>
<li class="form-group col-12 col-md-12">
  <div class="form-row">
    <div class="col-12">
      <label  class="col-form-sublabel">Available time of host
      </label>
    </div>
...
<fieldset>
  <h3 id="fillRoute" class="col-form-label mt-2">Route & Timings
  </h3>
  <label class="col-form-sublabel text-dark font-weight-semibold d-block">Default Slot
  </label>
  <ul class="form-row">
    <?php 
if(!empty($drafRouteTimeData)){
foreach($drafRouteTimeData as $key=>$routdata):
$stopsValue = fetchAll_stops($routdata->create_itinerary_id,$routdata->id);
// echo '<pre>';print_r($stopsValue);
?>
    <li class="form-group col-12 col-md-12">
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          <label class="col-form-sublabel">Pick-Up Point
          </label>
          <input type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Pick-up Point" id="pickup_point" autocomplete="off" value="<?php echo $routdata->pickup_point;?>" data-rule-required="true"/>
        </div>
        <div class="col-12 col-sm-6 placeVaild">
          <label class="col-form-sublabel">Start Time
          </label>
          <input type="text" name="itinerary_route_slot01_pickup_time[]" class="form-control timepicker ignore" placeholder="Time" id="pickup_time" value="<?php if(!empty($routdata->start_pickup_time)){echo $routdata->start_pickup_time;}else{echo '12:00 AM';}?>" data-rule-required="true" autocomplete="off"/>
        </div>
    ...
    <li class="form-group col-12 col-md-12">
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          <label class="col-form-sublabel">Drop-Off Point
          </label>
        ...
        <div class="col-12 col-sm-6 placeVaild">
          <label class="col-form-sublabel">End Time
          </label>
          <input type="text" name="itinerary_route_slot01_dropoff_time[]" class="form-control timepicker ignore" placeholder="Time" id="dropend_time" value="<?php if(!empty($routdata->end_dropoff_time)){echo $routdata->end_dropoff_time;}else{echo '12:00 AM';}?>" data-rule-required="true" autocomplete="off"/>
        </div>
    ...
    <li class="form-group col-6 placeVaild">
      <label class="col-form-sublabel">Total Duration(Hours)
      </label>
      <input type="text" name="itinerary_route_slot01_duration[]" class="form-control hourpicker ignore" placeholder="Total Duration" id="route_slot01_duration" value="<?php if(!empty($routdata->total_durations))echo $routdata->total_durations;else{echo '0:00';}?>" data-rule-required="true" autocomplete="off"/>
    </li>
    <li class="form-group col-6 placeVaild">
      <label class="col-form-sublabel">Cut-off Time(Hours)
      </label>
      <input type="text" name="itinerary_route_slot01_cutofftime[]" class="form-control cutoffpicker ignore" placeholder="Cut-off Time" id="route_slot01_cutofftime" value="<?php if(!empty($routdata->cutt_off_time))echo $routdata->cutt_off_time;else{echo '0:00';}?>" data-rule-required="true" autocomplete="off"/>
    </li>			
  </ul>
  <ul class="form-row">
    <?php $i=1;
...
?>
    <li class="form-group col-12 col-md-12">
      <label class="col-form-sublabel text-dark font-weight-semibold d-block">Stop 
        <?php echo $i;?>
      </label>
      <div class="form-row slotClass">
        <div class="col-12 col-sm-7 placeVaild">
          <label class="col-form-sublabel">Type a location 
          </label>
        ...
        <div class="col-12 col-sm-4 offset-sm-1 placeVaild">
          <label class="col-form-sublabel">Time
          </label>
          <input type="text" name="route[0][itinerary_route_slot01_stop01_time][<?php echo $key; ?>]" class="form-control timepicker ignore" placeholder="Time" id="route_slot01_stop01_time" value="<?php if(!empty($stopsData->stop_location_time)){echo $stopsData->stop_location_time;}else{echo '12:00 AM';}?>" data-rule-required="true" autocomplete="off"/>
        </div>
        <div class="col-12 col-sm-7 pt-4 placeVaild">
          <textarea class="form-control ignore" name="route[0][itinerary_route_slot01_stop01_description][<?php echo $key; ?>]" placeholder="Add a description" id="route_slot01_stop01_description" data-rule-required="true"><?php echo $stopsData->stop_location_desc;?>
          </textarea>
        </div>
      </div>
    ...
    <li class="form-group col-12 col-md-12">
      <label class="col-form-sublabel text-dark font-weight-semibold d-block">Stop 1
      </label>
      <div class="form-row slotClass">
        <div class="col-12 col-sm-7 placeVaild">
          <label class="col-form-sublabel">Type a location
...
endforeach;}
    ...
    <li class="form-group col-12 col-md-12">
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <input type="text" name="itinerary_route_slot01_pickup[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" id="pickup_point" data-rule-required="true" autocomplete="off"/>
        </div>
        <div class="col-12 col-sm-6 placeVaild">
          <label class="col-form-sublabel">Start Time
          </label>
    ...
    <li class="form-group col-12 col-md-12">
      <div class="form-row">
        <div class="col-12 col-sm-6 placeVaild">
          ...
          <input type="text" name="itinerary_route_slot01_dropoff[]" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" placeholder="Click to open map and select location" id="dropoff_point"  autocomplete="off"  data-rule-required="true"/>
        </div>
        <div class="col-12 col-sm-6 placeVaild">
          <label class="col-form-sublabel">End Time
          </label>
  ...
  <ul class="form-row">
    <li class="form-group col-12 col-md-12">
      <label class="col-form-sublabel text-dark font-weight-semibold d-block">Default Stop
      </label>
      <div class="form-row slotClass">
        <div class="col-12 col-sm-7 placeVaild">
          <label class="col-form-sublabel">Type a location
    ...
    <?php } ?>
    <li class="form-group col-12">
      <a href="#" class="text-uppercase font-weight-bold" id="addStopLink" data-toggle="modal" data-target="#addStopModal" >+ Add Another Stop</a> 
    </li>
  </ul>
  <!--<ul class="form-row no-gutters">
    <li class="form-group col-12"> 
      <a href="#" class="text-uppercase font-weight-bold text-secondary" id="addSlotLink" data-toggle="modal" data-target="#addSlotModal" >+ Add/Repeat New Slot
      </a> 
    </li>
  </ul>-->
  ...
  <ul class="form-row">
    <li class="form-group col-12 col-md-6 placeVaild">
      <label class="col-form-sublabel">Nearest Airport
      </label>
      <select class="form-control ignore" name="itinerary_connectivity_airport" id="connectivity_airport" data-rule-required="true">
        <option value="">Select
        </option>
...
?>
        <option value="<?php echo $airports->airport_name;?>" 
                <?php echo $selected;?> >
        <?php echo $airports->airport_name;?>
        </option>
      <?php endforeach;?>
    </select>
...
<li class="form-group col-12 col-md-6 placeVaild">
  <label class="col-form-sublabel">Nearest Railway Station
  </label>
  <select class="form-control ignore" name="itinerary_connectivity_railway" id="connectivity_railway" data-rule-required="true">
    <option value="">Select
    </option>
...
?>
    <option value="<?php echo $railways->railway_name;?>" 
            <?php echo $selected;?> >
    <?php echo $railways->railway_name;?>
    </option>
  <?php endforeach;?>
</select>
...
<li class="form-group col-12 col-md-12 placeVaild">
  <label class="col-form-sublabel">Location Covered
  </label>
  <input type="text" class="form-control ignore" name="itinerary_location_covered" placeholder="Location Covered" id="location_covered"  value="<?php if(isset($draftData->location_covered))echo $draftData->location_covered;?>" data-rule-required="true"/>
</li>
</ul>
<h3 id="fillTraveller" class="col-form-label mt-2">Traveller Specifications
</h3>
<div class="placeVaild">
  <ul class="form-row">
      ...
      <div class="form-row">
        <div class="col-12 col-sm-4">
          <div class="custom-control custom-checkbox custom-control-inline pt-3 pb-1">
            <input type="checkbox" id="travellerType-private" name="itinerary_traveller_private" class="custom-control-input ignore" value="1" 
                   <?php if(isset($draftData->private_traveller)==1)echo 'checked';?> data-rule-required="true">
            <label class="custom-control-label font-weight-semibold" for="travellerType-private">Private
            </label>
          </div>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Min. No. Travellers
          </label>
          <input type="number" name="itinerary_traveller_private_minnumber" class="form-control ignore" placeholder="0" min="1" id="private_min_no_travllers" value="<?php if(isset($draftData->private_min_no_travellers))
echo $draftData->private_min_no_travellers;else{echo 1;}?>" data-rule-required="true" disabled/>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Max. No. Travellers
          </label>
          <input type="number" name="itinerary_traveller_private_maxnumber" class="form-control ignore" placeholder="0" id="private_max_no_travllers" value="<?php if(isset($draftData->private_max_no_travellers))
      ...
      <div class="form-row">
        <div class="col-12 col-sm-4">
          <div class="custom-control custom-checkbox custom-control-inline pt-3 pb-1">
            ...
            <label class="custom-control-label font-weight-semibold" for="travellerType-group">Group
            </label>
          </div>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
...
if(!empty($drafFamilyData)){
//foreach($drafFamilyData as $key=>$familydata):
//if($key==0):
?>
    <li class="form-group col-12 col-sm-6 mb-1  pt-2">
      <div class="form-row">
        <div class="col-12 col-sm-4">
          <div class="custom-control custom-checkbox custom-control-inline pt-3 pb-1">
            <input type="checkbox" id="travellerType-family" name="itinerary-traveller-family" class="custom-control-input ignore" value="1" 
                   <?php echo isset($drafFamilyData[0]["family_traveller"]) && $drafFamilyData[0]["family_traveller"]==1 ? "checked" : ""; ?> >
            <label class="custom-control-label font-weight-semibold" for="travellerType-family">Family
            </label>
          </div>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Adult - Min. No.
          </label>
        ...
        <div class="col-6 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Adult - Max. No.
          </label>
    ...
    <li class="form-group col-12 col-sm-6 pt-2" data-id="kids-1">
      <div class="form-row">
        <div class="col-12 col-sm-4  placeVaild">
          <label class="col-form-sublabel">Kids (Age)
          </label>
          <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
            <input id="travellerType-kids-below10" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore keepCheck" value="10" 
                   <?php echo isset($ageTenKey) ? "checked" : ""; ?> data-rule-required="true" disabled />
            <label class="custom-control-label" for="travellerType-kids-below10">Below 10
            </label>
          </div>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Min. No. Kids
          </label>
        ...
        <div class="col-6 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Max. No. Kids
          </label>
    ...
    <li class="form-group col-12 col-sm-6 pt-2 offset-0 offset-sm-6" data-id="kids-2">
      <div class="form-row">
        <div class="col-12 col-sm-4 placeVaild">
          ...
          <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
            <input id="travellerType-kids-below7" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore disabledDad keepCheck" value="7" 
                   <?php echo isset($ageSevenKey) ? "checked" : ""; ?> data-rule-required="true" disabled />
            <label class="custom-control-label" for="travellerType-kids-below7">Below 7
            </label>
          </div>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
    ...
    <li class="form-group col-12 col-sm-6 pt-2 offset-0 offset-sm-6" data-id="kids-3">
      <div class="form-row">
        <div class="col-12 col-sm-4 placeVaild">
          ...
          <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
            <input id="travellerType-kids-below5" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore disabledDad keepCheck" value="5" 
                   <?php echo isset($ageFiveKey) ? "checked" : ""; ?> data-rule-required="true" disabled />
            <label class="custom-control-label" for="travellerType-kids-below5">Below 5
            </label>
          </div>
        </div>
        <div class="col-6 col-sm-4 placeVaild">
...
<fieldset>
  <h3 id="fillPrice" class="col-form-label mt-2">Price Chart
  </h3>
  <label class="col-form-sublabel mb-3">Enter pricing details 
    <small>(Prices will be added per participant - All prices are in INR)
    </small>
  </label>
  <ul class="form-row">
    <li  data-rel="privateCheck"  class="form-group col-12 col-md-12 hidden ">
      <div class="form-row">
        <div class="col-12 col-sm-3">
          <label class="col-form-sublabel font-weight-semibold pt-3">Private
          </label>
        </div>
        <div class="col-12 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Price
          </label>
          <input type="number" class="form-control ignore"  name="itinerary_traveller_private_price"  placeholder="0" id="itinerary_private_price" value="<?php if(isset($draftData->private_price))
echo $draftData->private_price;?>" data-rule-required="true"/>
        </div>
      </div>
    </li>
    <li  data-rel="groupCheck"  class="form-group col-12 col-md-12 hidden ">
      <div class="form-row">
        <div class="col-12 col-sm-3">
          <label class="col-form-sublabel font-weight-semibold pt-3">Group
          </label>
        </div>
        <div class="col-12 col-sm-4 placeVaild">
          <label class="col-form-sublabel">Price
          </label>
          <input type="number" class="form-control ignore" name="itinerary_traveller_group_price" placeholder="0" id="itinerary_group_price" value="<?php if(isset($draftData->group_price))echo $draftData->group_price;?>" data-rule-required="true"/>
        </div>
      </div>
    </li>
    <?php
...
//foreach($drafFamilyData as $key=>$priceData): ?>
    <li  data-rel="familyCheck"  class="form-group col-12 col-md-6 hidden ">
      <div class="form-row">
        ...
        <div class="col-12 col-sm-6">
          <label class="col-form-sublabel font-weight-semibold pt-3">Family
          </label>
        </div>
        <?php //endif;?>
        <?php //if(!empty($priceData->adults_price)){?>
        <div class="col-6 col-sm-6 placeVaild">
          <label class="col-form-sublabel">Price (Adults)
          </label>
    ...
    <li data-rel="familyCheck" data-id="familyKidCheck-01" class="form-group col-12 col-md-6 hidden">
      <div class="form-row">
        <div class="col-6 placeVaild">
          <label class="col-form-sublabel">Age (Kids)
          </label>
        ...
        <div class="col-6 placeVaild">
          <label class="col-form-sublabel">Price (Kids)
          </label>
  ...
  <?php
$draftDataSet = json_decode(json_encode($draftData), true);
if(isset($draftDataSet["additional_cost_description"]) && !empty($draftDataSet["additional_cost_description"])) {
$costData = json_decode($draftDataSet["additional_cost_description"],true);
  ...
  <ul>
    <li class="form-row">
      <div class="form-group col-12 col-sm-6 placeVaild">
        <label class="col-form-sublabel">Item
        </label>
      ...
      <div class="form-group col-12 ">
        <a href="#" class="btn btn-link removeItems pt-0">Remove
        </a>
      </div>
      <?php } ?>
    </li>
    ...
    <li class=" text-right"> 
      <a href="#" id="addItemLink" data-toggle="modal" data-target="#addItemsModal" class="text-uppercase font-weight-bold mb-2 pt-0">+ Add More
      </a> 
    </li>
    <?php } ?>
  </ul>
...
<input type="radio" id="confirmationType-instant" name="itinerary-confirmationtype" value="instant" class="custom-control-input ignore" <?php //echo @$draftData->confirmation_type=='instant'?'checked="checked"':'';?> data-rule-required="true">
<label class="custom-control-label" for="confirmationType-instant">Instant</label>
</div>
<div class="custom-control custom-radio custom-control-inline ml-3">
<input type="radio" id="confirmationType-review" name="itinerary-confirmationtype" value="review" class="custom-control-input" <?php //echo @$draftData->confirmation_type=='review'?'checked="checked"':'';?> >
...
<textarea class="form-control ignore" placeholder="Type the message" name="itinerary_confirmationtype_msg" id="instant_conf_msg" data-rule-required="true"><?php //if(isset($draftData->Instant_confirmation_message))echo $draftData->Instant_confirmation_message;?>
</textarea>
</li>
</ul>-->
  <h3 id="fillCancellations" class="col-form-label mt-2">Cancellations
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <label class="col-form-sublabel">Done By You(Host)
      </label>
      <p class="pt-1 pb-2">
        <?php echo strlen($legalData[0]->preview_cancel_donebyhost) > 500 ? substr($legalData[0]->preview_cancel_donebyhost,0,500)."..." : $legalData[0]->preview_cancel_donebyhost;?> 
        <a href="javascript:void(0);"  data-ref="done_host" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="cancelByHostInput-yes" name="itinerary-cancellations-agree" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->itinerary_cancelbyhost_agree==1?'checked="checked"':'';?> data-rule-required="true"/>
        <label class="custom-control-label" for="cancelByHostInput-yes"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="cancelByHostInput-no"> I Don't Agree
        </label>
      </div>
    </li>
    <li class="form-group col-12 placeVaild">
      <label class="col-form-sublabel">Done By traveller
      </label>
      <p class="pt-1 pb-2">
        <?php echo strlen($legalData[0]->preview_cancel_donebytraveller) > 500 ? substr($legalData[0]->preview_cancel_donebytraveller,0,500)."..." : $legalData[0]->preview_cancel_donebytraveller;?> 
        <a href="javascript:void(0);"  data-ref="done_traveller" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="cancelBytravellerInput-yes" name="itinerary-donetraveller-agree" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->itinerary_cancelbytraveller_agree==1?'checked="checked"':'';?> />
        <label class="custom-control-label" for="cancelBytravellerInput-yes" data-rule-required="true"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="cancelBytravellerInput-no"> I Don't Agree
        </label>
      </div>
    </li>
    <li class="form-group col-12 placeVaild">
      <label class="col-form-sublabel">Refund
      </label>
      <p class="pt-1 pb-2">
        <?php echo strlen($legalData[0]->preview_cancel_refund) > 500 ? substr($legalData[0]->preview_cancel_refund,0,500)."..." : $legalData[0]->preview_cancel_refund;?> 
        <a href="javascript:void(0);"  data-ref="done_refund" class="text-primary read_popup">View More
        </a>
      </p>
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="refundCheckInput-yes" name="itinerary-refund-agree" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->itinerary_refund_agree==1?'checked="checked"':'';?> data-rule-required="true"/>
        <label class="custom-control-label" for="refundCheckInput-yes"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="refundCheckInput-no"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>
...
<fieldset>
  <h3 id="fillSponsor" class="col-form-label mt-2">Sponsor
  </h3>
  <small class="text-muted">*Required min. dimension 400 X 127px, size less than 10mb and format .jpg,.jpeg only
  </small>
  <ul class="form-row">
    <?php $sponsorArr = '';
if(!empty($draftData->sponsors_img)){
$sponsorArr = explode(',',$draftData->sponsors_img);
//echo '<pre>';print_r($sponsorArr);
foreach($sponsorArr as $key=>$images):	   
?>
    <li class="form-group col-12 placeVaild">
      <label class="dragImageBox">
        <input type="file" class="form-control uploadDoc ignore imgInput" name="itinerary_sponsor_image_cover[]"  accept="image/jpg, image/jpeg" data-height="127" data-width="400" data-size="10240" data-msg-extension="Please upload file in image(.jpg & .jpeg) format only" />
        <input type="text" class="form-control lowKey ignore" name="itinerary_sponsor_hide_image_cover[]"  value="<?php if(@$images!='')echo $images;?>"   data-rule-required="false"/>
        <div class="dragImageBox-info" 
             <?php if(@$images!='' && @$images!=null) echo 'style="display:none"'; ?>>
        <div class="dragImageBox-icon">
          <img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" />
        </div>
        <p>Add a Sponsor Image
        </p>
        <span>Click here to upload image
        </span> 
        </div>
      <div class="infoShow" 
           <?php if(@$images!='' && @$images!=null) echo 'style="display:block"'; ?>>
      <p class="text-primary">
        <?php if(@$images!='')echo $images;?>
      </p>
      <small class="text-muted">000 KB
      </small>
      <a href="#" class="text-light text-uppercase clearDargbox">Remove
      </a>
    </div>
  </label>
...
<li class="form-group col-12 placeVaild">
  <label class="dragImageBox">
    ...
    <div class="infoShow">
      <p class="text-primary">File Name
      </p>
      <small class="text-muted">000 KB
      </small>
      <a href="#" class="text-light text-uppercase clearDargbox">Remove
...
//echo '<li class="form-group col-12 text-right"><a href="javascript:void(0);" class="text-light text-uppercase clearSponsor">Remove</a></li>';  
}
?>
</ul>
</fieldset>
<fieldset> <?php /*
  <h3 id="fillVideo" class="col-form-label mt-2">Video
  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <label class="col-form-sublabel">Add a video 
        <small>(*Required size less than 10mb and format .mp4 only)
        </small> 
      </label>
      <label class="dragImageBox">
        ...
        <input type="text" class="form-control lowKey ignore" name="hide_video" value="<?php if(@$draftData->video!='')echo $draftData->video;?>"  data-rule-required="true">
        <div class="dragImageBox-info" 
             <?php if(@$draftData->video!='' && @$draftData->video!=null) echo 'style="display:none"'; ?>>
        <div class="dragImageBox-icon">
          <img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="video file" />
        </div>
        <p>Add a Video
        </p>
        <span>Click here to upload video
        </span>
        </div>
      <div class="infoShow" 
           <?php if(@$draftData->video!='' && @$draftData->video!=null) echo 'style="display:block"'; ?>>
      <p class="text-primary">
        <?php if(@$draftData->video!='')echo $draftData->video;?>
      </p>
      <small class="text-muted">000 KB
      </small>
      <a href="#" class="text-light text-uppercase clearDargbox">Remove
...
<ul class="form-row no-gutters">
    <li class="form-group col-12 placeVaild">
      ...
      <textarea class="form-control ignore" name="itinerary_youtube_video" placeholder="Embed Video" id="itinerary_youtube_video" data-rule-required="false"><?php if(isset($draftData->youtube_video))echo $draftData->youtube_video;?></textarea>
  </li>
</ul>
<h3 id="fillImage" class="col-form-label mt-2">Image Gallery
</h3>
<small class="text-muted">*Required min. dimension 1440 X 810px, size less than 10mb and format .jpg,.jpeg only
</small>
<ul class="form-row">
  <li class="form-group col-12 placeVaild">
    <label class="dragImageBox">
      ...
      <input type="text" class="form-control lowKey ignore" name="hide_feature_img" value="<?php if(@$draftData->feature_img!='')echo $draftData->feature_img;?>" data-rule-required="false" >
      <div class="dragImageBox-info" 
           <?php if(@$draftData->feature_img!='' && @$draftData->feature_img!=null)echo 'style="display:none"';?>>
      <div class="dragImageBox-icon"> 
        <img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" />
      </div>
      <p>Add a Feature Image
      </p>
      <span>Click here to upload image
      </span> 
      </div>
    <div class="infoShow" 
         <?php if(@$draftData->feature_img!='' && @$draftData->feature_img!=null)echo 'style="display:block"';?>>
    <p class="text-primary">
      <?php if(@$draftData->feature_img!='')echo $draftData->feature_img;?>
    </p>
    <small class="text-muted">000 KB
    </small>
    <a href="#" class="text-light text-uppercase clearDargbox">Remove
...
<h3 class="col-form-sublabel mt-2">Additional Images
</h3>
<small class="text-muted">*Required min. dimension 250 X 158px, size less than 10mb and format .jpg,.jpeg only
</small>
<ul class="form-row">
  <li class="form-group col-12 col-md-4 placeVaild">
    <label class="dragImageBox text-center">
      ...
      <input type="text" class="form-control lowKey ignore" name="hide_additional_img1" value="<?php if(@$draftData->additional_img_1!='')echo $draftData->additional_img_1;?>" data-rule-required="false" >
      <div class="dragImageBox-info" 
           <?php if(@$draftData->additional_img_1!='' && @$draftData->additional_img_1!=null) echo 'style="display:none"';?>>
      <div class="dragImageBox-icon" > 
        <img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" />
      </div>
      <p>Add a Feature Image
    ...
    <div class="infoShow" 
         <?php if(@$draftData->additional_img_1!='' && @$draftData->additional_img_1!=null) echo 'style="display:block"';?>>
    <p class="text-primary">
      <?php if(@$draftData->additional_img_1!='')echo $draftData->additional_img_1;?>
    </p>
    <small class="text-muted">000 KB
    </small>
    <a href="#" class="text-light text-uppercase clearDargbox">Remove
...
<li class="form-group col-12 col-md-4 placeVaild">
  <label class="dragImageBox text-center">
    ...
    <input type="text" class="form-control lowKey ignore" name="hide_additional_img2" value="<?php if(@$draftData->additional_img_2!='')echo $draftData->additional_img_2;?>" data-rule-required="false">
    <div class="dragImageBox-info" 
         <?php if(@$draftData->additional_img_2!='' && @$draftData->additional_img_2!=null) echo 'style="display:none"';?>>
    <div class="dragImageBox-icon"> 
      <img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" />
    </div>
    <p>Add a Feature Image
  ...
  <div class="infoShow" 
       <?php if(@$draftData->additional_img_2!='' && @$draftData->additional_img_2!=null) echo 'style="display:block"';?>>
  <p class="text-primary">
    <?php if(@$draftData->additional_img_2!='')echo $draftData->additional_img_2;?>
  </p>
  <small class="text-muted">000 KB
  </small>
  <a href="#" class="text-light text-uppercase clearDargbox">Remove
...
<li class="form-group col-12 col-md-4 placeVaild">
  <label class="dragImageBox text-center">
    ...
    <input type="text" class="form-control lowKey ignore" name="hide_additional_img3" value="<?php if(@$draftData->additional_img_3!='')echo $draftData->additional_img_3;?>" data-rule-required="false" >
    <div class="dragImageBox-info" 
         <?php if(@$draftData->additional_img_3!='' && @$draftData->additional_img_3!=null) echo 'style="display:none"';?>>
    <div class="dragImageBox-icon">
      <img src="<?php echo base_url();?>assets/img/icon/file.svg" alt="file" />
    </div>
    <p>Add a Feature Image
  ...
  <div class="infoShow" 
       <?php if(@$draftData->additional_img_3!='' && @$draftData->additional_img_3!=null) echo 'style="display:block"';?>>
  <p class="text-primary">
    <?php if(@$draftData->additional_img_3!='')echo $draftData->additional_img_3;?>
  </p>
  <small class="text-muted">000 KB
  </small>
  <a href="#" class="text-light text-uppercase clearDargbox">Remove
...
<fieldset>
  ...
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="disclaimerCheckInput-yes" name="itinerary-disclaimer-agree" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->itinerary_liabilitie_disclaimer==1?'checked="checked"':'';?> data-rule-required="true"/>
        <label class="custom-control-label" for="disclaimerCheckInput-yes"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="disclaimerCheckInput-no"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>
    ...
    <li class="form-group col-12 placeVaild">
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="privacyCheckInput-yes"  name="itinerary-privacy-agree" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->itinerary_privacy_policy==1?'checked="checked"':'';?> data-rule-required="true"/>
        <label class="custom-control-label" for="privacyCheckInput-yes"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="privacyCheckInput-no"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>
  ...
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <div class="custom-control custom-radio custom-control-inline">
        ...
        <label class="custom-control-label" for="termsCheckInput-yes"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="termsCheckInput-no"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>
  <h3 id="fillLegalCancellations" class="col-form-label mb-1">Branding Merchandise & Identity Card Policy   <a href="javascript:void(0);" data-ref="branding_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="cancelByHostInput-yes1" name="itinerary-cancelbyHost-agree-copy" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->last_doneby_host==1?'checked="checked"':''?> data-rule-required="true"/>
        <label class="custom-control-label" for="cancelByHostInput-yes1"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="cancelByHostInput-no1"> I Don't Agree 
        </label>
      </div>
    </li>
  </ul>
    <h3  id="fillLegalItinerary"  class="col-form-label mb-1">Itinerary Policy  <a href="javascript:void(0);" data-ref="itinerary_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>
  <ul class="form-row">

    <li class="form-group col-12 placeVaild">
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="cancelBytravellerInput-yes1" name="itinerary-cancelbytraveller-agree-copy" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->last_doneby_traveller==1?'checked="checked"':''?> data-rule-required="true"/>
        <label class="custom-control-label" for="cancelBytravellerInput-yes1"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="cancelBytravellerInput-no1"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>

    <h3  id="fillLegalShopping"  class="col-form-label mb-1">Policy on Shopping Activities  <a  href="javascript:void(0);"  data-ref="shopping_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">

      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="refundCheckInput-yes1" name="itinerary-refund-agree-copy" value="1" class="custom-control-input ignore" 
               <?php echo @$draftData->last_refund==1?'checked="checked"':''?> data-rule-required="true"/>
        <label class="custom-control-label" for="refundCheckInput-yes1"> I Agree
        </label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        ...
        <label class="custom-control-label" for="refundCheckInput-no1"> I Don't Agree
        </label>
      </div>
    </li>
  </ul>
    ...
    <li class="form-group col-12 placeVaild">				
      <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="copyrightCheckInput-yes"  name="itinerary-copyright-agree" value="1" 
               class="custom-control-input ignore" 
               <?php echo @$draftData->media_infringement==1?'checked="checked"':'';?> data-rule-required="true"/>
        <label class="custom-control-label" for="copyrightCheckInput-yes"> I Agree</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline valign">
        <input type="radio" id="copyrightCheckInput-no" name="itinerary-copyright-agree" value="0"  class="custom-control-input"  <?php echo @$draftData->media_infringement==''?'':(@$draftData->media_infringement==0?'checked="checked"':'');?>>
  ...
  <ul class="form-row">
    <li class="form-group col-12 placeVaild">              
      <div class="custom-control custom-checkbox custom-control-inline">
        ...
        <label class="custom-control-label" for="term_policy"> I agree to all company <a href="<?php echo base_url();?>policies" target="_blank">policies</a> and <a href="<?php echo base_url();?>policies" target="_blank">terms of use</a> of www.cityexplorers.in </label>
      </div>             
    </li>
  </ul>
</fieldset>
    ...
    <div class="modal-content">
      <form id="newStopForm">
        <div class="modal-header">
          <h5 class="modal-title">Add Another stop
          </h5>
        ...
        <div class="modal-body">
          <ul class="pl-2 pr-2">
            <li class="form-group col-12 col-md-12">
              <label class="col-form-sublabel text-dark font-weight-semibold d-block">New Stop
              </label>
              <div class="form-row">
                <div class="col-12 col-sm-6">
                  <label class="col-form-sublabel">Type a location
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <input type="text" name="route[0][itinerary_route_slot01_stop01_time][0]" class="form-control timepicker"  value="12:00 AM" placeholder="12:00 AM" id="add_stopTime" required/>
                </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close
          </button>
          <button type="submit" class="btn btn-primary" id="addOtherStop">Add
          </button>
        </div>
      </form>
    </div>
...
<div class="modal fade" id="addSlotModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <form id="newSlotForm">
        <div class="modal-header">
          <h5 class="modal-title">Add New Slot
          </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
            <span aria-hidden="true">&times;
            </span> 
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-12">
              <div class="form-row routeClass">
                <div class="col-12 col-sm-6">
                  ...
                  <input type="text" class="form-control ignore" name="itinerary_route_slot01_pickup[]" placeholder="Click to open map and select location" id="add_new_pickpoint" data-toggle="modal" data-target="#getMapModal" required autocomplete="off" />
                </div>
                <div class="col-12 col-sm-6">
                  <label class="col-form-sublabel">Start Time
                  </label>
              ...
              <div class="form-row">
                <div class="col-12 col-sm-6">
                  ...
                  <input type="text" class="form-control ignore" data-toggle="modal" data-target="#getMapModal" 
                         name="itinerary_route_slot01_dropoff[]" placeholder="Click to open map and select location" id="add_new_dropoint" required autocomplete="off"/>
                </div>
                <div class="col-12 col-sm-6">
                  <label class="col-form-sublabel">End Time
                  </label>
            ...
            <li class="form-group col-12 col-md-12">
              <div class="form-row">
                ...
                <div class="col-12 col-sm-6">
                  <label class="col-form-sublabel ">Cut-off Time (minutes)
                  </label>
          ...
          <ul class="form-row">
            <li class="form-group col-12 col-md-12">
              ...
              <div class="form-row">
                ...
                <div class="col-12 pt-4">
                  <textarea class="form-control ignore" name="route[0][itinerary_route_slot01_stop01_description][0]" placeholder="Add a description" id="add_new_locdesc" required >
                  </textarea>
                </div>
              </div>
            </li>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="addNewSlot">Add
          </button>
        </div>
      </form>
    </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary addBtn" id="addMap_value">Add
        </button>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <form id="newQuestionForm">
        <div class="modal-header">
          <h5 class="modal-title">Add Another Question
          </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
            <span aria-hidden="true">&times;
            </span> 
        ...
        <div class="modal-body">
          <ul class="pl-2 pr-2">
            <li class="form-group col-12 col-md-12">
              ...
              <textarea class="form-control mt-4" placeholder="Answer (max 1000 characters)" name="itinerary_faq_answer_01[]" id="add_newAns"required data-rule-maxlength="1000">
              </textarea>
            </li>
          </ul>
        </div>
...
<div class="modal fade" id="doneModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <h5 class="modal-title pb-3 pt-3"> 
          <span class="modal-titleIcon">
            <img src="assets/img/icon/done.svg" alt="done" />
          </span> Thank You!
        </h5>
        <p class="font-weight-semibold text-center">Your registration is complete. Someone from our team will
          <br/>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="confirmationText">
          <p class="text-center">Your itinerary has been saved successfully!
          </p>
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="confirmationText">
          <p class="text-center">Are you sure you would like to cancel creating this itinerary?
          </p>
        </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="cancleItinerary">Yes
        </button>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <form id="addItemsForm">
        <div class="modal-header">
          <h5 class="modal-title">Add More Items
          </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
            <span aria-hidden="true">&times;
            </span> 
...
<div class="modal fade" id="tcModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" >Terms & Conditions 
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
          <span aria-hidden="true">&times;
          </span> 
...
<div class="modal fade" id="readMoreModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="titleText">
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> 
          <span aria-hidden="true">&times;
          </span> 
      ...
      <div class="modal-body legalPopup">  
        <div class="legalText readMoreData pl-4 pr-4">
        </div>
      </div>	  
      <div class="modal-footer">
        <button type="button" class="btn btn-link text-primary" data-dismiss="modal">Close
...
<div class="loadingWrap">
  <div class="loadingText">Loading...
  </div>
</div>
<!-- SCRIPT -->
<?php require('foot.php');?>
<!-- google places API START --> 
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC32_hwlF6rX6bIbwISUVS1GJ89dcjsLz4&libraries=places">
</script> 
...
$('#selectDateInput').datepicker({
   ...
   multidateSeparator: ", ",
    ...
    $(document).on('click', '[data-id="pickup_point"]', function() {
      ...
      var coordinatesval = $('#coordinatesval').val();
    ...
    //==========  new frequency change js on 14-05-19 ===========//
    $('#service_frequency').bind("change", function() {
      if ($(this).val() == 'weekly') {
        $('#weeklyDays').show();
        $('#dailyDays').hide();
    ...
    //========== END new frequency change js on 14-05-19 ===========//
    ...
    $('[name="send_to_translator"]').bind("change", function() {
      ...
      if ($val == 0) {
        console.log("NO");
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').removeClass('ignore').attr('required', 'required').attr('data-rule-required', 'true');
        validator.resetForm();
      } else {
        console.log("YES");
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').removeAttr('data-rule-required');
        validator.resetForm();
      }
    }).trigger('change');
    ...
    $(document).on('click','.read_popup',function(){
      ...
      var brandingText = '<?php echo $legalData[0]->branding_policy?>';
      var itinerarypolicyText = '<?php echo $legalData[0]->itinerary_policy?>';
      var shoppingpolicyText = '<?php echo $legalData[0]->shopping_policy?>';
      ...
      if(popupText=='liability_diclaimer'){
        $('#titleText').html('Code of Conduct');
        $('.readMoreData').html(liabilityDiscText);
        $('#readMoreModal').modal('show');
      }
      if(popupText=='privacy_policy'){
        $('#titleText').html('Non Discrimination & Sexual Harassment Policy');
        $('.readMoreData').html(privacyPolicyText);
        $('#readMoreModal').modal('show');
      }
      if(popupText=='term_condition'){
        $('#titleText').html('Confidential Information, Safety of Guests, Picture & Social Media Policy');
        $('.readMoreData').html(termConditionText);
        $('#readMoreModal').modal('show');
      }

      if(popupText=='branding_policy'){
        $('#titleText').html('Branding Merchandise & Identity Card Policy');
        $('.readMoreData').html(brandingText);
        $('#readMoreModal').modal('show');
      }

      if(popupText=='itinerary_policy'){
        $('#titleText').html('Itinerary Policy');
        $('.readMoreData').html(itinerarypolicyText);
        $('#readMoreModal').modal('show');
      }

      if(popupText=='shopping_policy'){
        $('#titleText').html('Policy on Shopping Activities');
        $('.readMoreData').html(shoppingpolicyText);
        $('#readMoreModal').modal('show');
      }
      if(popupText=='media_infri'){
        $('#titleText').html('Intellectual Property Policy');
