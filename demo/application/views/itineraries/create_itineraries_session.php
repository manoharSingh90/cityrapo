            ...
            <li class="form-group col-12 placeVaild">
              ...
              <select id="typeHighlights" name="itinerary_highlights[]" class="form-control ignore" placeholder="Type a highlight (separate using commas)" data-rule-required="true" multiple >
				 ...
				 foreach($highLightResult as $highlight):
				  ...
				  //$highlights1 = explode(',',$draftData->type_highlights);
  ...
  <fieldset> 
      ...
      <!-- <ul class="form-row">
        ...
        <h3 id="fillLegalLiabilities" class="col-form-label mb-1">Code of Conduct <a href="javascript:void(0);"  data-ref="liability_diclaimer" class="text-primary read_popup small font-weight-bold ml-1">View Detail</a></h3>
          ...
          <h3 id="fillLegalCancellations" class="col-form-label mb-1">Branding Merchandise & Identity Card Policy   <a href="javascript:void(0);" data-ref="branding_policy" class="text-primary read_popup small font-weight-bold ml-1">View Detail </a>  </h3>          <ul class="form-row">
            <li class="form-group col-12 placeVaild cancelRadio-01">
               <div class="custom-control custom-radio custom-control-inline">
...
$(document).on('click', '#callDone', function(e) {
    ...
    validator.destroy();
    $('#formItinerary').attr('action', 'doneSessionItinerary');
    $('.loadingWrap').show();
    $("#formItinerary").validate({
        errorElement: 'small',
        errorPlacement: function(error, element) {
