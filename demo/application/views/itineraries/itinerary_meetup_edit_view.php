		...
		<div class="col-6 col-sm-auto">
          ...
          <ul class="form-row no-gutters">
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_first_name))echo $editDataSet->host_first_name;else{echo $hostProfile[0]->host_first_name;}?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
			  ...
			  value="<?php if(isset($editDataSet->host_last_name))echo $editDataSet->host_last_name;else{echo $hostProfile[0]->host_last_name;}?>" data-rule-required="true"/>
            </li>
            <li class="form-group col-12 col-md-6 placeVaild">
    ...
    <div class="col-6 placeVaild">
     ...
     <fieldset> 
      ...
      <!--       <ul class="form-row">
                ...
                <div class="form-row">
                  <div class="col-12 col-sm-4  placeVaild">
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                      <input id="travellerType-kids-below10" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore keepCheck disabledDad" value="10" <?php echo isset($ageTenKey) ? "checked" : ""; ?> data-rule-required="true"  />
             ...
             <li class="form-group col-12 col-sm-6 pt-2" data-id="kids-1">
                <div class="form-row">
                  <div class="col-12 col-sm-4  placeVaild">
                    <label class="col-form-sublabel">Kids (Age)</label>
                    <div class="custom-control custom-checkbox custom-control-inline pt-4 pb-1">
                      <input id="travellerType-kids-below10" type="checkbox" name="itinerary-traveller-family-kids01-age[]" class="custom-control-input ignore keepCheck disabledDad" value="10" data-rule-required="true" disabled />
                      <label class="custom-control-label" for="travellerType-kids-below10">Below 10</label>
                    </div>
                   </div>
                  <div class="col-6 col-sm-4 placeVaild">
		...
		<?php if($key!=0) { ?>
			<div class="form-group col-12 "><a href="#" class="btn btn-link removeItems pt-0 pl-0">Remove</a></div>
		<?php } ?>
        ...
        <fieldset>
          ...
          <h3 id="fillImage" class="col-form-label mt-2">Image Gallery</h3>
                    		  <small class="text-muted">*Required dimension 1440 X 747px, size less than 10mb and format .jpg,.jpeg only</small>
...
$(window).on('load', function() {
    ...
    if (adminStatus == 1) {
        ...
        $('.floatBtn').html('');
		$('#addSponsor').remove();
        $('.floatBtn').append('<a href="<?php echo base_url()?>itineraries/meetup" class="btn btn-link text-default">Back</a>')
    }
});
...
$(document).on('click', '.clearSponsor', function(e) {
    ...
    $("#addSponsor").parent().show();
		...
		$(document).on('click', '#saveCall', function(e) {
						e.preventDefault();
						validator.destroy();
						$('#formItinerary').attr('action', 'editMeetupSaveItinerary');
						$('.loadingWrap').show();
        ...
        $('[name="type_category"], [name="origin_otherCity"], [name="itinerary_other_title"], [name="other_tag_line"], [name="other_itinerary_description"]').addClass('ignore').removeAttr('required').data("rule-required", false);
						...
						validator.destroy();
						$('#formItinerary').attr('action','editMeetupDoneItinerary');
						$('.loadingWrap').show();
						$("#formItinerary").validate({
										errorElement: 'small',
										errorPlacement: function(error, element) {
