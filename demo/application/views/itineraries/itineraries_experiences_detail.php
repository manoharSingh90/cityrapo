      ...
      <div class="row">
        <div class="col-12">
          <div class="mainIntro boxStyle">
            <div class="mainIntro-top"> <a href="<?php echo base_url();?>itineraries/experience" class="text-uppercase"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <div class="col-12 col-md-7">
          <div class="bookIntro boxStyle">
            ...
            <div class="row pt-2 clearfix">
              <div class="col-12">
                <div class="bookIntro-cost pt-2 pb-2">
                  <ul>
				   <?php 
