          ...
          <ul class="form-row no-gutters">
		   <li class="form-group col-12 col-md-6 placeVaild">
            ...
            <li class="form-group col-12 col-md-12 placeVaild">
              ...
              <textarea class="form-control" name="itinerary_description" placeholder="Give details of your service (max 400 characters)" id="itinerary_description" required data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->itinerary_description))echo $editDataSet->itinerary_description;?></textarea>
			  <div id="DescError" class="error errorOwn"></div>
            </li>
			<?php if($otherlang!='English'){ ?>
			 <li class="form-group col-12 col-md-12 placeVaild">
              <label class="col-form-label text-light">Description (<?php echo $otherlang;?>)</label>
              <textarea class="form-control" name="other_itinerary_description" placeholder="Give details of your service (max 400 characters)"  id="other_lang_desc" required data-rule-required="true" data-rule-maxlength="400"><?php if(isset($editDataSet->other_itinerary_description))echo $editDataSet->other_itinerary_description;?></textarea>
