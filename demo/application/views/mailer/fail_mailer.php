      ...
      <table cellpadding="0" cellspacing="0" style="width: 720px; background: #fff; margin: 0 auto; border: none; border-collapse: collapse; color: #000; font-size: 16px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; background-image: url(<?= base_url('assets/mailer_img/bg.png')?>); background-repeat: no-repeat; background-position: right top;">
        ...
        <tr>
          ...
          <td colspan="4">
            ...
            <br>
            <p style="color: #000; font-size: 22px; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">Welcome to India with locals</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="color: #000; font-size: 14px; line-height: 1.5; font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; margin: 0; padding: 0;">BOOKING UNSUCCESSFUL!:<br/>
            <strong style="color: #ee474c; text-transform: uppercase;">BOOKING ID:<?php echo $booking_id?></strong></td>
          <td style="width: 30px;"></td>
        </tr>
        <tr>
          <td colspan="4" style="padding: 10px;"></td>
        ...
        <tr>
          <td style="width: 30px;"></td>
          <td colspan="2" style="font-style: italic; color: #999; font-size: 80%;">Your booking is unsuccessful. This may be due to technical reasons, connection error or your bank declined the payment. Please check and try again.”</td>
          <td style="width: 30px;"></td>
        </tr>
        <tr>
