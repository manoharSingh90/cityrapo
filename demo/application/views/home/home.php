  ...
  <div class="heroBanner"> 
     <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
			...
			<div class="carousel-item bannerLayer active" style="background-image: url(<?php echo base_url();?>assets/img/banners/home/banner_1.jpg)"><img src="<?php echo base_url();?>assets/img/banners/home/banner_1.jpg" alt="1"/>	<div class="container"> 
				<div class="bannerText"><p>Traveling Unforgettable</p></div></div></div>
				...
				<div class="bannerText"><p>Discover Something</p></div></div></div>
				...
				<div class="bannerText"><p>Secret Stories</p></div></div></div>
				...
				<div class="bannerText"><p>Soul Connection</p></div></div></div>
				<div class="carousel-item bannerLayer" style="background-image: url(<?php echo base_url();?>assets/img/banners/home/banner_5.jpg)"><img src="<?php echo base_url();?>assets/img/banners/home/banner_5.jpg" alt="13"/>	<div class="container"> 
				<div class="bannerText"><p>Route Discoveries</p></div></div></div>
        <div class="carousel-item bannerLayer" style="background-image: url(<?php echo base_url();?>assets/img/banners/home/banner_6.jpg)"><img src="<?php echo base_url();?>assets/img/banners/home/banner_6.jpg" alt="13"/>	<div class="container"> 
				<div class="bannerText"><p>Rewarding Experiences</p></div></div></div>
        <div class="carousel-item bannerLayer" style="background-image: url(<?php echo base_url();?>assets/img/banners/home/banner_7.jpg)"><img src="<?php echo base_url();?>assets/img/banners/home/banner_7.jpg" alt="13"/>	<div class="container"> 
				<div class="bannerText"><p>Food & Communities</p></div></div></div>
			</div>
	</div>
 </div>
...
<div class="text-center bandRed-bg"><a class="d-block" href="<?php echo base_url()?>home/madhya_pradesh" target="_blank"><img src="<?php echo base_url();?>assets/img/banners/home/space_banner.jpg" alt="MP Festival"/></a></div>
  ...
  <div class="bgSpacer"> <a class="d-block" href="https://docs.google.com/forms/d/e/1FAIpQLSf80xDaLTH8-g-wUDWmo3KTVPYqavMelVBfySGAQlWrzxinBQ/viewform?usp=send_form" target="_blank"><img src="<?php echo base_url();?>assets/img/banners/home/bottom_space_banner.jpg" alt="cityexplorers"/></a></div>
  <!--
  ...
  <div class="moreusSection">
    <div class="container-fluid">
	  ...
	  <ul class="pb-2">
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="heritage heroes&trade;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_01.jpg" alt="heritageheroes" /><span><strong>HERITAGE HEROES</strong><sup>&trade;</sup></span></a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="gandhi walks&trade;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_02.jpg" alt="gandhiwalks" /><span><strong>Gandhi Walks</strong><sup>&trade;</sup></span></a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="swachh walks&reg;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_03.jpg" alt="swachhwalks" /><span><strong>Swachh Walks</strong><sup>&reg;</sup></span> </a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="photo walking&reg;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_04.jpg" alt="photowalking" /><span><strong>Photowalking</strong><sup>&reg;</sup></span></a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="gully gyan&reg;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_05.jpg" alt="gullygyan" /><span><strong>Gully Gyan</strong><sup>&reg;</sup></span></a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="india heritage walks&trade;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_06.jpg" alt="indiaheritagewalks" /><span><strong>India Heritage Walks</strong><sup>&trade;</sup></span></a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="incredible india stories&trade;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_07.jpg" alt="incredibleindiastories" /><span><strong>Incredible India Stories</strong><sup>&trade;</sup></span></a>
                    </li>
                    <li>
                        <a href="#" class="knownMorebox" data-toggle="modal" data-target="#moreusModal" data-rel="party crawl&reg;"><img src="<?php echo base_url();?>assets/img/moreus/moreus_08.jpg" alt="partycrawl" /><span><strong>Party Crawl</strong><sup>&reg;</sup></span></a>
                    </li>
                </ul>
    </div>
  </div>
